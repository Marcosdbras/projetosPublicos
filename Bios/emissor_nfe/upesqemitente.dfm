object frmpesqemitente: Tfrmpesqemitente
  Left = 30
  Top = 108
  Width = 968
  Height = 609
  Caption = 'Pesquisa de Emitentes'
  Color = clBtnFace
  ...
  object pnlcentro: TPanel
    ...
    object pctdados: TPageControl
      ...
      object tbslista: TTabSheet
        Caption = 'LI&STAR'
        object dbg_emitente: TDBGrid
          Left = 0
          Top = 0
          Width = 789
          Height = 387
          Align = alClient
          DataSource = frmdados.dts_emitente
      ...
      object tbsficha: TTabSheet
        ...
        object cbxdescregtrib: TDBLookupComboBox
          Left = 440
          Top = 213
          Width = 329
          Height = 21
          ...
          KeyField = 'codigo'
          ListField = 'nome'
          ListSource = frmdados.dts_regtrib
          TabOrder = 16
          OnKeyPress = edinomeKeyPress
        end
        object MMOObs: TMemo
