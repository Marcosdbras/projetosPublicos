...
if frmdados.sql_consulta.FieldByName('validados').AsInteger > 0 then
   begin
     ...
     application.MessageBox(pchar('Outro equipamento est· emitindo neste momento, clique em ok e tente novamente daqui alguns segundos...'+chr(13)+'Se esta mensagem continuar a persistir clique em utilit·rio e desbloqueio de envio'),pchar('AtenÁ„o'),mb_ok);
     frmfecnf.Update;
...
begin
             ...
             begin
               ...
               if (bAut) then
                  ...
                  begin
                    bNaut := true;
                    if sAcao = 'V' then
                       lblmensagem.Caption := 'VisualizaÁ„o concluida'
                    else
  ...
  if bNaut then
    begin
      ...
      //retorno do sefaz com erro de validaÁ„o
    ...
    //Autorizado uso e impress„o pelo sefaz
    frmdados.cds_nf.Edit;
...
begin
 ...
 //endif
  ...
  with frmdados do
   ...
   if infennf >= strtoint(ediproxnota.Text) then
      begin
        ...
        if application.MessageBox(pchar('Deseja atualizar n˙mero da prÛxima nota com informaÁ„o recente?'+chr(13)+chr(13)+
                                  'Caso sua resposta seja afirmativa o n˙mero que vocÍ digitou para prÛxima nota ser· desconsiderado'+chr(13)+
                                  'Motivo: N˙mero da prÛxima NF È menor que o n˙mero das ˙ltimas notas fiscais emitidas') ,'AtenÁ„o',mb_yesno) = 6 then
           begin
           ...
           begin
             ...
             with frmdados do
               begin
                 ...
                 if application.MessageBox(pchar('Deseja atualizar n˙mero da prÛxima nota com informaÁ„o recente?'+chr(13)+chr(13)+
                                           'Caso sua resposta seja afirmativa o n˙mero que vocÍ digitou para prÛxima nota'+chr(13)+
                                           'ser· desconsiderado'),'AtenÁ„o',mb_yesno) = 6 then
                     begin
  ...
  //showmessage(  'NFE registrada anteriormente, n˙mero '+formatfloat('00000',infennf)  );
