...
type
  Tfrmdados = class(TDataModule)
    ...
    sql_nfpicmsstant: TFloatField;
    sql_nfiva: TFloatField;
    sql_nfbaseicmsstant: TFloatField;
    sql_nfvlricmsstant: TFloatField;
    sql_nfchave: TStringField;
    cds_nfpicmsstant: TFloatField;
    cds_nfiva: TFloatField;
    cds_nfbaseicmsstant: TFloatField;
    cds_nfvlricmsstant: TFloatField;
    cds_nfchave: TStringField;
    sql_nfstatus: TStringField;
    cds_nfstatus: TStringField;
    sql_nfcaminhonfe: TStringField;
    ...
    sql_cupomnecf: TStringField;
    cds_cupomnecf: TStringField;
    sql_indicefonte_transp_imposto: TStringField;
    sql_indicealiqfederal: TFloatField;
    sql_indicealiqestadual: TFloatField;
    sql_indicealiqmunicipal: TFloatField;
    cds_indicefonte_transp_imposto: TStringField;
    cds_indicealiqfederal: TFloatField;
    cds_indicealiqestadual: TFloatField;
    cds_indicealiqmunicipal: TFloatField;
    sql_produtosaliqfederal: TFloatField;
    sql_produtosaliqestadual: TFloatField;
    sql_produtosaliqmunicipal: TFloatField;
    cds_produtosaliqfederal: TFloatField;
    cds_produtosaliqestadual: TFloatField;
    cds_produtosaliqmunicipal: TFloatField;
    sql_nfpaliqfederal: TFloatField;
    sql_nfpaliqestadual: TFloatField;
    sql_nfpaliqmunicipal: TFloatField;
