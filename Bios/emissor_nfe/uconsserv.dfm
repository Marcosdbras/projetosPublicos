object frmconsserv: Tfrmconsserv
  Left = 218
  Top = 155
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = 'Consulta M'#227'o-de-Obra'
  ClientHeight = 446
  ClientWidth = 681
  Color = clBtnFace
  ...
  object dbg_cmobra: TDBGrid
    Left = 8
    Top = 66
    Width = 662
    Height = 367
    DataSource = frmdados.dts_cmobra
    ...
    TitleFont.Style = []
    OnDblClick = dbg_cmobraDblClick
    OnKeyPress = dbg_cmobraKeyPress
    Columns = <
      item
        Expanded = False
        FieldName = 'descricao'
