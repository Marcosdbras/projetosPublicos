...
procedure Tfrmrelsita.cabecalhoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
ipag := ipag + 1;
...
procedure Tfrmrelsita.delalheBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tfrmrelsita.FormClose(Sender: TObject;
