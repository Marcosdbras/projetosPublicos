...
procedure TfrmrelClientes.cabecalhoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
ipag := ipag + 1;
...
procedure TfrmrelClientes.relatorioBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
 ipag := 0;
 ...
 lbltit3.Caption := 'RELAÇÃO DE CLIENTES';
 lbltit4.Caption := frmpesqclientes.sTitRel;

end;

procedure TfrmrelClientes.delalheBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  lblnome.Caption:=frmDados.Cds_clientes.fieldbyname('nome').AsString;
  lblcodigo.Caption:=frmDados.Cds_clientes.fieldbyname('codigo').AsString;
