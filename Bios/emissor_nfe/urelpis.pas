...
procedure Tfrmrelpis.cabecalhoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
ipag := ipag + 1;
...
procedure Tfrmrelpis.delalheBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tfrmrelpis.FormClose(Sender: TObject;
