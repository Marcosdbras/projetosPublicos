...
type
  TFrmFiltroImpostoI = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    Label4: TLabel;
...
var
  FrmFiltroImpostoI: TFrmFiltroImpostoI;
...
procedure TFrmFiltroImpostoI.BtnOKClick(Sender: TObject);
begin
  aplicarfiltro;
  close;
end;

procedure TFrmFiltroImpostoI.BtnCancelClick(Sender: TObject);
begin
  close;
end;

procedure TFrmFiltroImpostoI.FormShow(Sender: TObject);
begin
...
procedure TFrmFiltroImpostoI.FormClose(Sender: TObject;
...
procedure TFrmFiltroImpostoI.cbxoperadorKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key :=0;
end;

procedure TFrmFiltroImpostoI.CbxCampoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
key :=0;
end;

procedure TFrmFiltroImpostoI.CbxOperacaoKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key :=0;
end;

procedure TFrmFiltroImpostoI.CbxOrdPorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
key :=0;
end;

procedure TFrmFiltroImpostoI.cbxoperadorKeyPress(Sender: TObject;
  var Key: Char);
begin
key :=#0;
end;

procedure TFrmFiltroImpostoI.CbxCampoKeyPress(Sender: TObject;
  var Key: Char);
begin
key :=#0;
end;

procedure TFrmFiltroImpostoI.CbxOperacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
key :=#0;
end;

procedure TFrmFiltroImpostoI.CbxOrdPorKeyPress(Sender: TObject;
  var Key: Char);
begin
key :=#0;
end;

procedure TFrmFiltroImpostoI.aplicarfiltro;
var
  sCampo:STRING;
  sOperacao:STRING;
  sOrdem:STRING;
...
procedure TFrmFiltroImpostoI.btnaplicarClick(Sender: TObject);
begin
aplicarfiltro;
end;

procedure TFrmFiltroImpostoI.ediinformacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
if cbxcampo.ItemIndex = 0 then
   begin
...
procedure TFrmFiltroImpostoI.btnlimparClick(Sender: TObject);
begin
with frmdados do
  begin
    cds_impostoI.Filtered := false;
...
procedure TFrmFiltroImpostoI.CbxCampoDropDown(Sender: TObject);
begin
ediinformacao.Text := '';
end;
