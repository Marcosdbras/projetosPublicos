...
uses
  ...
  CurrEdit, TFlatComboBoxUnit, Menus, jpeg, TFlatPanelUnit;
...
procedure Tfrmvenda_fechamento_avista.rdesconto1Enter(Sender: TObject);
begin
...
procedure Tfrmvenda_fechamento_avista.rdinheiroEnter(Sender: TObject);
begin
  tedit(sender).color := $00B97237;
