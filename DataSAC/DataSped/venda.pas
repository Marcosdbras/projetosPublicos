...
uses
  ...
  AdvMenus,principal, FileCtrl, FlCtrlEx, CPort, clipbrd;
...
begin
  try
    ...
    sMsg := cECF_Abre_Cupom(iECF_Modelo,sConsumidor_CPF,
      sConsumidor_Nome,
      sConsumidor_Endereco,
...
begin
  ...
  begin
    Imprime_display_teclado('Micromarc Informatica', 'DataSAC');
...
{   if (messageDlg('Este programa foi desenvolvido em 800 X 600. Ele vai rodar normalmente nas suas configurações, mas não vai ficar posicionado corretamete em seu monitor! Deseja Alterar suas configurações de vídeo agora?',
 ...
 begin
  ...
  begin
    // abrir a comunicacao
    OpenTec44;
    Imprime_display_teclado('Micromarc Informatica :: DataSAC','Terminal iniciado com sucesso!');
  end;
...
begin
  ...
  begin
    ...
    if Executa_Login('MESTREDATASAC',ed_senha.text,'') then
    begin
      bSair_campo := true;
