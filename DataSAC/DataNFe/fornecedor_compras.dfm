object frmfornecedor_compras: Tfrmfornecedor_compras
  ...
  object qrcompras: TZQuery
    ...
    Left = 420
    Top = 178
    object qrcomprasCODPRODUTO: TStringField
      DisplayLabel = 'C'#211'DIGO'
      DisplayWidth = 5
      FieldName = 'CODPRODUTO'
      Size = 13
    end
    object qrcomprasPRODUTO: TStringField
      DisplayWidth = 37
      FieldName = 'PRODUTO'
      Size = 60
    end
    object qrcomprasUNIDADE: TStringField
      DisplayLabel = 'UN'
      DisplayWidth = 2
      FieldName = 'UNIDADE'
      Size = 2
    end
    object qrcomprasNOTAFISCAL: TStringField
      DisplayLabel = 'NFISCAL'
      DisplayWidth = 6
