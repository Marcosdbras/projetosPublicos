...
uses
  ...
  IBQuery, IBDatabase, DBAccess, IBC, MemDS, ExtCtrls, dialogs, Registry;
  ...
  begin
    ...
    begin
      if trim(copy(entrada,9,1)) = '' then
        frmprincipal.caption := 'DataSAC 2.0 | Server - PAF 1.09                [ Servidor Local ]'
      else
        frmprincipal.caption := 'DataSAC 2.3 | Cliente- PAF 1.09                [ Servidor: '+trim(copy(entrada,9,50))+' ]';
    end;
       ...
       begin
         ...
         begin
            try
              ...
              frmModulo.Conexao.HostName  :=Registro.ReadString('Servidor_Host');
              ...
              frmmodulo.conexaolocal.hostname := Registro.ReadString('Servidor_Host');;
              frmmodulo.conexaolocal.database := Registro.ReadString('Servidor_Base');
         ...
         begin
          if (Registro.ReadString('NFe_Ativo')='SIM') then
           sUsa_NFE:='1'
          else
           sUsa_NFE:='2';
         end
         ...
         begin
           application.messagebox('Houve falha na leitura do registro da NF-eletronica!'+
