object frmpedido: Tfrmpedido
  ...
  object pficha: TPanel
    ...
    object Panel1: TPanel
      ...
      object PageView1: TPageView
        ...
        object Software1: TPageSheet
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Align = alClient
            DataSource = dspedido_contasreceber
            Enabled = False
            Font.Charset = ANSI_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
      ...
      object rdesconto1: TRxDBCalcEdit
        Left = 708
        Top = 36
        Width = 64
        Height = 21
      ...
      object racrescimo1: TRxDBCalcEdit
        Left = 709
        Top = 60
        Width = 64
        Height = 21
        DataField = 'ACRESCIMO1'
        DataSource = dspedido
        DecimalPlaces = 3
        DisplayFormat = '###,###,##0.00%'
        ButtonWidth = 0
    ...
    object Panel2: TPanel
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'PDESCONTO;CustomEdit;pdesconto;F'
          'PACRESCIMO;CustomEdit;pacrescimo;F')
        Selected.Strings = (
          ...
          'PDESCONTO'#9'7'#9'% DESC'#9#9
          'DESCONTO'#9'8'#9'(-) R$'#9#9
          'PACRESCIMO'#9'8'#9'% ACRES'#9#9
          'ACRESCIMO'#9'10'#9'(+) R$'#9'F'#9
  ...
  object pdesconto: TwwDBEdit
    ...
    WantReturns = False
    WordWrap = False
    OnExit = pdescontoExit
  end
  object pacrescimo: TwwDBEdit
    Left = 584
    Top = 216
    Width = 121
    Height = 21
    DataField = 'PACRESCIMO'
    DataSource = dspedido_produto
    TabOrder = 9
    UnboundDataType = wwDefault
    WantReturns = False
    WordWrap = False
    OnExit = pacrescimoExit
  end
  object dspedido: TDataSource
    DataSet = frmmodulo.qrPedido
    Left = 480
    Top = 96
  end
  object qrpedido_produto: TZQuery
    Connection = frmmodulo.Conexao
    OnCalcFields = qrpedido_produtoCalcFields
    BeforeInsert = qrpedido_produtoBeforeInsert
    BeforeEdit = qrpedido_produtoBeforeEdit
    BeforePost = qrpedido_produtoBeforePost
    BeforeDelete = qrpedido_produtoBeforeDelete
    SQL.Strings = (
      'select * from C000057PEDIDO')
    Params = <>
    Left = 80
    Top = 88
    object s_produtoCODPRODUTO: TStringField
      DisplayLabel = 'C'#211'DIGO'
      DisplayWidth = 13
      FieldName = 'CODPRODUTO'
      Size = 13
    end
    object s_produtoPRODUTO: TStringField
      DisplayWidth = 57
      FieldName = 'PRODUTO'
      Size = 60
    end
    object s_produtoUNIDADE: TStringField
      DisplayLabel = 'UN'
      DisplayWidth = 5
      FieldName = 'UNIDADE'
      Size = 5
    end
    object f_produtoQTDE: TFloatField
      DisplayLabel = 'QTDE.'
      DisplayWidth = 8
      FieldName = 'QTDE'
      DisplayFormat = '###,###,##0.00'
    end
    object f_produtoUNITARIO: TFloatField
      DisplayLabel = 'PRE'#199'O'
      DisplayWidth = 10
      FieldName = 'UNITARIO'
      DisplayFormat = '###,###,##0.00'
    end
    object qrpedido_produtoPDESCONTO: TFloatField
      DisplayLabel = '% DESC'
      DisplayWidth = 7
      FieldName = 'PDESCONTO'
      DisplayFormat = '###,###,##0.00'
    end
    object f_produtoDESCONTO: TFloatField
      DisplayLabel = '(-) R$'
      DisplayWidth = 8
      FieldName = 'DESCONTO'
      DisplayFormat = '###,###,##0.00'
    end
    object qrpedido_produtoPACRESCIMO: TFloatField
      DisplayLabel = '% ACRES'
      DisplayWidth = 8
      FieldName = 'PACRESCIMO'
      DisplayFormat = '###,###,##0.00'
    end
    object f_produtoACRESCIMO: TFloatField
      DisplayLabel = '(+) R$'
      DisplayWidth = 10
      FieldName = 'ACRESCIMO'
      DisplayFormat = '###,###,##0.00'
    end
    object f_produtoTOTAL: TFloatField
      DisplayWidth = 11
      FieldName = 'TOTAL'
      DisplayFormat = '###,###,##0.00'
    end
    object s_produtoCODPEDIDO: TStringField
      DisplayWidth = 14
      FieldName = 'CODPEDIDO'
      Visible = False
      Size = 6
    end
    object f_produtoestoque: TFloatField
      FieldKind = fkCalculated
      FieldName = 'estoque'
      Visible = False
      Calculated = True
    end
    object intgrfld_produtoNUMERACAO: TIntegerField
      DisplayWidth = 10
      FieldKind = fkCalculated
      FieldName = 'NUMERACAO'
      Visible = False
    ...
    object s_produtoCODBARRA: TStringField
      DisplayWidth = 13
      FieldName = 'CODBARRA'
      Visible = False
      Size = 13
    end
    object s_produtoITEM: TStringField
      DisplayWidth = 3
      FieldName = 'ITEM'
      Visible = False
      Size = 3
    end
    object s_produtoCODBARRAS: TStringField
      DisplayWidth = 13
      FieldName = 'CODBARRAS'
      Visible = False
      Size = 13
    end
    object s_produtoSERIAL: TStringField
      DisplayWidth = 30
      FieldName = 'SERIAL'
      Visible = False
      Size = 30
    end
    object s_produtoCODGRADE: TStringField
      DisplayWidth = 6
      FieldName = 'CODGRADE'
      Visible = False
      Size = 6
    end
    object intgrfld_produtoTIPO: TIntegerField
      DisplayWidth = 10
      FieldName = 'TIPO'
      Visible = False
    end
    object f_produtoALIQUOTA: TFloatField
      DisplayWidth = 10
      FieldName = 'ALIQUOTA'
      Visible = False
    end
    object s_produtoCST: TStringField
      DisplayWidth = 3
      FieldName = 'CST'
      Visible = False
      Size = 3
    end
    object s_produtoTERMINAL: TStringField
      DisplayWidth = 4
      FieldName = 'TERMINAL'
      Visible = False
      Size = 4
    end
    object s_produtoCODSUBGRUPO: TStringField
      DisplayWidth = 6
      FieldName = 'CODSUBGRUPO'
      Visible = False
      Size = 6
    end
    object s_produtoPISCOFINS: TStringField
      DisplayWidth = 1
      FieldName = 'PISCOFINS'
      Visible = False
      Size = 1
    end
    object s_produtoSERIAL_CODINT: TStringField
      DisplayWidth = 6
      FieldName = 'SERIAL_CODINT'
      Visible = False
      Size = 6
    end
    object s_produtoGRADE_CODINT: TStringField
      DisplayWidth = 6
      FieldName = 'GRADE_CODINT'
      Visible = False
      Size = 6
    end
    object qrpedido_produtoIDGRADE: TIntegerField
      DisplayWidth = 10
      FieldName = 'IDGRADE'
      Visible = False
    end
  ...
  object dspedido_contasreceber: TDataSource
    DataSet = qrpedido_contasreceber
    Left = 368
    Top = 160
  end
  object qrpedido_contasreceber: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select * from c000060P')
    Params = <>
    Left = 80
    Top = 208
    object intgrfld_contasreceberPRESTACAO: TIntegerField
      DisplayLabel = 'N'#186
      DisplayWidth = 3
      FieldName = 'PRESTACAO'
    end
    object dtmfld_contasreceberVENCIMENTO: TDateTimeField
      DisplayWidth = 18
      FieldName = 'VENCIMENTO'
    end
    object s_contasreceberTIPO: TStringField
      DisplayWidth = 36
      FieldName = 'TIPO'
    end
    object f_contasreceberVALOR: TFloatField
      DisplayWidth = 20
      FieldName = 'VALOR'
      DisplayFormat = '###,###,##0.00'
    end
    object s_contasreceberDOCUMENTO: TStringField
      DisplayWidth = 18
      FieldName = 'DOCUMENTO'
      Visible = False
    end
    object s_contasreceberCODPEDIDO: TStringField
      FieldName = 'CODPEDIDO'
      Visible = False
      Size = 6
    end
  ...
  object qrquery2: TZReadOnlyQuery
    Connection = frmmodulo.Conexao
    Params = <>
    Left = 176
    Top = 152
