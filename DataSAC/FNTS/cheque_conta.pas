...
begin
  RESULTADO_PESQUISA1 := FRMCHEQUE.QRCONTA_CLIENTE.FIELDBYNAME('CONTA').ASSTRING;
  RESULTADO_PESQUISA2 := FRMCHEQUE.QRCONTA_CLIENTE.FIELDBYNAME('CODBANCO').ASSTRING;
  RESULTADO_PESQUISA3 := FRMCHEQUE.QRCONTA_CLIENTE.FIELDBYNAME('AGENCIA').ASSTRING;
  RESULTADO_PESQUISA4 := FRMCHEQUE.QRCONTA_CLIENTE.FIELDBYNAME('DATA_CONTA').ASSTRING;
  CLOSE;
end;
