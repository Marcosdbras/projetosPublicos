object frmecf_reducao_menu: Tfrmecf_reducao_menu
  ...
  object tab_principal: TAdvToolBarPager
    ...
    object AdvPage1: TAdvPage
      ...
      Height = 394
      AutoPosition = False
      Caption = 'Impressoras Fiscais / Redu'#231#245'es'
      ImageIndex = 28
      object grid: TwwDBGrid
        ...
        Selected.Strings = (
          'SERIE_EMPRESA'#9'3'#9'N'#186#9#9
          'SERIE_EQUIPAMENTO'#9'19'#9'NR. S'#201'RIE'#9#9)
      ...
      object AdvToolBar1: TAdvToolBar
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            'SITUACAO;ImageIndex;Original Size')
          Selected.Strings = (
            'DATA_EMISSAO'#9'10'#9'EMISS'#195'O'
            'NRO_CONTADOR_INICIO'#9'10'#9'COO INICIAL'
            'NRO_CONTADOR_FIM'#9'10'#9'COO FINAL'#9'F'
            'VALOR_VENDA_BRUTA'#9'10'#9'VD.BRUTA'
            'CANCELAMENTO'#9'10'#9'CANCEL.'
            'DESCONTO'#9'10'#9'DESCONTOS'
            'ISSQN'#9'10'#9'SERVI'#199'OS'
            'VALOR_VENDA_LIQUIDA'#9'11'#9'VD.L'#205'QUIDA')
          IniAttributes.Delimiter = ';;'
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
