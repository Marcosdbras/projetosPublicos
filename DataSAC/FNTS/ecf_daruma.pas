...
function tfrmecf_daruma.ecf_registro_60A(ecf:string):string;
begin
  Daruma_FI_RelatorioTipo60Analitico();
end;
function tfrmecf_daruma.ecf_registro_60M(ecf:string):string;
begin
    Daruma_FI_RelatorioTipo60Mestre();
end;


function tfrmecf_daruma.ecf_numero_serie(ecf:string):string;
...
function tfrmecf_daruma.ecf_abre_CNFV(ecf:string;forma_pgto:string;valor:string;numero_cupom:string):string;
begin
...
function tfrmecf_daruma.ecf_usa_CNFV(ecf:string;texto:string):string;
begin
...
function tfrmecf_daruma.ecf_fecha_CNFV(ecf:string):string;
begin
...
function tfrmecf_daruma.ecf_arredondamento(ecf:string;tipo:string):string;
begin
...
function tfrmecf_daruma.ecf_leitura_x(ecf:string):string;
begin
    Daruma_FI_LeituraX();
    SetLength(RET,4);
    Daruma_FI_RetornaErroExtendido(ret);
...
function tfrmecf_daruma.ecf_reducao_z(ecf:string):string;
begin
    Daruma_FI_ReducaoZ('', '');
    SetLength(RET,4);
    Daruma_FI_RetornaErroExtendido(ret);
...
function tfrmecf_daruma.ecf_leitura_memoria_fiscal(ecf:string;data_inicial:string;data_final:string):string;
begin
...
function tfrmecf_daruma.ecf_suprimentoX(ecf:string;valor:string;forma_pgto:string):string;
begin
...
function tfrmecf_daruma.ecf_sangriaX(ecf:string;valor:string):string;
begin
...
function tfrmecf_daruma.ecf_operador(ecf:string;operador:string):string;
begin
...
function tfrmecf_daruma.ecf_ligada(ecf:string):string;
begin
...
function tfrmecf_daruma.ecf_modeloecf(ecf:string):string;
begin
  RESULT := inttostr(Daruma_FI_VerificaModeloEcf());
end;
function tfrmecf_daruma.ecf_abre_gaveta(ecf:string):string;
begin
...
function tfrmecf_daruma.ecf_numero_cupom(ecf:string):string;
...
begin
     ...
     SetLength(RET,4);
     Daruma_FI_RetornaErroExtendido(ret);
     if ANALISA_RETORNO(RET,'DARUMA') = 'ERRO' then
       RESULT := 'ERRO'
     ELSE
       RESULT := NUMERO_CUPOM;
end;
function tfrmecf_daruma.ecf_numero_caixa(ecf:string):string;
...
function tfrmecf_daruma.ecf_data_hora(ecf:string):string;
...
function tfrmecf_daruma.ecf_cancela_cupom(ecf:string):string;
begin
...
function tfrmecf_daruma.ecf_abre_cupom(ecf:string;cpf:string):string;
begin
...
function tfrmecf_daruma.ecf_vende_item_completo(ecf: string;Codigo: String; produto: String; Aliquota: String; Unitario: real; quantidade: real; Valor_Desconto: real; Valor_Acrescimo: real; Unidade:string;total:real ):string;
var posicao : integer;
...
function tfrmecf_daruma.ecf_vende_item(ecf:string;codigo:string;produto:string;aliquota:string;tipo_quantidade:string;quantidade:real;casas_decimais:integer;unitario:real;tipo_desconto:string;valor_desconto:real;Desconto_Acrescimo:string;total:real):string;
var posicao : integer;
quantidade_string, unitario_string, texto, total_string, ST : string;
begin
  if codigo = ''  then codigo := '999999';
...
function tfrmecf_daruma.ecf_inicia_fechamento_cupom(ecf:string;Acrescimo_ou_desconto:string;tipo_acrescimo_desconto:string;valor_acrescimo_desconto:real;valor_total:real):string;
...
function tfrmecf_daruma.ecf_efetua_forma_pgto(ecf:string;forma_pgto:string;valor:real):string;
begin
...
function tfrmecf_daruma.ecf_efetua_forma_pgto_especial(ecf:string;forma_pgto1:string;valor1:real;forma_pgto2:string;valor2:real;forma_pgto3:string;valor3:real;forma_pgto4:string;valor4:real;forma_pgto5:string;valor5:real;forma_pgto6:string;valor6:real):string;
var posicao : integer;
begin
//
end;

function tfrmecf_daruma.ecf_identifica_consumidor(ecf:string;nome:string;endereco:string;cpf:string):string;
begin
...
function tfrmecf_daruma.ecf_termina_fechamento(ecf:string;mensagem:string):string;
begin
...
function tfrmecf_daruma.ecf_termina_fechamento_especial(ecf:string;cliente:string;endereco:string;cpf:string):string;
var operador : string;
begin
//
end;
...
function tfrmecf_daruma.ecf_cancela_item(ecf:string;item:string):string;
begin
