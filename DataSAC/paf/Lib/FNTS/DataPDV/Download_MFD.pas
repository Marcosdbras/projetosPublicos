...
// -------------------------------------------------------------------------- //
procedure TfrmDownload_MFD.rb_crzClick(Sender: TObject);
begin
  ed_data_ini.Visible := false;
  ed_data_fim.Visible := false;
  ed_inicio.Visible   := true;
...
procedure TfrmDownload_MFD.rb_crzKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then
    perform(wm_nextdlgctl,0,0);
end;

procedure TfrmDownload_MFD.rb_cooKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then
    perform(wm_nextdlgctl,0,0);
end;
