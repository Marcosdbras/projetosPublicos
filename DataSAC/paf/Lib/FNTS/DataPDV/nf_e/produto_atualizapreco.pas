...
uses
  ...
  Dialogs, Mask, ToolEdit, CurrEdit, StdCtrls, Menus, Buttons, ExtCtrls,
  Collection, TFlatPanelUnit, DB, ZAbstractRODataset, ZAbstractDataset,
  ZDataset, ComCtrls, AdvGlowButton, RzPrgres;
...
uses modulo_nfe, xloc_grupo, xloc_subgrupo, xloc_fornecedor, xloc_marca;
