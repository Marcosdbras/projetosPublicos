...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Collection, Buttons, Menus, Mask, ToolEdit,
  wwdblook, CurrEdit, DB, ZAbstractRODataset, ZAbstractDataset, ZDataset,
  AdvGlowButton;
...
//  EDIT14.Color := CLWINDOW;
  ...
  BEGIN
    ...
    ELSE
    BEGIN
      APPLICATION.MESSAGEBOX('Cliente/Sacado não localizado!','Atenção',mb_ok+MB_ICONERROR);
