...
uses
  ...
  Dialogs, DB, ExtCtrls, TFlatPanelUnit, StdCtrls, Collection, ToolEdit,
  RXDBCtrl, Buttons, Mask, DBCtrls, 
  ZAbstractRODataset, ZAbstractDataset, ZDataset, Grids, Wwdbigrd, Wwdbgrid,
  wwdbedit, Wwdotdot, Wwdbcomb, Menus, CurrEdit, RzEdit, RzDBEdit,
...
uses modulo_nfe, loc_produto_ligth, principal, lista_produto2, loc_subgrupo,
