object frmbackup: Tfrmbackup
  ...
  Caption = 'BACKUP | C'#243'pia de Seguran'#231'a'
  ClientHeight = 145
  ClientWidth = 420
  Color = clBtnFace
  ...
  object ZipMaster1: TZipMaster
    ...
    SFXOptions = [SFXAskFiles]
    SFXOverWriteMode = OvrConfirm
    SFXPath = '..\SFX\ZipSFX.bin'
    Left = 302
    Top = 62
  end
