object frmproduto_farma_preco: Tfrmproduto_farma_preco
  Left = 209
  Top = 62
  Width = 529
  Height = 302
  BorderStyle = bsSizeToolWin
  Caption = 'PRODUTOS | Importa'#231#227'o de Pre'#231'os'
  Color = clBtnFace
  ...
  object combobalanca: TwwDBComboBox
    ...
    OnKeyPress = combobalancaKeyPress
  end
