...
uses
  ...
  Dialogs, Wwkeycb, StdCtrls, ExtCtrls, Collection, Mask, ToolEdit,
  CurrEdit, Buttons, Menus, DB, Grids, Wwdbigrd, Wwdbgrid, TFlatPanelUnit,
  AdvGlowButton, ZAbstractRODataset, ZAbstractDataset, ZDataset;
...
uses principal, modulo_nfe, venda, venda_grade, venda_serial;
