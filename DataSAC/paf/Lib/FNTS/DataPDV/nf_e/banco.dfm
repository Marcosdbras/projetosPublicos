object frmbanco: Tfrmbanco
  ...
  object pficha: TFlatPanel
    ...
    object GroupBox2: TGroupBox
      ...
      Width = 433
      Height = 82
      Caption = 'Comiss'#245'es e prazos (Adm.Cart'#227'o)'
      TabOrder = 8
      ...
      object ed_debito: TRzDBNumericEdit
        Left = 232
        Top = 27
        Width = 49
        Height = 21
        DataSource = dsbanco2
        DataField = 'COMISSAO_DEBITO'
        Alignment = taLeftJustify
        TabOrder = 0
        OnKeyPress = ed_debitoKeyPress
        DisplayFormat = '##0.00%'
      end
      object ed_credito: TRzDBNumericEdit
        Left = 232
        Top = 51
        Width = 49
        Height = 21
        DataSource = dsbanco2
        DataField = 'COMISSAO_CREDITO'
        Alignment = taLeftJustify
        TabOrder = 2
        OnKeyPress = ed_creditoKeyPress
        DisplayFormat = '##0.00%'
      end
      object ed_dias_debito: TRzDBSpinEdit
        ...
        MaxLength = 999
        TabOrder = 1
        OnKeyPress = ed_dias_debitoKeyPress
        AllowKeyEdit = True
        Max = 100.000000000000000000
        Min = 1.000000000000000000
        Value = 1.000000000000000000
      ...
      object ed_dias_credito: TRzDBSpinEdit
        ...
        MaxLength = 999
        TabOrder = 3
        OnKeyPress = ed_dias_creditoKeyPress
        AllowKeyEdit = True
        Max = 100.000000000000000000
        Min = 1.000000000000000000
        Value = 1.000000000000000000
