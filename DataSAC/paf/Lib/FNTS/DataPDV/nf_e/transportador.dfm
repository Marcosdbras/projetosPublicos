object frmtransportador: Tfrmtransportador
  ...
  object PopupMenu1: TPopupMenu
    Left = 233
    Top = 287
    object NFeExportarCliente1: TMenuItem
      Caption = 'NFe - Exportar Transportador Selecionado'
      OnClick = NFeExportarCliente1Click
    end
    object NFeExportartodososclientes1: TMenuItem
      Caption = 'NFe - Exportar todos os Transportadores'
      OnClick = NFeExportartodososclientes1Click
    end
  end
