...
uses modulo_nfe, principal, loc_regiao, regiao, loc_funci, loc_cfop,
...
begin
   if frmprincipal.autentica('Excluir Saída Produto',4) then
  begin
...
begin
   if frmprincipal.autentica('Excluir Item Saída',4) then
  begin
