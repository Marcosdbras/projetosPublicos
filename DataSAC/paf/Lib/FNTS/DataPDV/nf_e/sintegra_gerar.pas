...
uses
 ...
 DBCtrls, Dateutil, ExtCtrls, Inifiles, ShellApi, IBDatabase, jpeg, RxGIF,
  Collection, TFlatPanelUnit, ZAbstractRODataset, ZAbstractDataset,
  ZDataset, Menus, Grids, DBGrids, Mask, ToolEdit, RzEdit, RzDBEdit,
  ...
  RzRadChk, RzBckgnd, RzCmboBx, AdvShapeButton, RzBtnEdt, CurrEdit,
  RzPrgres, PageView, TFlatGaugeUnit;
...
type
 Tfrmsintegra_gerar = class(TForm)
   ...
   SaveDialog1: TSaveDialog;
    ...
    qrentrada_checkCODIGO: TStringField;
    qrentrada_checkTURBO: TIntegerField;
    I: TStringField;
    qrentrada_checkCODIGO_EMPRESA: TIntegerField;
    qrentrada_checkCFOP: TStringField;
    qrentrada_checkNOTAFISCAL: TStringField;
    qrentrada_checkSERIE: TStringField;
    qrentrada_checkSUBSERIE: TStringField;
    qrentrada_checkESPECIE: TStringField;
    qrentrada_checkSINTEGRA: TStringField;
    qrentrada_checkMODELO_NF: TStringField;
    qrentrada_checkS_TRIB: TStringField;
    qrentrada_checkCODIGO_CLIENTE: TIntegerField;
    qrentrada_checkCPF_CLIENTE: TStringField;
    qrentrada_checkCNPJ_CLIENTE: TStringField;
    qrentrada_checkIE_CLIENTE: TStringField;
    qrentrada_checkUF_IE_CLIENTE: TStringField;
    qrentrada_checkTIPO_VENDA: TStringField;
    qrentrada_checkTIPO_FRETE: TStringField;
    qrentrada_checkDATA: TDateTimeField;
    qrentrada_checkDATA_ESCRITURACAO: TDateTimeField;
    qrentrada_checkCODIGO_CONTABIL: TIntegerField;
    qrentrada_checkDESDOBRAMENTO: TStringField;
    ...
    qrentrada_checkCONDPGTO: TStringField;
    qrentrada_checkCONDICAO_PAGAMENTO: TStringField;
    qrentrada_checkCODEMPRESA: TIntegerField;
    qrentrada_checkOBS1: TStringField;
    qrentrada_checkOBS2: TStringField;
    qrentrada_checkCODLANCAMENTO: TStringField;
    ...
    qrentrada_checkOBS3: TStringField;
    qrentrada_checkCONTABIL: TIntegerField;
    qrentrada_checkVALOR_ICMS: TFloatField;
    qrentrada_checkCODIGO_MINICIPIO: TIntegerField;
    qrentrada_checkCNPJ: TStringField;
    qrentrada_checkINSC_ESTADUAL: TStringField;
    qrentrada_checkUF: TStringField;
    qrentrada_checkCODIGO_PISCONFINS: TStringField;
    qrentrada_checkNOTA_CANCELADA: TStringField;
    qrentrada_checkOBSERVACAO: TBlobField;
    qrentrada_checkTRANSPORTE_NOME: TStringField;
    qrentrada_checkTRANSPORTE_PLACA: TStringField;
    qrentrada_checkTRANSPORTE_UF: TStringField;
    qrentrada_checkTRANSPORTE_CNPJCPF: TStringField;
    qrentrada_checkTRANSPORTE_ENDERECO: TStringField;
    qrentrada_checkTRANSPORTE_CIDADE: TStringField;
    qrentrada_checkTRANSPORTE_MUNICIPIO_UF: TStringField;
    qrentrada_checkTRANSPORTE_IE: TStringField;
    qrentrada_checkTRANSPORTE_QUANTIDADE: TFloatField;
    qrentrada_checkTRANSPORTE_MARCA: TStringField;
    qrentrada_checkTRANSPORTE_ESPECIE: TStringField;
    qrentrada_checkTRANSPORTE_NUMERO: TStringField;
    qrentrada_checkTRANSPORTE_PESO_BRUTO: TFloatField;
    qrentrada_checkTRANSPORTE_PESO_LIQUIDO: TFloatField;
    Val: TACBrValidador;
    qrsaida_checkCODIGO: TStringField;
    qrsaida_checkTURBO: TIntegerField;
    qrsaida_checkTIPO: TStringField;
    qrsaida_checkCODIGO_EMPRESA: TIntegerField;
    qrsaida_checkCFOP: TStringField;
    qrsaida_checkNOTAFISCAL: TStringField;
    qrsaida_checkSERIE: TStringField;
    qrsaida_checkSUBSERIE: TStringField;
    qrsaida_checkESPECIE: TStringField;
    qrsaida_checkSINTEGRA: TStringField;
    qrsaida_checkMODELO_NF: TStringField;
    qrsaida_checkS_TRIB: TStringField;
    qrsaida_checkCODIGO_CLIENTE: TIntegerField;
    qrsaida_checkCPF_CLIENTE: TStringField;
    qrsaida_checkCNPJ_CLIENTE: TStringField;
    qrsaida_checkIE_CLIENTE: TStringField;
    qrsaida_checkUF_IE_CLIENTE: TStringField;
    qrsaida_checkTIPO_VENDA: TStringField;
    qrsaida_checkTIPO_FRETE: TStringField;
    qrsaida_checkDATA: TDateTimeField;
    qrsaida_checkDATA_ESCRITURACAO: TDateTimeField;
    qrsaida_checkCODIGO_CONTABIL: TIntegerField;
    qrsaida_checkDESDOBRAMENTO: TStringField;
    qrsaida_checkVALOR_CONTABIL: TFloatField;
    qrsaida_checkVALOR_MERCADORIAS: TFloatField;
    qrsaida_checkALIQUOTA_ICMS: TFloatField;
    qrsaida_checkCONDPGTO: TStringField;
    qrsaida_checkCONDICAO_PAGAMENTO: TStringField;
    qrsaida_checkCODEMPRESA: TIntegerField;
    qrsaida_checkOBS1: TStringField;
    qrsaida_checkOBS2: TStringField;
    qrsaida_checkCODLANCAMENTO: TStringField;
    ...
    qrsaida_checkOBS3: TStringField;
    qrsaida_checkCONTABIL: TIntegerField;
    qrsaida_checkVALOR_ICMS: TFloatField;
    qrsaida_checkCODIGO_MINICIPIO: TIntegerField;
    qrsaida_checkCNPJ: TStringField;
    qrsaida_checkINSC_ESTADUAL: TStringField;
    qrsaida_checkUF: TStringField;
    qrsaida_checkCODIGO_PISCONFINS: TStringField;
    qrsaida_checkNOTA_CANCELADA: TStringField;
    qrsaida_checkOBSERVACAO: TBlobField;
    qrsaida_checkTRANSPORTE_NOME: TStringField;
    qrsaida_checkTRANSPORTE_PLACA: TStringField;
    qrsaida_checkTRANSPORTE_UF: TStringField;
    qrsaida_checkTRANSPORTE_CNPJCPF: TStringField;
    qrsaida_checkTRANSPORTE_ENDERECO: TStringField;
    qrsaida_checkTRANSPORTE_CIDADE: TStringField;
    qrsaida_checkTRANSPORTE_MUNICIPIO_UF: TStringField;
    qrsaida_checkTRANSPORTE_IE: TStringField;
    qrsaida_checkTRANSPORTE_QUANTIDADE: TFloatField;
    qrsaida_checkTRANSPORTE_MARCA: TStringField;
    qrsaida_checkTRANSPORTE_ESPECIE: TStringField;
    qrsaida_checkTRANSPORTE_NUMERO: TStringField;
    ...
    qrtransporteNUMERO: TStringField;
    qrtransporteCODFORNECEDOR: TStringField;
    qrtransporteMODELO: TStringField;
    qrtransporteESPECIE: TStringField;
    qrtransporteSERIE: TStringField;
    qrtransporteCFOP: TStringField;
    qrtransporteDATA_LANCAMENTO: TDateTimeField;
    qrtransporteTOTAL_NOTA: TFloatField;
    qrtransporteNOTA_FISCAL: TStringField;
    ...
    qrtransporte_saidaCODIGO: TStringField;
    qrtransporte_saidaNUMERO: TStringField;
    qrtransporte_saidaDATA: TDateTimeField;
    qrtransporte_saidaCFOP: TStringField;
    qrtransporte_saidaCODREMETENTE: TStringField;
    qrtransporte_saidaCODDESTINATARIO: TStringField;
    qrtransporte_saidaSITUACAO: TIntegerField;
    qrtransporte_saidaTIPO: TStringField;
    qrtransporte_saidaCONSIG_NOME: TStringField;
    qrtransporte_saidaCONSIG_ENDERECO: TStringField;
    qrtransporte_saidaCONSIG_CIDADE: TStringField;
    qrtransporte_saidaCONSIG_UF: TStringField;
    qrtransporte_saidaCONSIG_TIPO: TStringField;
    qrtransporte_saidaCONSIG_CALCULADO: TStringField;
    qrtransporte_saidaREDE_NOME: TStringField;
    qrtransporte_saidaREDE_ENDERECO: TStringField;
    qrtransporte_saidaREDE_CIDADE: TStringField;
    qrtransporte_saidaREDE_UF: TStringField;
    qrtransporte_saidaREDE_TIPO: TStringField;
    qrtransporte_saidaREDE_CNPJ: TStringField;
    qrtransporte_saidaCARGA_NATUREZA: TStringField;
    qrtransporte_saidaCARGA_NF: TStringField;
    ...
    qrtransporte_saidaCARGA_VOL_ESPECIE: TStringField;
    qrtransporte_saidaCARGA_MARCA1: TStringField;
    qrtransporte_saidaCARGA_MARCA2: TStringField;
    ...
    qrtransporte_saidaFRETE_PRONT: TStringField;
    qrtransporte_saidaFRETE_APOLICE: TStringField;
    qrtransporte_saidaFRETE_CIA: TStringField;
    qrtransporte_saidaFRETE_CARREGAR: TStringField;
    qrtransporte_saidaFRETE_DESCARREGAR: TStringField;
    qrtransporte_saidaCODVEICULO: TStringField;
    qrtransporte_saidaCODTRANSPORTADOR: TStringField;
    qrtransporte_saidaOBS: TBlobField;
    qrtransporte_saidaCODFILIAL: TStringField;
    qrtransporte_saidaLOCAL: TStringField;
    qrtransporte_saidaMOTIVO: TStringField;
    qrtransporte_saidaVEICULO_LOCAL: TStringField;
    qrtransporte_saidaVEICULO_UF: TStringField;
    qrtransporte_saidaMODELO: TStringField;
    qrtransporte_saidaESPECIE: TStringField;
    qrtransporte_saidaSERIE: TStringField;
    qrtransporte_saidaMODELO_NF: TStringField;
    qrtransporte_saidaESPECIE_NF: TStringField;
    qrtransporte_saidaSERIE_NF: TStringField;
    qrtransporte_saidaDATA_NF: TDateTimeField;
    qrtransporte_saidaVALOR_CONHECIMENTO: TFloatField;
    qrtransporte_saidaINF1: TStringField;
    qrtransporte_saidaINF2: TStringField;
    qrtransporte_saidaINF3: TStringField;
    qrtransporte_saidaINF4: TStringField;
    qrtransporte_saidaINF5: TStringField;
    ...
    dscfop: TDataSource;
    qrcfop: TZQuery;
    qrcfopTIPO: TStringField;
    qrcfopCFOP: TStringField;
    qrcfopNOTAFISCAL: TStringField;
    qrcfopDATA: TDateTimeField;
    qrcfopVALOR_CONTABIL: TFloatField;
    qrcfopCODIGO_CONTABIL: TIntegerField;
    qrcfopALIQUOTA_ICMS: TFloatField;
    qrcfopBASE_ICMS: TFloatField;
    qrcfopVALOR_ICMS_CREDITADO: TFloatField;
...
uses principal, modulo_nfe, sintegra_menu, fornecedor, cliente, notafiscal,
       ...
       if not Trata_SIntegra_Str(TempStr) then
        begin
         ...
         Err_Msg := Err_Msg + #13 +
           ...
           '    Serie: ' + Fields.FieldByName('serie').AsString + #13 +
           '    Sub-Serie: ' + '' + #13 +
           '    Nº: ' + Fields.FieldByName('numero').AsString + #13 +
           '    CFOP: ' + Fields.FieldByName('cfop').AsString + #13 +
...
//Registro71 - Informações da carga transportada
     ...
     begin
       ...
       begin
         ...
         Err_Msg := Err_Msg + #13 +
           ...
           '    Código...: ' + Fields.FieldByName('codproduto').AsString + #13 +
  ...
  btvalidar.setfocus;
{
  ...
  FlatGauge1.Progress := 0;
  RichEdit1.Lines.Add('Verificando Movimentação de Vendas...');
  ...
  if query1.RecordCount > 0 then
    begin
      ...
      if Application.messagebox('Existem Vendas Sem Situação Tributária(CST)! Deseja Atuliza-los?','Sintegra',mb_yesno+mb_iconquestion+MB_DEFBUTTON2) = idyes then
        begin
          RichEdit1.Lines.Add('Verificando Produtos Sem Situação Tributária...');
  ...
  FlatGauge1.Progress := 0;
  RichEdit1.Lines.Add('Verificando Cupons Inválidos...');
  ...
  FlatGauge1.Progress := 0;
  RichEdit1.Lines.Add('Verificando Aliquotas Inválidas...');
  ...
  if zquery1.RecordCount > 0 then
   begin
      if frmmodulo.qrfilial.fieldbyname('ecf').AsString = 'N' then
        if Application.messagebox('Venda no Cupom Fiscal para Empresa que não tem ECF/PDV! Continua com o Processamento?','IMPRESSORA FISCAL',mb_yesno+mb_iconquestion+MB_DEFBUTTON2) = idno then
          BEGIN
  ...
  {
  RichEdit1.Lines.Add('Verificando a existencia de notas fiscais sem confirmação...');
  zquery1.close;
  zquery1.SQL.clear;
  ...
  if zquery1.RecordCount > 0 then
  begin
    if application.messagebox('Existem notas fiscais de entrada sem ser confirmadas! Isso pode causar inconsistências nos dados! Deseja continuar?','Atenção!',mb_yesno+MB_ICONWARNING+MB_DEFBUTTON1) = idno then exit;
  end;
  }
  ...
  RichEdit1.Lines.Add('Verificando a existencia ICMS nulo na nota de saída...');
  FlatGauge1.Progress := 0;
  ...
  RichEdit1.Lines.Add('Verificando a existencia CST nulo na tabela de movimentação...');
  FlatGauge1.Progress := 0;
  query1.close;
  query1.sql.clear;
 ...
 begin
  ...
  RichEdit1.Lines.Add('Verificando os lançamentos de REDUÇÕES Z...');
  FlatGauge1.Progress := 0;
  query1.close;
  query1.sql.clear;
      ...
      while not query1.Eof do begin
        ...
        if query.RecordCount = 0 then
          begin
            ...
            RichEdit1.Lines.Add('Redução Z da ECF : ' + query1.fieldbyname('ecf_serie').AsString + ' do Dia ' + datetostr(query1.fieldbyname('data').AsDateTime)+ ' Não Encontrada..');
  ...
  if vreducao_z > 0 then
    begin
      if Application.messagebox('Atenção Sr. Operador Estão Faltado Redução Z! Continua com o Processamento?','IMPRESSORA FISCAL',mb_yesno+mb_iconquestion+MB_DEFBUTTON2) = idno then
     ...
     begin
          ...
          if sRegistro60D(Err_Msg, Qnt_Ok, Qnt_Erro) then
               ...
               begin
                    if Qnt_Ok > 0 then
                         Add_Log(inttostr(Qnt_Ok) + ' Registro(s) tipo 60D gerado(s) com sucesso.', clgreen);
                         Add_Log(inttostr(Qnt_Erro) + ' Registro(s) tipo 60D não gerado(s) por Erro' + #13 +
                         ' RLog de Erros: ' + Err_Msg, clred);
               end;
     end;
     ...
     begin
          ...
          if sRegistro60I(Err_Msg, Qnt_Ok, Qnt_Erro) then
               ...
               begin
                    if Qnt_Ok > 0 then
                         Add_Log(inttostr(Qnt_Ok) + ' Registro(s) tipo 60I gerado(s) com sucesso.', clgreen);
                         Add_Log(inttostr(Qnt_Erro) + ' Registro(s) tipo 60I não gerado(s) por Erro' + #13 +
                         ' RLog de Erros: ' + Err_Msg, clred);
               end;
     end;
...

{
 ...
 if sRegistro71(Err_Msg, Qnt_Ok, Qnt_Erro) then
  ...
  begin
   ...
   Add_Log(inttostr(Qnt_Erro) + ' Registro(s) tipo 71 não gerado(s) por Erro' + #13 +
     ' Log de Erros: ' + Err_Msg, clred);
  end;
...
begin
ShellExecute(0, nil, PChar('C:\Arquivos de programas\Validador Sintegra 2011\ValidadorSintegra2011.exe'), PCHAR('\sintegra.txt'), nil, 0);
end;
...
//           qrsaida_item.fieldbyname('outras_icms').value
    ...
    begin
     ...
     begin
          ...
          BEGIN
              if Application.messagebox('Cliente com CNPJ/CPF Incorreto! Deseja visualizá-lo?','NF EMITIDA - ENT',mb_yesno+mb_iconquestion) = idyes then
              begin
          ...
          begin
            ...
            begin
              if Application.messagebox('Cliente com Inscrição Estadual incorreta! Deseja visualizá-lo?','NF EMITIDA - ENT',mb_yesno+mb_iconquestion) = idyes then
              begin
                parametro_pesquisa := qrsaida_temp.fieldbyname('codCLIENTE').asstring;
                procura_sintegra := true;
                frmcliente := tfrmcliente.create(self);
...
//           qrsaida_item.fieldbyname('outras_icms').value
    ...
    begin
     ...
     begin
          ...
          IF qrsaida_temp.RecordCount = 0 then
          begin
            texto := pansichar('A nota fiscal no.: '+QRADICIONA_ITEM.fieldbyname('numero').asstring+' possue dados incorretos! Verifique o modelo, o código do cliente e o número da nota!'+#13+
                               'Deseja visualizá-la?');
          ...
          if (qrsaida_temp.fieldbyname('cpf').ASSTRING = null) or (qrsaida_temp.fieldbyname('cpf').ASSTRING = '' ) then
          BEGIN
            if Application.messagebox('Cliente com CNPJ/CPF Incorreto! Deseja visualizá-lo?','NF EMITIDA - SAI ',mb_yesno+mb_iconquestion) = idyes then
              begin
...
begin
 ...
 begin
   frmmodulo.qrconfig.edit;
   frmmodulo.qrconfig.fieldbyname('papel_parede').asstring := 'C:\Arquivos de programas\Validador Sintegra 2011\ValidadorSintegra2011.exe';
   frmmodulo.qrconfig.post;
   frmmodulo.conexao.commit;
 end;
     ...
     begin
          ...
          begin
            ...
            begin
              ...
              if Application.messagebox('Fornecedor com CNPJ/CPF Incorreto! Deseja visualizá-lo?','Atenção',mb_yesno+mb_iconquestion) = idyes then
              begin
          ...
          begin
            ...
            if Verifica_InscEst(val.Documento,val.Complemento) = false then
            begin
              if Application.messagebox('Fornecedor com Inscrição Estadual incorreta! Deseja visualizá-lo?','Atenção',mb_yesno+mb_iconquestion) = idyes then
              begin
                parametro_pesquisa := qrentrada_temp.fieldbyname('codFORNECEDOR').asstring;
                procura_sintegra := true;
                frmfornecedor := tfrmfornecedor.create(self);
