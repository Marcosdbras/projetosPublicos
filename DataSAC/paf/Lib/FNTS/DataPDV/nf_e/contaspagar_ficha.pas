...
begin
  ...
  if query.recordcount > 0 then
    begin
      if application.messagebox(pchar('Já existe uma NOTA FISCAL Cadastrada com este Número'+#13+
                                      'para este FORNECEDOR e com esse VENCIMENTO!'+#13+
                                      'Deseja Continuar Com a Operação?'),'Aviso',mb_yesno+MB_ICONWARNING) = idno then
        exit;
    end;
