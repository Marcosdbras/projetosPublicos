...
uses venda, modulo_nfe, principal, venda_contasreceber, troco, venda_impressao,
  ...
  begin
    ...
    //   ENVIA COMANDO PARA O ECF                                                \\
     ...
     bimp_comprovanteClick(frmvenda_fechamento_vidalink);
      ...
      begin
           // --------------------- EMISSAO DO COMPROVANTE DE AUTORIZAÇÃO DO CONVÊNIO NOTA DE VENDA --------------------------\\
          ...
          if copy(Memo1.Lines[x],1,6) = '000313' then
            ...
            if eresposta_autorizacao.Text <> frmvenda_farma_vidalink.eautorizacao.Text then
              begin
                ...
                ShowMessage('Pré-Autorização de Venda Inválida : ' + emensagem_venda.Text);
