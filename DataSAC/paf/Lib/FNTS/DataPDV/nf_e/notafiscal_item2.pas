...
uses modulo_nfe, principal, venda_serial, NotaFiscal_Item_Serial, xloc_produto,
  ...
  begin
    ...
    if frmnotafiscal.check_desconto.Checked = false then
      begin
       ...
       //frmnotafiscal_menu.qrnota.FieldByName('VALOR_PRODUTOS').asfloat := frmprincipal.Arredondar(vtot_produtos,2);
