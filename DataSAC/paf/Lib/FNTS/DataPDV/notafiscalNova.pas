...
uses
  ...
  Dialogs, StdCtrls, TFlatPanelUnit, Grids, Wwdbigrd, Wwdbgrid,
  NxPageControl, DBCtrls, rxToolEdit, RXDBCtrl, wwdbedit, Wwdotdot,
  Wwdbcomb, RzEdit, RzDBEdit, RzDBBnEd, Mask, ExtCtrls, AdvGlowButton,
  frxClass, frxDesgn, frxDBSet, RxMemDS, DB, MemDS, DBAccess, IBC, Menus,
  ComCtrls;

type
  TfrmNotaFiscalNova = class(TForm)
    Panel3: TPanel;
    Label1: TLabel;
    Label4: TLabel;
    Label36: TLabel;
    ...
    procedure eserieKeyPress(Sender: TObject; var Key: Char);
    procedure DBEdit1Enter(Sender: TObject);
    procedure DBEdit1Exit(Sender: TObject);
    procedure DBEdit1KeyPress(Sender: TObject; var Key: Char);
    procedure EDATA_SAIDAEnter(Sender: TObject);
    procedure EDATA_SAIDAExit(Sender: TObject);
    ...
    procedure RzDBNumericEdit19KeyPress(Sender: TObject; var Key: Char);
    procedure RzDBNumericEdit20Exit(Sender: TObject);
    procedure RzDBNumericEdit20KeyPress(Sender: TObject; var Key: Char);
    procedure RzDBNumericEdit21KeyPress(Sender: TObject; var Key: Char);
...
var
  frmNotaFiscalNova: TfrmNotaFiscalNova;
  comando : string;
...
procedure TfrmNotaFiscalNova.FormClose(Sender: TObject;
...
procedure TfrmNotaFiscalNova.FormCreate(Sender: TObject);
begin
  mostra := false;
end;

procedure TfrmNotaFiscalNova.FormShow(Sender: TObject);
begin
...
procedure TfrmNotaFiscalNova.efilialButtonClick(Sender: TObject);
begin
...
procedure TfrmNotaFiscalNova.efilialEnter(Sender: TObject);
begin
  tedit(sender).Color := clyellow;
end;

procedure TfrmNotaFiscalNova.efilialExit(Sender: TObject);
var
  key : char;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        efilialButtonClick(frmnotafiscalNova);
      end
      else
      begin
        if frmnotafiscal_menu.qrnota.State = dsinsert then
...
procedure TfrmNotaFiscalNova.efilialKeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
end;

procedure TfrmNotaFiscalNova.COMBOMOVIMENTOKeyPress(Sender: TObject;
  var Key: Char);
begin
if key = #13 then perform(wm_nextdlgctl,0,0);
end;

procedure TfrmNotaFiscalNova.ecfopButtonClick(Sender: TObject);
begin
  resultado_pesquisa1 := '';
...
procedure TfrmNotaFiscalNova.ecfopExit(Sender: TObject);
begin
  IF (frmnotafiscal_menu.qrnota.state = dsinsert) or (frmnotafiscal_menu.qrnota.State = dsedit) then
  begin
      ...
      END
        ...
        ecfopButtonClick(frmnotafiscalNova);

  end;

end;

procedure TfrmNotaFiscalNova.ecfopKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then perform(wm_nextdlgctl,0,0);
end;

procedure TfrmNotaFiscalNova.eclienteButtonClick(Sender: TObject);
begin
...
procedure TfrmNotaFiscalNova.eclienteExit(Sender: TObject);
begin
  tedit(sender).Color := clwindow;
end;

procedure TfrmNotaFiscalNova.eclienteKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    begin
      eClienteButtonClick(frmnotafiscalNova);
    end;
  end;

end;

procedure TfrmNotaFiscalNova.DBEdit23Enter(Sender: TObject);
begin
  tedit(sender).Color := clyellow;
end;

procedure TfrmNotaFiscalNova.DBEdit23Exit(Sender: TObject);
var
  key : char;
begin
  tedit(sender).Color := clwindow;
...
procedure TfrmNotaFiscalNova.DBEdit23KeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
end;

procedure TfrmNotaFiscalNova.ENUMEROEnter(Sender: TObject);
begin
  tedit(sender).color := clyellow;
end;

procedure TfrmNotaFiscalNova.ENUMEROExit(Sender: TObject);
begin
  tedit(sender).Color := clwindow;
        ...
        if (frmnotafiscal_menu.qrnota.State = dsinsert) then
          begin
            if APPLICATION.MESSAGEBOX('Existe uma nota fiscal já emitida com este número! Deseja prosseguir?','Atenção',mb_yesno+mb_iconwarning+MB_DEFBUTTON2) = idno then
              bcancelarClick(frmnotafiscalNova);
          end;
      END;
...
procedure TfrmNotaFiscalNova.ENUMEROKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key <> #8 then
  if key = #13 then
...
procedure TfrmNotaFiscalNova.ecodmodeloButtonClick(Sender: TObject);
begin
  resultado_pesquisa3 := '';
  resultado_pesquisa4 := '';
  parametro_pesquisa := '';
...
procedure TfrmNotaFiscalNova.ecodmodeloKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    begin
      ecodmodeloButtonClick(frmnotafiscalNova);
    end;
  end;
...
procedure TfrmNotaFiscalNova.edata_cadastroEnter(Sender: TObject);
begin
 tedit(sender).Color := clyellow;
 if frmnotafiscal_menu.qrnota.state = dsinsert then
...
procedure TfrmNotaFiscalNova.edata_cadastroExit(Sender: TObject);
begin
tedit(sender).Color := clwindow;
...
procedure TfrmNotaFiscalNova.edata_cadastroKeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
end;

procedure TfrmNotaFiscalNova.DBEdit42Enter(Sender: TObject);
begin
  tedit(sender).Color := clyellow;
end;

procedure TfrmNotaFiscalNova.DBEdit42Exit(Sender: TObject);
var
  key : char;
begin
  tedit(sender).Color := clwindow;
...
procedure TfrmNotaFiscalNova.DBEdit42KeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
...
procedure TfrmNotaFiscalNova.eserieEnter(Sender: TObject);
begin
tedit(sender).Color := clyellow;

end;

procedure TfrmNotaFiscalNova.eserieExit(Sender: TObject);
begin
  tedit(sender).Color := clwindow;
     ecliente.SetFocus;
...
procedure TfrmNotaFiscalNova.eserieKeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
...
procedure TfrmNotaFiscalNova.DBEdit1Enter(Sender: TObject);
begin
tedit(sender).Color := clyellow;

end;

procedure TfrmNotaFiscalNova.DBEdit1Exit(Sender: TObject);
begin
  tedit(sender).Color := clwindow;
     ecliente.SetFocus;
...
procedure TfrmNotaFiscalNova.DBEdit1KeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
end;

procedure TfrmNotaFiscalNova.EDATA_SAIDAEnter(Sender: TObject);
begin
 tedit(sender).Color := clyellow;
 if frmnotafiscal_menu.qrnota.state = dsinsert then
...
procedure TfrmNotaFiscalNova.EDATA_SAIDAExit(Sender: TObject);
begin
tedit(sender).Color := clwindow;
...
procedure TfrmNotaFiscalNova.EDATA_SAIDAKeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
end;

procedure TfrmNotaFiscalNova.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
  if key <> #8 then
  if key = #13 then
  perform(wm_nextdlgctl,0,0)
...
procedure TfrmNotaFiscalNova.check_estoqueKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TfrmNotaFiscalNova.check_descontoKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then bincluir_item.setfocus;
end;

procedure TfrmNotaFiscalNova.bincluir_itemClick(Sender: TObject);
begin
  ...
  frmnotafiscal_menu.qrnota.fieldbyname('ITENS').asinteger := nf_item - 1;
    ...
    begin
       ...
       bincluir_itemClick(frmnotafiscalNova);
    end;
...
procedure TfrmNotaFiscalNova.bitbtn9Click(Sender: TObject);
var
  vrecno : integer;
...
procedure TfrmNotaFiscalNova.bexcluir_itemClick(Sender: TObject);
begin
...
procedure TfrmNotaFiscalNova.brateioClick(Sender: TObject);
begin
...
procedure TfrmNotaFiscalNova.bgravarClick(Sender: TObject);
...
begin
   ...
   begin
     ...
     begin
       ...
       begin
         if check_desconto.Checked = true then
            brateioClick(frmnotafiscalNova)
         else
...
procedure TfrmNotaFiscalNova.bcancelarClick(Sender: TObject);
begin
...
procedure TfrmNotaFiscalNova.DBEdit14Enter(Sender: TObject);
begin
tedit(sender).Color := clyellow;
end;

procedure TfrmNotaFiscalNova.DBEdit14Exit(Sender: TObject);
begin
  tedit(sender).color := clwindow;

end;

procedure TfrmNotaFiscalNova.DBEdit14KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then perform(wm_nextdlgctl,0,0);
end;

procedure TfrmNotaFiscalNova.DBEdit15Enter(Sender: TObject);
begin
tedit(sender).Color := clyellow;
end;

procedure TfrmNotaFiscalNova.DBEdit15Exit(Sender: TObject);
begin
  tedit(sender).Color := clwindow;
end;

procedure TfrmNotaFiscalNova.DBEdit15KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then perform(wm_nextdlgctl,0,0);
end;

procedure TfrmNotaFiscalNova.DBEdit7Exit(Sender: TObject);
begin
  tedit(sender).Color := clwindow;
  if (frmnotafiscal_menu.qrnota.State = dsinsert) or (frmnotafiscal_menu.qrnota.State = dsedit) then
  begin
...
procedure TfrmNotaFiscalNova.DBEdit12Exit(Sender: TObject);
begin
  tedit(sender).Color := clwindow;
  if (frmnotafiscal_menu.qrnota.State = dsinsert) or (frmnotafiscal_menu.qrnota.State = dsedit) then
  begin
...
procedure TfrmNotaFiscalNova.ed_serv1ButtonClick(Sender: TObject);
begin
   resultado_pesquisa1 := '';
...
procedure TfrmNotaFiscalNova.ed_serv2ButtonClick(Sender: TObject);
begin
   resultado_pesquisa1 := '';
   frmxloc_servico := Tfrmxloc_servico.create(self);
   frmxloc_servico.showmodal;
...
procedure TfrmNotaFiscalNova.ed_serv3ButtonClick(Sender: TObject);
begin
   resultado_pesquisa1 := '';
   frmxloc_servico := Tfrmxloc_servico.create(self);
   frmxloc_servico.showmodal;
...
procedure TfrmNotaFiscalNova.ed_serv4ButtonClick(Sender: TObject);
begin
   resultado_pesquisa1 := '';
   frmxloc_servico := Tfrmxloc_servico.create(self);
   frmxloc_servico.showmodal;
...
procedure TfrmNotaFiscalNova.ed_serv5ButtonClick(Sender: TObject);
begin
   resultado_pesquisa1 := '';
   frmxloc_servico := Tfrmxloc_servico.create(self);
   frmxloc_servico.showmodal;
...
procedure TfrmNotaFiscalNova.ed_serv1KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    BEGIN
      ...
      begin
        ...
        begin
          ...
          OS_QTDE1Exit(frmnotafiscalNova);
          perform(wm_nextdlgctl,0,0);
        end
        else
        begin
      ...
      begin
        ed_serv1ButtonClick(frmnotafiscalNova);
      end;
    END;
  END;
...
procedure TfrmNotaFiscalNova.ed_serv2KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    BEGIN
      ...
      begin
        ed_serv2ButtonClick(frmnotafiscalNova);
      end;
    END;
  END;
...
procedure TfrmNotaFiscalNova.ed_serv3KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    BEGIN
      ...
      begin
        ed_serv3ButtonClick(frmnotafiscalNova);
      end;
    END;
  END;
...
procedure TfrmNotaFiscalNova.ed_serv4KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    BEGIN
      ...
      begin
        ed_serv4ButtonClick(frmnotafiscalNova);
      end;
    END;
  END;
...
procedure TfrmNotaFiscalNova.ed_serv5KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    BEGIN
      ...
      begin
        ed_serv5ButtonClick(frmnotafiscalNova);
      end;
    END;
  END;
...
procedure TfrmNotaFiscalNova.ed_serv6KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
    ...
    BEGIN
      ...
      begin
        ed_serv6ButtonClick(frmnotafiscalNova);
      end;
    END;
  END;
end;

procedure TfrmNotaFiscalNova.OS_QTDE1Exit(Sender: TObject);
begin
  IF frmnotafiscal_menu.qrnota.State IN [DSINSERT,DSEDIT] THEN
  BEGIN
...
procedure TfrmNotaFiscalNova.RzDBNumericEdit19KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then bgravar.setfocus;
end;

procedure TfrmNotaFiscalNova.RzDBNumericEdit20Exit(Sender: TObject);
begin
  IF frmnotafiscal_menu.qrnota.State IN [DSINSERT,DSEDIT] THEN
  BEGIN
...
procedure TfrmNotaFiscalNova.RzDBNumericEdit20KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then bgravar.setfocus;
end;

procedure TfrmNotaFiscalNova.RzDBNumericEdit21KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then bgravar.setfocus;
end;

procedure TfrmNotaFiscalNova.ed_serv6ButtonClick(Sender: TObject);
begin
   resultado_pesquisa1 := '';
   frmxloc_servico := Tfrmxloc_servico.create(self);
   frmxloc_servico.showmodal;
...
procedure TfrmNotaFiscalNova.grid1KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then bgravar.setfocus;

end;

procedure TfrmNotaFiscalNova.qrreceberBeforePost(DataSet: TDataSet);
begin
