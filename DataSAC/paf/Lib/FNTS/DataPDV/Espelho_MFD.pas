...
var
  frmEspelho_MFD: TfrmEspelho_MFD;
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action := cafree;
end;

// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.bt_cancelarClick(Sender: TObject);
begin
  close;
end;

// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.bt_okClick(Sender: TObject);
...
begin
  ...
  begin
    ...
    begin
      ...
      sMsg := cECF_Arquivo_Fiscal_CAT52(iECF_Modelo,'DATAM',
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.rb_dataClick(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.rb_cooClick(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.ed_data_iniKeyPress(Sender: TObject;
  var Key: Char);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.ed_data_fimKeyPress(Sender: TObject;
  var Key: Char);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.FormShow(Sender: TObject);
begin
  if rb_espelho.Checked then
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.rb_dataKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then
...
// -------------------------------------------------------------------------- //
procedure TfrmEspelho_MFD.rb_espelhoKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
    perform(wm_nextdlgctl,0,0);
...
procedure TfrmEspelho_MFD.rb_crzClick(Sender: TObject);
begin
  ed_data_ini.Visible := false;
  ed_data_fim.Visible := false;
  ed_inicio.Visible   := true;
...
procedure TfrmEspelho_MFD.rb_crzKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then
    perform(wm_nextdlgctl,0,0);
end;

procedure TfrmEspelho_MFD.rb_cooKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then
    perform(wm_nextdlgctl,0,0);
end;
