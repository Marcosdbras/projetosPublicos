...
begin
  frmEspelhoMFD := tfrmEspelhoMFD.Create(self);
...
begin
  ...
  try
    repeat
      sMsg := cECF_Abre_Gerencial(iECF_Modelo,'ID. DO PAF-ECF');
...
procedure TfrmMenu_Fiscal.BitBtn19Click(Sender: TObject);
begin
  cECF_ReducaoZ(iECF_Modelo);
end;
