...
begin
  {Anexo VI -  Arquivo eletronico dos registros Efetuados pelo ECF
   ...
   try
    ...
    sNome_Arquivo := 'C:\DATASAC\paf\Txt\MovtoEcf\' + sECF_Codigo_Sefa + sECF_Serial +
...
begin
  ...
  begin
    ...
    qrpre_venda.sql.add('  and c000074.data <= :datam'); //09/09   aqui <=
...
begin
  ...
  begin
    ...
    begin
      ...
      (******************* P R E   -   V E N D A S ******************************)
      // verificar a existencia de pre-vendas abertas
      ...
      begin
        ...
        begin
          ...
          repeat
            ...
            begin
              spReducaoZ.ParamByName('Data_emissao').asdatetime := formata_data(copy(sMsg,1,8));
              spReducaoZ.ParamByName('Hora_emissao').AsTime := strtotime(formata_hora(copy(sMsg,9,6)));
            end;
          until sMsg <> 'ERRO';
          if sMsg = 'ERRO' then exit;
