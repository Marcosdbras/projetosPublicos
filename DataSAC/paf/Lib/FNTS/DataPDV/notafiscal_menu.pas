...
uses
  ...
  ImgList, AdvMenuStylers, RzDBEdit, RzEdit, rxToolEdit, Mask, RzBtnEdt,
...
uses modulo, principal, xloc_cliente, funcoes, notafiscal, notafiscalNova;
...
begin
  ...
  frmnotafiscalNova := tfrmnotafiscalNova.create(self);
  frmnotafiscalNova.showmodal;
