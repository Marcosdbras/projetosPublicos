object frmContasReceberNovo: TfrmContasReceberNovo
  Left = 3
  Top = 0
  ...
  object NxPageControl1: TNxPageControl
    ...
    object NxTabSheet1: TNxTabSheet
      ...
      object pLegenda: TNxHeaderPanel
        Left = 9
        Top = 42
        Width = 243
        Height = 262
  ...
  object Panel2: TPanel
    ...
    object bestornar: TAdvGlowButton
      Left = 214
      Top = 1
      Width = 100
      Height = 24
  ...
  object qrconfig_cobrebem: TIBCQuery
    Connection = frmModulo.Conexao_Servidor
    SQL.Strings = (
      'select * from c000064')
    Left = 824
  ...
  object qrcontasreceber: TIBCQuery
    ...
    object qrcontasreceberbanco: TStringField
      ...
      FieldKind = fkLookup
      FieldName = 'banco'
      LookupDataSet = qrconfig_cobrebem
    ...
    object qrcontasrecebervalor_anterior: TFloatField
      FieldKind = fkCalculated
  ...
  object qrcr_recibo1: TRxMemoryData
    FieldDefs = <
      item
        Name = 'FILTRO'
        DataType = ftInteger
  ...
  object qrcontasreceber_pgto: TIBCQuery
    Connection = frmModulo.Conexao_Servidor
    SQL.Strings = (
      'select * from c000050')
    Left = 544
