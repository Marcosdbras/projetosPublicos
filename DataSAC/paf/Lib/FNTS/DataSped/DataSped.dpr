...
uses
  ...
  contasreceber in 'util\contasreceber.pas' {frmcontasreceber},
...
begin
  ...
  Hand := FindWindow('TApplication', 'DataSped 2.0');

  // GUIO: 04/03/2010 - Caso não esteja, cria o formulário entra normalmente
  if Hand = 0 then
  begin
    Application.Initialize;
    Application.Title := 'DataSped 2.0';
  Application.CreateForm(TfrmLista_Vendas_Periodo, frmLista_Vendas_Periodo);
