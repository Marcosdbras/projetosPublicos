...
implementation
  ...
  uses funcoes, Constantes, Modulo, Principal;
...
//         showmessage(cDataInicial+' '+cDataFinal);
  ...
  begin
    ...
    try
      if FileExists('C:\DATASAC\paf\exe\uDecoder\WIN_uDecoder.exe') then
      begin
        Executa_Programa('C:\DATASAC\paf\exe\uDecoder\WIN_uDecoder.exe', '', SW_SHOW);
