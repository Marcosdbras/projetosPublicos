object frmNotaFiscal_Item2: TfrmNotaFiscal_Item2
  ...
  Caption = 'NOTA FISCAL | Edi'#231#227'o do Item'
  ClientHeight = 470
  ClientWidth = 667
  Color = clBtnFace
  ...
  object dsserial: TIBCDataSource
    DataSet = qrgrade
    Left = 520
    Top = 64
  end
  object qrgrade: TIBCQuery
    Connection = frmModulo.Conexao_Servidor
    SQL.Strings = (
      'select * from c000021')
    Left = 552
  ...
  object dsgrade: TIBCDataSource
    DataSet = qrgrade
    Left = 584
    Top = 64
  end
  object query1: TIBCQuery
    Connection = frmModulo.Conexao_Servidor
    Left = 616
    Top = 59
  end
  object qrestoque: TIBCQuery
    Connection = frmModulo.Conexao_Servidor
    SQL.Strings = (
      'select * from c000007')
    Left = 400
