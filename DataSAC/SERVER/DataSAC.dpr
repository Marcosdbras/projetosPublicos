...
uses
  ...
  os_impressao_auto in 'fnts\os_impressao_auto.pas' {frmos_impressao_auto},
  ...
  os_item in 'fnts\os_item.pas' {frmos_item},
  os_item_auto in 'fnts\os_item_auto.pas' {frmos_item_auto},
  os_impressao in 'fnts\os_impressao.pas' {frmos_impressao},
  sobre in 'fnts\sobre.pas' {Form_sobre},
  FMapa in 'fnts\FMapa.pas' {FormMapa},
  UFuncoes in 'fnts\UFuncoes.pas',
  GeracaoSPED in 'fnts\GeracaoSPED.pas' {frmGeracaoSPED},
  pedido in '..\FNTS\pedido.pas' {frmpedido},
  pedido_contasreceber in 'fnts\pedido_contasreceber.pas' {frmpedido_contasreceber},
  pedido_impressao in 'fnts\pedido_impressao.pas' {frmpedido_impressao},
  pedido_localizar in 'fnts\pedido_localizar.pas' {frmPedido_localizar},
  Pedido_Abrir in 'fnts\pedido_abrir.pas' {frmPedido_Abrir},
  pedido_fechar in 'fnts\pedido_fechar.pas' {frmpedido_fechar},
  ped_fechamento in 'fnts\ped_fechamento.pas' {frmped_fechamento},
  pedido_serial in 'fnts\pedido_serial.pas' {frmpedido_Serial},
  pedido_grade in 'fnts\pedido_grade.pas' {frmpedido_grade},
  pedido_troco in 'fnts\pedido_troco.pas' {frmpedido_troco},
  pedido_entrega in 'fnts\pedido_entrega.pas' {frmpedido_Entrega},
