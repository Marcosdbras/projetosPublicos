object frmPedido_localizar: TfrmPedido_localizar
  Left = 319
  Top = 202
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      'CODIGO'#9'7'#9'N'#250'mero'#9'F'
      'DATA'#9'10'#9'Data'#9'F'
      'cliente'#9'50'#9'Cliente'#9'F'
  ...
  object qrpedido: TZQuery
    ...
    object dtmfldDATA: TDateTimeField
      DisplayLabel = 'Data'
      DisplayWidth = 10
      FieldName = 'DATA'
    end
    object sqrpedidocliente: TStringField
    ...
    object fTOTAL: TFloatField
      DisplayWidth = 10
      FieldName = 'TOTAL'
      DisplayFormat = '###,###,##0.00'
    end
    object sCODCLIENTE: TStringField
      DisplayWidth = 6
