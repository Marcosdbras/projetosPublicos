    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOS.qrOS_contasreceber.FieldByName('vencimento').asdatetime := strtodate(frmmodulo.qros.fieldbyname('data').asstring)+frmmodulo.qrcondpgto_parcela.fieldbyname('dias').AsInteger;
          ...
          frmOS.qrOS_contasreceber.FieldByName('documento').asstring := frmmodulo.qros.fieldbyname('codigo').asstring +'s'+inttostr(prestacao);
...
begin
  ...
  begin
        ...
        begin
          frmOS.qrOS_contasreceber.Insert;
          frmOS.qrOS_contasreceber.FieldByName('prestacao').asinteger :=  prestacao;
          frmOS.qrOS_contasreceber.FieldByName('vencimento').asdatetime := incmonth(strtodate(frmmodulo.qros.fieldbyname('data').asstring),prestacao);
          frmOS.qrOS_contasreceber.fieldbyname('valor').asfloat := valor;
          frmOS.qrOS_contasreceber.FieldByName('documento').asstring := frmmodulo.qros.fieldbyname('codigo').asstring +'s'+inttostr(prestacao);
          frmOS.qrOS_contasreceber.FieldByName('TIPO').asstring := 'CARTEIRA';
          frmOS.qrOS_contasreceber.post;
