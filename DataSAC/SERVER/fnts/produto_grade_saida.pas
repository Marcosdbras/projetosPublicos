...
type
  Tfrmproduto_grade_saida = class(TForm)
    ...
    qrgrade_saidaCODIGO: TStringField;
    qrgrade_saidaCODPRODUTO: TStringField;
    qrgrade_saidaCODNOTA: TStringField;
    qrgrade_saidaQTDE: TFloatField;
    qrgrade_saidaCODGRADE: TStringField;
    ...
    qrgrade_saidaCODITEM: TStringField;
    Pop2: TPopupMenu;
    Gravar1: TMenuItem;
    Fechar1: TMenuItem;
...
uses modulo, produto_saida, principal;
