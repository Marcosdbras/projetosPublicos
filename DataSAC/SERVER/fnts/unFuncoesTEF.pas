...
begin
  ...
  try
    ...
    begin
      ...
      begin
        windows.CopyFile(pansichar(sTEFKonekPath + 'IntPos.001'),pansichar(sTEFPath + 'RESP\IntPos.001'),true);
...
begin
  ...
  try
    ...
    windows.copyfile(pansichar(sTEFPath + 'RESP\IntPos.001'),pansichar(sTEFKoneKPath+'IntPos.001'),true);
...
//        {$ELSE}
        //bRet := CopyFile(sTEFPath + 'REQ\IntPos.tmp',sTEFPath + 'REQ\IntPos.001');

         windows.CopyFile(pchar(sTEFPath + 'REQ\IntPos.tmp'),pchar(sTEFPath + 'REQ\IntPos.001'),true);
