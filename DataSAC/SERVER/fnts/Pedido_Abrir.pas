...
var
  frmPedido_Abrir: TfrmPedido_Abrir;
...
procedure TfrmPedido_Abrir.bitbtn7Click(Sender: TObject);
...
procedure TfrmPedido_Abrir.bfecharClick(Sender: TObject);
begin
  close;
end;

procedure TfrmPedido_Abrir.FormShow(Sender: TObject);
begin
    qrorcamento.close;
...
procedure TfrmPedido_Abrir.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action := cafree;
end;

procedure TfrmPedido_Abrir.Timer1Timer(Sender: TObject);
begin
  QRORCAMENTO.REFRESH;
end;
