...
uses
  ...
  Menus, Mask, rxtooledit, rxcurredit, AdvGlowButton;
...
begin
  ...
  begin
    ...
    begin
      application.MessageBox('Os valores digitados nesta grade não confere com a quantidade deste produto! Caso não queira utilizar esta grade, favor zerar todos os valores no campo "QUANTIDADE".','Atenção',mb_ok+MB_ICONWARNING);
      wwdbgrid1.setfocus;
    end
    else
    begin
