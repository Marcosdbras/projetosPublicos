...
uses
  ...
  LMDGraphicControl, LMDScrollText, pngimage, AdvPicture, ExceptionLog;
...
type
  ...
  TfrmPrincipal = class(TForm)                         
    ...
    Usurios1: TMenuItem;
    rocadeusurios1: TMenuItem;
    GerencimentodeUsurios2: TMenuItem;
    ArquivoLOG2: TMenuItem;
    ...
    NotaFiscalEmissoNFe201: TMenuItem;
    ...
    Fiananceiro1: TMenuItem;
    CaixaF51: TMenuItem;
    ContasaPagarF101: TMenuItem;
    ContasaReceberF81: TMenuItem;
    ...
    ControledeRotas201: TMenuItem;
    Balano1: TMenuItem;
    SobreSiscom851: TMenuItem;
    Sair1: TMenuItem;
    SairdoSistema2: TMenuItem;
    AtivaodoSistema1: TMenuItem;
    ...
    procedure rocadeusurios1Click(Sender: TObject);
    procedure GerencimentodeUsurios2Click(Sender: TObject);
    procedure ArquivoLOG2Click(Sender: TObject);
    ...
    procedure ProdutosF61Click(Sender: TObject);
    ...
    procedure ConsultadePreoF31Click(Sender: TObject);
    ...
    procedure CaixaF51Click(Sender: TObject);
    procedure ContasaPagarF101Click(Sender: TObject);
    procedure ContasaReceberF81Click(Sender: TObject);
    ...
    procedure AtivaodoSistema1Click(Sender: TObject);
...
begin
  ...
  try
    ...
    Backup.BackupFile.Add(ChangeFileExt('\DataSAC\server\backup\' + FormatDateTime('yyyymmddnnhh', now), '.fbk'));
    Backup.Active := true;

    listbox1.Clear;
    listbox1.Items.Add(Format('Backup Iniciado às %s horas', [FormatDateTime('hh:nn:ss', now)]));
    listbox1.Items.add('Local: \DataSAC\server\backup\');
 ...
 //   bativacao.Visible := true;
  ...
  case FRMMODULO.QRCONFIG.FIELDBYNAME('RAMO_ATIVIDADE').ASINTEGER of
    ...
    4:BEGIN // FARMACIA
       ...
       marcasfabricantes1.Caption:='Laboratórios';

//       BSERVICO.Visible := FALSE;
       servio1.Visible:=false;
//       BOS.Visible := FALSE;
       OrdemdeServio2.Visible:=false;
//       BCONHECIMENTO.Visible := FALSE;
       ConhecimentodeTransporte1.Visible:=false;
//       BVEICULOC.Visible := FALSE;
       Veculos2.Visible:=false;
//       BBALANCA.Visible := FALSE;
       BalanaExportao1.Visible:=false;
//       BROS.VISIBLE := FALSE;
       OrdemdeServio3.Visible:=false;
      end;
  end;
...
procedure TfrmPrincipal.rocadeusurios1Click(Sender: TObject);
begin
 WITH FRMPRINCIPAL DO
 BEGIN
...
procedure TfrmPrincipal.GerencimentodeUsurios2Click(Sender: TObject);
begin
  if frmprincipal.autentica('Config. Usuários',nivel_exclusao) then
  begin
    frmusuario := tfrmusuario.create(self);
...
procedure TfrmPrincipal.ArquivoLOG2Click(Sender: TObject);
begin
  if frmprincipal.autentica('Log de Usuários',nivel_exclusao) then
  begin
    frmusuario_log := tfrmusuario_log.create(self);
...
procedure TfrmPrincipal.servio1Click(Sender: TObject);
begin
...
procedure TfrmPrincipal.ProdutosF61Click(Sender: TObject);
begin
...
procedure TfrmPrincipal.ConsultadePreoF31Click(Sender: TObject);
begin
...
procedure TfrmPrincipal.VendaF21Click(Sender: TObject);
VAR F : TEXTFILE;
slinha : string;
begin
  If frmprincipal.acesso(codigo_usuario,'03.01') = 'NAO' then
...
procedure TfrmPrincipal.NotaFiscalEmissoNFe201Click(Sender: TObject);
begin
 If frmprincipal.acesso(codigo_usuario,'03.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.CaixaF51Click(Sender: TObject);
begin
 If frmprincipal.acesso(codigo_usuario,'04.01') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.ContasaPagarF101Click(Sender: TObject);
begin
 If frmprincipal.acesso(codigo_usuario,'04.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.ContasaReceberF81Click(Sender: TObject);
begin
 If frmprincipal.acesso(codigo_usuario,'04.07') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AtivaodoSistema1Click(Sender: TObject);
begin
