...
procedure Tfrmproduto_auto.elimiteKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tfrmproduto_auto.wwDBGrid1Exit(Sender: TObject);
var estoque : real;
begin
  estoque := 0;
...
procedure Tfrmproduto_auto.Receitas1Click(Sender: TObject);
begin
...
procedure Tfrmproduto_auto.qrcomposicao_produtoBeforePost(DataSet: TDataSet);
begin
...
procedure Tfrmproduto_auto.Indstrializao1Click(Sender: TObject);
begin
  frmcliente_veiculo := tfrmcliente_veiculo.create(self);
  frmcliente_veiculo.showmodal;al;
...
procedure Tfrmproduto_auto.bexclui_barraClick(Sender: TObject);
begin
...
procedure Tfrmproduto_auto.bgrava_barraClick(Sender: TObject);
begin
...
procedure Tfrmproduto_auto.GravarCodigodeBarra1Click(Sender: TObject);
begin
  bgrava_barraClick(frmproduto);
end;

procedure Tfrmproduto_auto.excluircodigodebarra1Click(Sender: TObject);
begin
  bexclui_barraClick(frmproduto);
end;
...
procedure Tfrmproduto_auto.bcodigoClick(Sender: TObject);
begin
  if combocodbarra.Text = 'VARIOS' then
    begin
      PopupMenu := pop_barra;
...
procedure Tfrmproduto_auto.FormDestroy(Sender: TObject);
begin
  frmproduto := nil;
end;
