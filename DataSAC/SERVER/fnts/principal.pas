...
begin
  ...
  with frmmodulo do
    begin
       ...
       //-- Vari·veis globais proveniente de funcoes_ibpt
   ...
   memo1.Lines.Add('3) No final da p·gina localize a frase');
   memo1.Lines.Add('   VocÍ precisa fazer o login para publicar um coment·rio.');
   memo1.Lines.Add('4) Clique em LOGIN');
   memo1.Lines.Add('5) Se vocÍ j· est· cadastrado utilize seu nome de usu·rio e senha / FAZER LOGIN para se autenticar');
   memo1.Lines.Add('   ou clique em PERDEU A SENHA se este for o motivo');
   memo1.Lines.Add('6) Caso n„o tenha cadastro clique em REGISTRA-SE');
   memo1.Lines.Add('7) ApÛs se autenticar localize a frase DEIXE UMA RESPOSTA ou COMENT¡RIO e');
   memo1.Lines.Add('   informe ID DA INSTALA«√O '+ IntToStr(bloqueio.IDInstalacao));
   memo1.Lines.Add('   identificaÁ„o do pagamento / CNPJ da empresa / Nome do contato / email e telefone');
   memo1.Lines.Add('8) Depois clique em PUBLICAR COMENT¡RIO ');
   memo1.Lines.Add('9) Aguarde contato via email');
   memo1.Lines.Add('Em caso de d˙vida envie mensagem para contato@marcosbras.com');
   ...
   memo1.Lines.Add(  'ID da instalaÁ„o : '+ IntToStr(bloqueio.IDInstalacao) );
...
begin
  try
     ...
     //tenviaxml.Terminate;
      reResp.Lines.Add('fim da sincronizaÁ„o');
  end;
    ...
    begin
        ...
        try
            ...
            try
              ...
              reResp.Lines.Add( 'Conex„o com servidor inativa');
            end;
