...
uses
  ...
  Dialogs, ExtCtrls, Collection, StdCtrls, Mask, TFlatPanelUnit, Buttons, Menus, wwdbedit, Wwdotdot, Wwdbcomb, DB,
  ...
  RzEdit, RzSpnEdt, frxDesgn, frxClass, frxDBSet, RxMemDS, rxToolEdit,
  rxCurrEdit;
...
//+      FRMMODULO.QRPRODUTO_MOV.OPEN;
      ...
      //query1.Close;
      //query1.SQL.Clear;
      //query1.SQL.Add('update C000056PEDIDO set desconto = :desconto, acrescimo = :acrescimo where codigo = :codigo');
      //query1.Params.ParamByName('desconto').AsFloat :=  rdesconto2.Value;
      //query1.Params.ParamByName('acrescimo').AsFloat := racrescimo2.Value;

      //query1.Params.ParamByName('codigo').AsString := frmpedido.scodPedido;
      //query1.ExecSQL;
      ...
      frmmodulo.qrPedido.FieldByName('desconto1').Asfloat := rdesconto1.Value;
      frmmodulo.qrPedido.FieldByName('acrescimo1').Asfloat := racrescimo1.Value;

      frmmodulo.qrPedido.FieldByName('total').Asfloat := frmmodulo.qrPedido.FieldByName('total').Asfloat-rdesconto2.Value+racrescimo2.Value;
