object frmmemorando: Tfrmmemorando
  Left = 329
  Top = 196
  Width = 659
  Height = 464
  Caption = 'MEMORANDO DE EXPORTA'#199#195'O | Nota Fiscal'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object panel1: TAdvOfficeStatusBar
    Left = 0
    Top = 0
    Width = 651
    Height = 32
    ...
    object ememorando: TRzEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnEnter = ememorandoEnter
      OnExit = ememorandoExit
      OnKeyPress = ememorandoKeyPress
    end
    object esituacao: TRzEdit
      Left = 377
      Top = 6
      Width = 34
      Height = 21
  ...
  object tab_principal: TAdvToolBarPager
    ...
    object AdvPage1: TAdvPage
      ...
      Width = 643
      Height = 327
      Caption = 'Dados da Exporta'#231#227'o'
      ImageIndex = 10
      object AdvOfficeStatusBar18: TAdvOfficeStatusBar
        Left = 16
        Top = 139
        Width = 226
        Height = 21
        ...
        object Label11: TLabel
          ...
          Width = 169
          Height = 13
          Caption = 'DESPACHO DE EXPORTA'#199#195'O'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object AdvOfficeStatusBar2: TAdvOfficeStatusBar
        ...
        object Label7: TLabel
          ...
          Width = 165
          Height = 13
          Caption = 'REGISTRO DE EXPORTA'#199#195'O'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object AdvOfficeStatusBar4: TAdvOfficeStatusBar
        ...
        object Label9: TLabel
          ...
          Width = 196
          Height = 13
          Caption = 'ESTADO PRODUTOR/FABRICANTE'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object AdvOfficeStatusBar5: TAdvOfficeStatusBar
        Left = 16
        Top = 227
        Width = 226
        Height = 21
        ...
        object Label10: TLabel
          ...
          Width = 210
          Height = 13
          Caption = 'PA'#205'S DE DESTINO DA MERCADORIA'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object AdvOfficeStatusBar9: TAdvOfficeStatusBar
        Left = 206
        Top = 32
        Width = 75
        Height = 21
      ...
      object codfornecedor: TRzButtonEdit
        Left = 107
        Top = 86
        Width = 74
        Height = 21
        ...
        ParentFont = False
        TabOrder = 4
        OnEnter = enotafiscal_saidaEnter
        OnExit = codfornecedorExit
        OnKeyPress = ememorandoKeyPress
        ButtonGlyph.Data = {
          ...
          FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF738FFFFFFFFFFFF7783FFFFFFFFFFF878
          73FFFFF8888887883FFFFF88FFF88887FFFFF88F8888F87FFFFFF8FF8888888F
          FFFFF8F888888F8FFFFFF8FF88888F8FFFFFF8FFF888FF8FFFFFFFFFFFFFF88F
          FFFFFFFFFFFF88FFFFFFFFFF8888FFFFFFFFFFFFFFFFFFFFFFFF}
        ButtonNumGlyphs = 1
        ButtonKind = bkCustom
        OnButtonClick = codfornecedorButtonClick
      end
      object codtransportador: TRzButtonEdit
        Left = 243
        Top = 278
        Width = 74
        Height = 21
        ...
        ButtonNumGlyphs = 1
        ButtonKind = bkCustom
        OnButtonClick = codtransportadorButtonClick
      end
      object efornecedor: TRzEdit
        Left = 182
        Top = 86
        Width = 251
        Height = 21
      ...
      object edatanf: TRzDateTimeEdit
        Left = 503
        Top = 32
        Width = 102
        Height = 21
      ...
      object enotafiscal_saida: TRzButtonEdit
        Left = 107
        Top = 32
        Width = 97
        Height = 21
        ...
        ButtonNumGlyphs = 1
        ButtonKind = bkCustom
        OnButtonClick = enotafiscal_saidaButtonClick
      end
      object AdvOfficeStatusBar12: TAdvOfficeStatusBar
        ...
        object Label15: TLabel
          ...
          Width = 168
          Height = 14
          Caption = 'DADOS DA EXPORTA'#199#195'O'
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'Verdana'
      ...
      object AdvOfficeStatusBar14: TAdvOfficeStatusBar
        ...
        object Label17: TLabel
          ...
          Width = 375
          Height = 14
          Caption = 'REMETENTE COM FINS DE EXPORTA'#199#195'O / NOTA FISCAL'
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'Verdana'
      ...
      object AdvOfficeStatusBar16: TAdvOfficeStatusBar
        Left = 434
        Top = 86
        Width = 86
        Height = 21
      ...
      object enotafiscal_entrada: TRzButtonEdit
        Left = 521
        Top = 86
        Width = 83
        Height = 21
        ...
        TabOrder = 32
        OnEnter = enotafiscal_saidaEnter
        OnExit = enotafiscal_entradaExit
        OnKeyPress = ememorandoKeyPress
        ButtonGlyph.Data = {
          F6000000424DF600000000000000760000002800000010000000100000000100
          0400000000008000000000000000000000001000000000000000000000000000
        ...
        ButtonNumGlyphs = 1
        ButtonKind = bkCustom
        OnButtonClick = enotafiscal_entradaButtonClick
      end
      object epais: TRzComboBox
        Left = 243
        Top = 227
        Width = 362
        Height = 21
      ...
      object AdvOfficeStatusBar17: TAdvOfficeStatusBar
        Left = 16
        Top = 300
        Width = 226
        Height = 21
        ...
        object Label20: TLabel
          ...
          Width = 165
          Height = 13
          Caption = 'PA'#205'S DA TRANSPORTADORA'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object epais_transportadora: TRzComboBox
        Left = 243
        Top = 300
        Width = 362
        Height = 21
        ...
        TabOrder = 34
        OnEnter = ememorandoEnter
        OnExit = epais_transportadoraExit
        OnKeyPress = ememorandoKeyPress
        Items.Strings = (
          'ALEMANHA'
          'ARGENTINA'
      ...
      object edespacho_data: TDateEdit
        Left = 530
        Top = 139
        Width = 74
        Height = 21
      ...
      object eregistro_data: TDateEdit
        Left = 530
        Top = 161
        Width = 75
        Height = 21
      ...
      object econhecimento_data: TDateEdit
        Left = 530
        Top = 183
        Width = 75
        Height = 21
    ...
    object AdvPage5: TAdvPage
      ...
      object GRID1: TwwDBGrid
        ...
        Selected.Strings = (
          'quantidade'#9'11'#9'QUANTIDADE'
          'unidade'#9'8'#9'UNIDADE'
          'produto'#9'57'#9'PRODUTO'
          'unitario'#9'9'#9'UNITARIO'
          'total'#9'9'#9'TOTAL')
    ...
    object AdvPage2: TAdvPage
      ...
      object GRID2: TwwDBGrid
        ...
        DisableThemesInTitle = False
        Selected.Strings = (
          'notafiscal'#9'7'#9'N.FISCAL'
          'fornecedor'#9'46'#9'FORNECEDOR'
          'modelo'#9'10'#9'MODELO'
          'quantidade'#9'11'#9'QUANTIDADE'
          'unidade'#9'8'#9'UNIDADE'
          'data'#9'10'#9'DATA')
        IniAttributes.Delimiter = ';;'
    ...
    object AdvPage3: TAdvPage
      ...
      ImageIndex = 97
      object AdvOfficeStatusBar19: TAdvOfficeStatusBar
        Left = 8
        Top = 18
        Width = 185
        Height = 21
        ...
        object Label21: TLabel
          ...
          Width = 170
          Height = 13
          Caption = 'N'#218'MERO DO CONHECIMENTO'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object enumero_conhecimento: TRzEdit
        Left = 192
        Top = 18
        Width = 113
        Height = 21
      ...
      object AdvOfficeStatusBar20: TAdvOfficeStatusBar
        Left = 8
        Top = 42
        Width = 185
        Height = 21
      ...
      object AdvOfficeStatusBar21: TAdvOfficeStatusBar
        Left = 8
        Top = 66
        Width = 185
        Height = 21
        ...
        object Label23: TLabel
          ...
          Width = 170
          Height = 13
          Caption = 'MODELO DO CONHECIMENTO'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object AdvOfficeStatusBar22: TAdvOfficeStatusBar
        Left = 8
        Top = 90
        Width = 185
        Height = 21
        ...
        object Label24: TLabel
          ...
          Width = 156
          Height = 13
          Caption = 'S'#201'RIE DO CONHECIMENTO'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Verdana'
      ...
      object emodelo_conhecimento: TRzEdit
        Left = 192
        Top = 66
        Width = 113
        Height = 21
      ...
      object eserie_conhecimento: TRzEdit
        Left = 192
        Top = 90
        Width = 73
        Height = 21
        ...
        TabOrder = 3
        OnEnter = ememorandoEnter
        OnExit = eserie_conhecimentoExit
        OnKeyPress = ememorandoKeyPress
      end
      object edata_conhecimento: TDateEdit
        Left = 192
        Top = 42
        Width = 74
        Height = 21
  ...
  object rxnotas: TRxMemoryData
    ...
    Left = 428
    Top = 171
    object rxnotasnotafiscal: TStringField
      DisplayLabel = 'N.FISCAL'
      DisplayWidth = 7
      FieldName = 'notafiscal'
      Size = 6
    end
    object rxnotasfornecedor: TStringField
      DisplayLabel = 'FORNECEDOR'
      DisplayWidth = 46
      FieldName = 'fornecedor'
      Size = 40
    end
    object rxnotasmodelo: TStringField
      DisplayLabel = 'MODELO'
      DisplayWidth = 10
      FieldName = 'modelo'
      Size = 10
    end
    object rxnotasquantidade: TFloatField
      DisplayLabel = 'QUANTIDADE'
      DisplayWidth = 11
      FieldName = 'quantidade'
      DisplayFormat = '###,###,##0.000'
    end
    object rxnotasunidade: TStringField
      DisplayLabel = 'UNIDADE'
      DisplayWidth = 8
      FieldName = 'unidade'
      Size = 2
    end
    object rxnotasdata: TDateField
      DisplayLabel = 'DATA'
      DisplayWidth = 10
      FieldName = 'data'
    end
    object rxnotascodfornecedor: TStringField
      DisplayWidth = 6
  ...
  object rxitem: TRxMemoryData
    ...
    object rxitemunidade: TStringField
      DisplayLabel = 'UNIDADE'
      DisplayWidth = 8
      FieldName = 'unidade'
      Size = 2
    ...
    object rxitemcodproduto: TStringField
  ...
  object rxconhecimento: TRxMemoryData
    Active = True
    FieldDefs = <
      item
        Name = 'ctrc'
    ...
    Left = 460
    Top = 171
    object rxconhecimentoctrc: TStringField
      DisplayLabel = 'N.CTRC'
      DisplayWidth = 20
      FieldName = 'ctrc'
      Size = 6
    end
    object rxconhecimentodata: TDateField
      DisplayLabel = 'DATA'
      DisplayWidth = 20
      FieldName = 'data'
    end
    object rxconhecimentomodelo: TStringField
      DisplayLabel = 'MODELO'
      DisplayWidth = 20
      FieldName = 'modelo'
      Size = 10
    end
    object rxconhecimentoserie: TStringField
