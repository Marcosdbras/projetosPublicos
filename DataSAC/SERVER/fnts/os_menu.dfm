object frmOs_menu: TfrmOs_menu
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'cliente'#9'32'#9'Cliente'#9#9
      'TOTAL'#9'10'#9'Total-R$'#9#9
      'SERIAL'#9'15'#9'Serial / Placa'#9'F'
      'MARCA'#9'11'#9'Marca'#9'F'#9'Equipamento / Ve'#237'culo'
      'MODELO'#9'10'#9'Modelo'#9'F'#9'Equipamento / Ve'#237'culo')
  ...
  object Panel2: TPanel
    ...
    object bExcluir: TAdvGlowButton
      ...
      ParentFont = False
      Picture.Data = {
        424D260500000000000036040000280000000F0000000F000000010008000000
        0000F0000000610B0000610B0000000000000000000000000000330000006600
        ...
        
        A5EEEEEEEE00}
      TabOrder = 4
