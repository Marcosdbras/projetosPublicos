...
type
  Tfrmexporta = class(TForm)
    ...
    fslog: TfrxDBDataset;
    qrentradaCODIGO: TStringField;
    qrentradaNUMERO: TStringField;
    qrentradaCODEMPRESA: TStringField;
    qrentradaCODFORNECEDOR: TStringField;
    qrentradaMODELO: TStringField;
    qrentradaESPECIE: TStringField;
    qrentradaSERIE: TStringField;
    ...
    qrentradaTRANSP_NOME: TStringField;
    qrentradaTRANSP_FRETE: TStringField;
    qrentradaTRANSP_PLACA: TStringField;
    qrentradaTRANSP_PLACAUF: TStringField;
    qrentradaTRANSP_IE: TStringField;
    qrentradaTRANSP_CNPJ: TStringField;
    qrentradaTRANSP_ENDERECO: TStringField;
    qrentradaTRANSP_CIDADE: TStringField;
    qrentradaTRANSP_UF: TStringField;
    qrentradaTRANSP_QTDE: TFloatField;
    qrentradaTRANSP_ESPECIE: TStringField;
    qrentradaTRANSP_MARCA: TStringField;
    qrentradaTRANSP_NUMERO: TStringField;
    qrentradaTRANSP_PESOBRUTO: TFloatField;
    qrentradaTRANSP_PESOLIQUIDO: TFloatField;
    qrentradaOBS1: TStringField;
    qrentradaOBS2: TStringField;
    qrentradaOBS3: TStringField;
    qrentradaOBS4: TStringField;
    qrentradaOBS5: TStringField;
    qrentradaOBS6: TStringField;
    qrentradaOBS7: TStringField;
    qrentradaSITUACAO: TIntegerField;
    qrentradaITENS: TIntegerField;
    qrentradaTIPO: TStringField;
    qrentradaNOTA_FISCAL: TStringField;
    qrentradaVALOR_MERCADORIAS: TFloatField;
    qrentradaCODREMETENTE: TStringField;
    ...
    qrentradaOBS8: TStringField;
    qrentradaOPERACAO: TStringField;
    qrentradaINTEGRACAO: TIntegerField;
    qrentradaCODIGO_1: TStringField;
    qrentradaNOME: TStringField;
    qrentradaCNPJ: TStringField;
    qrentradaIE: TStringField;
    qrentradaUF: TStringField;
    qrentradaCOD_MUNICIPIO_IBGE: TStringField;
    qrsaidaCODIGO: TStringField;
    qrsaidaNUMERO: TStringField;
    qrsaidaCFOP: TStringField;
    qrsaidaDATA: TDateTimeField;
    qrsaidaCODCLIENTE: TStringField;
    ...
    qrsaidaCODTRANSPORTADOR: TStringField;
    qrsaidaFRETE_CONTA: TIntegerField;
    qrsaidaPLACA: TStringField;
    qrsaidaPLACA_UF: TStringField;
    qrsaidaVOL_QTDE: TFloatField;
    qrsaidaVOL_ESPECIE: TStringField;
    qrsaidaVOL_MARCA: TStringField;
    qrsaidaVOL_NUMERO: TStringField;
    qrsaidaPESO_LIQUIDO: TFloatField;
    qrsaidaPESO_BRUTO: TFloatField;
    qrsaidaSITUACAO: TIntegerField;
    qrsaidaMOTIVO: TStringField;
    ...
    qrsaidaFATURAMENTO_NUMERO1: TStringField;
    qrsaidaFATURAMENTO_NUMERO2: TStringField;
    qrsaidaFATURAMENTO_NUMERO3: TStringField;
    qrsaidaFATURAMENTO_NUMERO4: TStringField;
    ...
    qrsaidaCODFILIAL: TStringField;
    qrsaidaOBS1: TStringField;
    qrsaidaOBS2: TStringField;
    qrsaidaOBS3: TStringField;
    qrsaidaINF1: TStringField;
    qrsaidaINF2: TStringField;
    qrsaidaINF3: TStringField;
    qrsaidaINF4: TStringField;
    qrsaidaINF5: TStringField;
    qrsaidaDATA_SAIDA: TDateTimeField;
    qrsaidaHORA: TStringField;
    qrsaidaSITUACAO_A: TStringField;
    qrsaidaMODELO_NF: TStringField;
    qrsaidaSERIE_NF: TStringField;
    qrsaidaVALOR_ISENTO_ICMS: TFloatField;
    qrsaidaALIQUOTA_ICMS: TFloatField;
    qrsaidaSIT: TStringField;
    qrsaidaCODLANCAMENTO: TStringField;
    qrsaidaMOVIMENTO: TStringField;
    qrsaidaBAIXA_ESTOQUE: TStringField;
    qrsaidaTIPO: TStringField;
    qrsaidaOS_COD1: TStringField;
    qrsaidaOS_COD2: TStringField;
    qrsaidaOS_COD3: TStringField;
    qrsaidaOS_COD4: TStringField;
    qrsaidaOS_COD5: TStringField;
    qrsaidaOS_COD6: TStringField;
    qrsaidaOS_SERV1: TStringField;
    qrsaidaOS_SERV2: TStringField;
    qrsaidaOS_SERV3: TStringField;
    qrsaidaOS_SERV4: TStringField;
    qrsaidaOS_SERV5: TStringField;
    qrsaidaOS_SERV6: TStringField;
    qrsaidaOS_COMP1: TStringField;
    qrsaidaOS_COMP2: TStringField;
    qrsaidaOS_COMP3: TStringField;
    qrsaidaOS_COMP4: TStringField;
    qrsaidaOS_COMP5: TStringField;
    qrsaidaOS_COMP6: TStringField;
    ...
    qrsaidaFAT_FORMA_PGTO: TStringField;
    ...
    qrsaidaCODVENDEDOR: TStringField;
    qrsaidaCUSTO_VENDA: TStringField;
    qrsaidaOPERACAO: TStringField;
    qrsaidaINTEGRACAO: TIntegerField;
    qrsaidaCODIGO_1: TStringField;
    qrsaidaNOME: TStringField;
    qrsaidaCPF: TStringField;
    qrsaidaRG: TStringField;
    qrsaidaUF: TStringField;
    qrsaidaCOD_MUNICIPIO_IBGE: TStringField;
    qrfaturas: TZQuery;
    ...
    qrfaturasCODCONTA: TStringField;
    qrfaturasCODFORNECEDOR: TStringField;
    ...
    qrfaturasDOCUMENTO: TStringField;
    qrfaturasNOTAFISCAL: TStringField;
    qrfaturasHISTORICO: TStringField;
    qrfaturasC: TStringField;
    qrfaturasE: TStringField;
    qrfaturasFILTRO: TIntegerField;
    qrfaturasESPECIE: TStringField;
    qrfaturasSITUACAO: TIntegerField;
    qrfaturasCODNOTA: TStringField;
    qrfaturasMOVIMENTO: TIntegerField;
    qrfaturasCODCAIXA: TStringField;
    qrfaturasCODIGO_1: TStringField;
    qrfaturasNUMERO: TStringField;
    qrfaturasCODFORNECEDOR_1: TStringField;
    qrfaturasDATA_LANCAMENTO: TDateTimeField;
    qrfaturasMODELO: TStringField;
    qrfaturasSERIE: TStringField;
    qrfaturasESPECIE_1: TStringField;
    qrfaturasCODIGO_2: TStringField;
    qrfaturasNOME: TStringField;
    qrfaturasCNPJ: TStringField;
    qrfaturasIE: TStringField;
    qrfaturasUF: TStringField;
    qrfaturasCOD_MUNICIPIO_IBGE: TStringField;
    qrreducaoz: TZQuery;
    qrreducaozID: TIntegerField;
    qrreducaozMOVIMENTO: TStringField;
    qrreducaozCODIGO_EMPRESA: TIntegerField;
    qrreducaozOBS1: TStringField;
    qrreducaozCNPJ: TStringField;
    qrreducaozIE: TStringField;
    qrreducaozUF: TStringField;
    qrreducaozCODIGO_CLIENTE: TIntegerField;
    qrreducaozCNPJ_CLIENTE: TStringField;
    qrreducaozIE_CLIENTE: TStringField;
    qrreducaozUF_CLIENTE: TStringField;
    qrreducaozCFOP: TStringField;
    qrreducaozCOD_SINTEGRA_R60: TStringField;
    qrreducaozDATA_EMISSAO: TDateTimeField;
    qrreducaozNRO_SERIE_EQP: TStringField;
    qrreducaozNRO_ORDEM_EQP: TIntegerField;
    qrreducaozMODELO_DOC: TStringField;
    ...
    qrreducaozBRANCOS: TStringField;
    qrreducaozDATAHORA_RECEBIMENTO: TDateTimeField;
    qrreducaozMODELO_NF: TStringField;
    ...
    qrreducaozBRANCOS_60A01: TStringField;
    qrreducaozBRANCOS_60A02: TStringField;
    qrreducaozBRANCOS_60A03: TStringField;
    qrreducaozBRANCOS_60A04: TStringField;
    qrreducaozBRANCOS_60A05: TStringField;
    qrreducaozTOTAL_INICIO_DIA: TFloatField;
    qrreducaozTOTAL_FINAL_DIA: TFloatField;
    qrreducaozTOTAL_DIA: TFloatField;
    qrreducaozOBSERVACAO: TStringField;
...
begin
if Trim(ecaminho.text)='' then
begin
  ShowMessage('Escolha um caminho de destino para a exportação dos dados!');
  exit;
end;
if fileexists(ecaminho.Text) then
  ...
  begin
    if application.messagebox('Existem notas fiscais de entrada sem ser confirmadas! Isso pode causar inconsistências nos dados! Deseja continuar?','Atenção!',mb_yesno+MB_ICONWARNING) = idno then exit;
  end;
  ...
  Add_Log('Exportação de Dados iniciada em ' + datetimetostr(now),clblue);

//  if rpsoftw.Checked = true then
     btprosoftwClick(frmexporta);
{  else
     begin
          showmessage('Opção ainda não implementada, Fale com o Suporte!');
          exit;
     end;
}
  if not debug then
    Add_Log('Exportação Concluída com Sucesso em ' + datetimetostr(now),clblue)
  else
    Add_Log('Exportação de Dados Interrompida ' + datetimetostr(now),clblue);
...
begin
  ...
  if query.RecordCount > 0 then
    begin
      ...
      while not query.Eof do begin
        ...
        if Trim(v05) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - CPF/CNPJ Inválido',clRed);
            rxlog.Append;
            ...
            rxloglog.AsString := 'CPF/CNPJ Inválido';
            rxlog.Post;
          end;

        v06 := frmPrincipal.texto_justifica(query.fieldbyname('NOME').AsString,60,' ','D'); // nome/razão social
        ...
        if Trim(v07) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - APELIDO Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'APELIDO Inválido';
            rxlog.Post;
          end;
        }

        v08 := frmPrincipal.texto_justifica('',10,' ','D'); // endereço - tipo de logradouro
        v09 := frmPrincipal.texto_justifica(query.fieldbyname('ENDERECO').AsString,60,' ','D'); // endereço - logradouro

        if Trim(v09) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - LOGRADOURO Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'LOGRADOURO Inválido';
            rxlog.Post;
          end;
        v10 := frmPrincipal.texto_justifica('SN',10,' ','D'); // endereço - numero
        if Trim(v10) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - NÚMERO Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'NÚMERO Inválido';
            rxlog.Post;
          end;

        v11 := frmPrincipal.texto_justifica(query.fieldbyname('COMPLEMENTO').AsString,20,' ','D'); // endereço - complemento

        v12 := frmPrincipal.texto_justifica(frmPrincipal.FormataCEP(query.fieldbyname('CEP').AsString),9,' ','D'); // endereço - cep
        if Trim(v12) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - CEP Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'CEP Inválido';
            rxlog.Post;
          end;

        v13 := frmPrincipal.texto_justifica(query.fieldbyname('BAIRRO').AsString,30,' ','D'); // endereço - bairro
        if Trim(v13) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - BAIRRO Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'BAIRROInválido';
            rxlog.Post;
          end;

        v14 := frmPrincipal.texto_justifica(query.fieldbyname('CIDADE').AsString,30,' ','D'); // endereço - município
        if Trim(v14) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - MUNICIPIO Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'MUNICÍPIO Inválido';
            rxlog.Post;
          end;

        v15 := frmPrincipal.texto_justifica(query.fieldbyname('UF').AsString,2,' ','D'); // endereço - uf

        if Trim(v15) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - UF Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'UF Inválida';
            rxlog.Post;
          end;
        ...
        if ( query.fieldbyname('NASCIMENTO').AsString <> ' / /' ) and
          ...
          begin
            ...
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - DATA DE NASCIMENTO Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'DATA DE NASCIMENTO Inválida';
            rxlog.Post;
          end;
        ...
        if Trim(v21) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - EMAIL Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'EMAIL Inválido';
            rxlog.Post;
          end;
        ...
        if Trim(v22) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - HOME-PAGE Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'HOME-PAGE Inválido';
            rxlog.Post;
          end;
        ...
        if query.fieldbyname('TIPO').AsInteger = 2 then  // JURIDICA
          begin
              if frmPrincipal.somenteNumero(query.fieldbyname('RG').AsString) = '' then
                ...
                v23 := frmPrincipal.texto_justifica(frmPrincipal.somenteNumero(query.fieldbyname('RG').AsString),20,' ','D'); // inscrição estadual
          end;

        if Trim(v23) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - INSC. ESTADUAL Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'INSC.ESTADUAL Inválido';
            rxlog.Post;
          end;

        v24 := frmPrincipal.texto_justifica('',20,' ','D'); // inscrição municipal
        if Trim(v24) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - INSC. MUNICIPAL Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'INSC. MUNICIPAL Inválido';
            rxlog.Post;
          end;
        ...
        if query.fieldbyname('TIPO').AsInteger = 1 then  // fisica
          begin
            ...
            if Trim(v26) = '' then
              begin
                Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - RG / NÚMERO - Inválido',clRed);
                rxlog.Append;
                rxlogtabela.AsString := 'CLIENTES';
                rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
                rxlognome.AsString := query.fieldbyname('NOME').AsString;
                rxloglog.AsString := 'RG / NÚMERO - Inválido';
                rxlog.Post;
              end;
            if Trim(v27) = '' then
              begin
                Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - RG / ORGÃO EMISSOR - Inválido',clRed);
                rxlog.Append;
                rxlogtabela.AsString := 'CLIENTES';
                rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
                rxlognome.AsString := query.fieldbyname('NOME').AsString;
                rxloglog.AsString := 'RG / ORGÃO EMISSOR - Inválido';
                rxlog.Post;
              end;
            if Trim(v28) = '' then
              begin
                Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - RG / ESTADO DO EMISSOR - Inválido',clRed);
                rxlog.Append;
                rxlogtabela.AsString := 'CLIENTES';
                rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
                rxlognome.AsString := query.fieldbyname('NOME').AsString;
                rxloglog.AsString := 'RG / ESTADO DO EMISSOR - Inválido';
                rxlog.Post;
              end;
            if Trim(v29) = '' then
              begin
                Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - RG / DATA DE EMISSÃO - Inválida',clRed);
                rxlog.Append;
                rxlogtabela.AsString := 'CLIENTES';
                rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
                rxlognome.AsString := query.fieldbyname('NOME').AsString;
                rxloglog.AsString := 'RG / DATA DE EMISSÃO - Inválida';
                rxlog.Post;
              end;
          end
        else
        ...
        if Trim(v31) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - CÓDIGO DO PAÍS Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'CÓDIGO DO PAÍS Inválido';
            rxlog.Post;
          end;
        ...
        if Trim(v32) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - CÓDIGO DO IBGE Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'CÓDIGO DO IBGE Inválido';
            rxlog.Post;
          end;
        ...
        if Trim(v34) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - CÓDIGO DO MUNICÍPIO Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'CLIENTES';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'CÓDIGO DO MUNICÍPIO Inválido';
            rxlog.Post;
          end;
        }
  ...
  if query.RecordCount > 0 then
    begin
      ...
      while not query.Eof do begin
        ...
        if Trim(v08) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - TIPO DE LOGRADOURO Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FORNECEDOR';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'TIPO LOGRADOURO Inválido';
            rxlog.Post;
          end;
        ...
        if Trim(v13) = '' then
          begin
            ...
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'BAIRRO Inválido';
            rxlog.Post;
          end;
        ...
        if Trim(v14) = '' then
          begin
            ...
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'MUNICIPIO Inválido';
            rxlog.Post;
          end;
        ...
        if ( datetostr(query.fieldbyname('DATA').ASdatetime) <> '30/12/1899' ) then
          ...
          begin
            v16 := frmPrincipal.texto_justifica('',8,' ','D'); // data anscimento/inicio atividade
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - INICIO DAS ATIVIDADES Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FORNECEDOR';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'INICIO DAS ATIVIDADES Inválida';
            rxlog.Post;
          end;
        ...
        if Trim(v22) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - HOMEPAGE Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FORNECEDOR';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'HOMEPAGE Inválido';
            rxlog.Post;
          end;

        v23 := frmPrincipal.texto_justifica(frmPrincipal.somenteNumero(query.fieldbyname('IE').AsString),20,' ','D'); // inscrição estadual

        if Trim(v23) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - INSC. ESTADUAL Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FORNECEDOR';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'INSC. ESTADUAL Inválida';
            rxlog.Post;
          end;
        ...
        if Trim(v31) = '' then
          begin
            Add_Log(' => '+query.fieldbyname('CODIGO').AsString+'-'+query.fieldbyname('NOME').AsString+' - CÓDIGO PAÍS Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FORNECEDOR';
            rxlogcodigo.AsString := query.fieldbyname('CODIGO').AsString;
            rxlognome.AsString := query.fieldbyname('NOME').AsString;
            rxloglog.AsString := 'CÓDIGO PAÍS Inválido';
            rxlog.Post;
          end;
  ...
  if rxlog.RecordCount > 0 then
    begin
      fxlog.LoadFromFile('\DATASAC\server\rel\F000193.fr3');
      fxlog.ShowReport;
    end;
  rxlog.First;
...
begin
  ...
  while not frmmodulo.qrfornecedor.Eof do begin
    ...
    if Result = true then
       begin
          showmessage('Erro na Importação dos Fornecedores...');
       end;
  ...
  ProgressBar1.Position := frmmodulo.qrcliente.RecordCount;
    ...
    if Result = true then
       begin
          showmessage('Erro na Importação dos Clientes...');
       end;
      ...
      while not qrentrada.Eof do begin
        ...
        if ( qrentradaDATA_LANCAMENTO.AsString <> ' / /' ) and
          ...
          begin
            ...
            Add_Log(' => Nota Fiscal : '+qrentradaNUMERO.AsString+'-'+qrentradaDATA_LANCAMENTO.AsString+' - DATA DE LANÇAMENTO Inválida',clRed);
            rxlog.Append;
            ...
            rxloglog.AsString := 'DATA DE LANÇAMENTO Inválida';
            rxlog.Post;
          end;
        ...
        if ( qrentradaDATA_EMISSAO.AsString <> ' / /' ) and
          ...
          begin
            ...
            Add_Log(' => Nota Fiscal : '+qrentradaNUMERO.AsString+'-'+qrentradaDATA_EMISSAO.AsString+' - DATA DE EMISSÃO Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'NOTA DE ENTRADA';
            rxlogcodigo.AsString := qrentradaNUMERO.AsString;
            rxlognome.AsString := qrentradaCODFORNECEDOR.AsString+'-'+qrentradaNOME.AsString;
            rxloglog.AsString := 'DATA DE EMISSÃO Inválida';
            rxlog.Post;
          end;

        v05 := frmPrincipal.texto_justifica(qrentradaNUMERO.AsString,6,'0','E'); // número do documento
        ...
        // TRANSPORTADOR ( SÓ COMBUSTIVEIS - Local de saida )
        ...
        v106:= frmPrincipal.texto_justifica(' ',2,' ','D');                // sped - tipo de titulo de cobrança
      ...
      while not qrsaida.Eof do begin
        ...
        if ( qrsaidaDATA_SAIDA.AsString <> ' / /' ) and
          ...
          begin
            ...
            Add_Log(' => Nota Fiscal : '+qrsaidaNUMERO.AsString+'-'+qrsaidaDATA_SAIDA.AsString+' - DATA DE SAIDA Inválida',clRed);
            rxlog.Append;
            ...
            rxloglog.AsString := 'DATA DE SAIDA Inválida';
            rxlog.Post;
          end;
        ...
        if ( qrsaidaDATA.AsString <> ' / /' ) and
          ...
          begin
            v46 := frmPrincipal.texto_justifica('',6,' ','D'); // data emissao
            Add_Log(' => Nota Fiscal : '+qrsaidaNUMERO.AsString+'-'+qrsaidaDATA.AsString+' - DATA DO DOCUMENTO Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'NOTA DO SAIDA';
            rxlogcodigo.AsString := qrsaidaNUMERO.AsString;
            rxlognome.AsString := qrsaidaCODCLIENTE.AsString+'-'+qrsaidaNOME.AsString;
            rxloglog.AsString := 'DATA DO DOCUMENTO Inválida';
            rxlog.Post;
          end;
        }
        v47 := '  '; // reservado
        ...
        v50 := frmPrincipal.FormataValorProsoft(qrsaidaOS_TOTAL_GERAL.asfloat,14); // valor do serviço
        ...
        if ( qrsaidaMODELO_NF.AsString = '21' ) or
           ( qrsaidaMODELO_NF.AsString = '22' ) then // só nota de telecomunicacao
        ...
        v147 := frmPrincipal.texto_justifica(' ',2,' ','D');                // sped - tipo titulo de cobrança - 00-duplicata 01-cheque 02-promissoria 03-recibo 994-outros
      ...
      while not qrfaturas.Eof do begin
        ...
        if ( qrfaturasDATA_EMISSAO.AsString <> ' / /' ) and
          ...
          begin
            ...
            Add_Log(' => '+qrfaturasNOTAFISCAL.AsString+'-'+qrfaturasNOME.AsString+' - DATA DE ESCRITURAÇÃO Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FATURAS';
            rxlogcodigo.AsString := qrfaturasNOTAFISCAL.AsString;
            rxlognome.AsString := qrfaturasNOME.AsString;
            rxloglog.AsString := 'DATA DE ESCRITURAÇÃO Inválida';
            rxlog.Post;
          end;
        ...
        if qrfaturasDOCUMENTO.AsString <> '' then
          ...
          begin
            ...
            Add_Log(' => '+qrfaturasNOTAFISCAL.AsString+'-'+qrfaturasNOME.AsString+' - NÚMERO DA DUPLICATA Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FATURAS';
            rxlogcodigo.AsString := qrfaturasNOTAFISCAL.AsString;
            rxlognome.AsString := qrfaturasNOTAFISCAL.AsString;
            rxloglog.AsString := 'NÚMERO DA DUPLICATA Inválido';
            rxlog.Post;
          end;
        ...
        if ( qrfaturasDATA_VENCIMENTO.AsString <> ' / /' ) and
          ...
          begin
            ...
            Add_Log(' => '+qrfaturasNOTAFISCAL.AsString+'-'+qrfaturasNOME.AsString+' - DATA DE VENCIMENTO Inválida',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FATURAS';
            rxlogcodigo.AsString := qrfaturasNOTAFISCAL.AsString;
            rxlognome.AsString := qrfaturasNOTAFISCAL.AsString;
            rxloglog.AsString := 'DATA DE VENCIMENTO Inválida';
            rxlog.Post;
          end;
        ...
        if qrfaturasVALOR.AsFloat > 0 then
          ...
          begin
            ...
            Add_Log(' => '+qrfaturasNOTAFISCAL.AsString+'-'+qrfaturasNOME.AsString+' - VALOR BRUTO DA FATURA Inválido',clRed);
            rxlog.Append;
            rxlogtabela.AsString := 'FATURAS';
            rxlogcodigo.AsString := qrfaturasNOTAFISCAL.AsString;
            rxlognome.AsString := qrfaturasNOTAFISCAL.AsString;
            rxloglog.AsString := 'VALOR BRUTO DA FATURA Inválido';
            rxlog.Post;
          end;
...
begin
  ...
  Add_Log('Exportando Redução Z...',clGreen);
  ...
  if qrreducaoz.RecordCount > 0 then
    begin
      ...
      while not qrreducaoz.Eof do begin
        ...
        v05 := frmPrincipal.texto_justifica(qrreducaozNRO_SERIE_EQP.AsString,20,' ','D');     // número de serie da ecf
        ...
        v11 := frmPrincipal.texto_justifica(' ',6,' ','D');   // número ultimo documento pre-emitido
