...
procedure Tfrmcartao_ficha.FormClose(Sender: TObject;
...
procedure Tfrmcartao_ficha.DateEdit1KeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tfrmcartao_ficha.DateEdit2KeyPress(Sender: TObject;
  var Key: Char);
begin
  IF KEY = #13 THEN PERFORM(WM_NEXTDLGCTL,0,0);
end;
...
procedure Tfrmcartao_ficha.spin_parcelaKeyPress(Sender: TObject;
  var Key: Char);
begin
