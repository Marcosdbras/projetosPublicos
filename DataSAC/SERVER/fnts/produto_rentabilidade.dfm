object frmproduto_rentabilidade: Tfrmproduto_rentabilidade
  ...
  object qrrentabilidade_entrada: TZQuery
    ...
    Left = 184
    Top = 312
    object qrrentabilidade_entradaCODPRODUTO: TStringField
      DisplayLabel = 'C'#243'digo'
      DisplayWidth = 7
      FieldName = 'CODPRODUTO'
      Size = 6
    end
    object qrrentabilidade_entradaPRODUTO: TStringField
    ...
    object qrrentabilidade_entradaRENTABILIDADE: TStringField
      DisplayWidth = 6
