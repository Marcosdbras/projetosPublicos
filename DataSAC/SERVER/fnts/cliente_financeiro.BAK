...
uses
  ...
  Buttons, ImgList, Mask, ToolEdit, CurrEdit, Menus, ComCtrls, RXSpin,
            ...
            begin
              ...
              begin
                ...
                begin
                    ...
                    frmmodulo.qrcliente.close;
                    frmmodulo.qrcliente.SQL.Clear;
                    frmmodulo.qrcliente.SQL.Add('update c000007 set situacao = 2, obs4 = '''+'Cliente com prestações em Atrazo!'+''' where codigo = '''+qrcontasreceber.fieldbyname('codcliente').asstring+'''');
                    frmmodulo.qrcliente.ExecSQL;
                    qrcontasreceber.next;
                end;
                frmmodulo.qrcliente.close;
...
Classe A : Clientes que possuem alto lucro dentro do período selecionado (70% do lucro obtido).
Classe B : Clientes que possuem um lucro intermediário dentro do período selecionado (20% do lucro obtido).
Classe C : Clientes que possuem um baixo lucro dentro do período selecionado (10% do lucro obtido).
