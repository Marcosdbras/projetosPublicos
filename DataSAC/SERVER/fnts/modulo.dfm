object frmmodulo: Tfrmmodulo
  ...
  object qrFilial: TZQuery
    ...
    object qrFilialPERFIL_SPED: TIntegerField
  ...
  object qrPedido1: TZQuery
    Connection = Conexao
    SQL.Strings = (
      'select * from c000056PEDIDO')
    Params = <>
    Left = 168
    Top = 162
    object s1: TStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    ...
    object s2: TStringField
      FieldName = 'CODCLIENTE'
      Size = 6
    end
    object s3: TStringField
      FieldName = 'CODVENDEDOR'
      Size = 6
    end
    object f1: TFloatField
      FieldName = 'SUBTOTAL'
      DisplayFormat = '###,###,##0.00'
    end
    object f2: TFloatField
      FieldName = 'DESCONTO'
      DisplayFormat = '###,###,##0.00'
    end
    object f3: TFloatField
      FieldName = 'ACRESCIMO'
      DisplayFormat = '###,###,##0.00'
    end
    object f4: TFloatField
      FieldName = 'TOTAL'
      DisplayFormat = '###,###,##0.00'
    end
    object s4: TStringField
      FieldName = 'OBS1'
      Size = 80
    end
    object s5: TStringField
      FieldName = 'OBS2'
      Size = 80
    end
    object s6: TStringField
      FieldName = 'OBS3'
      Size = 80
    end
    object s7: TStringField
      FieldName = 'OBS4'
      Size = 80
    end
    object s8: TStringField
      FieldKind = fkLookup
      FieldName = 'cliente'
      LookupDataSet = qrcliente
      LookupKeyFields = 'codigo'
    ...
    object sPedidoSTATUS: TStringField
      FieldName = 'STATUS'
      Size = 1
    end
    object fPedidoMEIO_DINHEIRO: TFloatField
      FieldName = 'MEIO_DINHEIRO'
    end
    object fPedidoMEIO_CHEQUEAV: TFloatField
      FieldName = 'MEIO_CHEQUEAV'
    end
    object fPedidoMEIO_CHEQUEAP: TFloatField
      FieldName = 'MEIO_CHEQUEAP'
    end
    object fPedidoMEIO_CARTAOCRED: TFloatField
      FieldName = 'MEIO_CARTAOCRED'
    end
    object fPedidoMEIO_CARTAODEB: TFloatField
      FieldName = 'MEIO_CARTAODEB'
    end
    object fPedidoMEIO_CREDIARIO: TFloatField
      FieldName = 'MEIO_CREDIARIO'
    end
    object intgrfldPedidoST: TIntegerField
      FieldName = 'ST'
    end
    object sPedidoSITUACAO: TStringField
      FieldName = 'SITUACAO'
      Size = 35
    end
    object sPedidoCODCAIXA: TStringField
      FieldName = 'CODCAIXA'
      Size = 6
    end
  end
  object qrPedido2: TZQuery
    Connection = Conexao
    SQL.Strings = (
      'select * from c000056P')
    Params = <>
    Left = 248
    Top = 242
    ...
    object intgrfldPedidoID: TIntegerField
      FieldName = 'ID'
    end
    object fPedidoDESCONTO1: TFloatField
      FieldName = 'DESCONTO1'
    end
    object fPedidoACRESCIMO1: TFloatField
  ...
  object qrPedido: TZQuery
    ...
    object fPedidoMEIO_CONVENIO: TFloatField
      FieldName = 'MEIO_CONVENIO'
    end
    object fPedidoMEIO_FINANCEIRA: TFloatField
      FieldName = 'MEIO_FINANCEIRA'
    end
  end
