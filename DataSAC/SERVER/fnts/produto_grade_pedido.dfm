object frmproduto_grade_pedido: Tfrmproduto_grade_pedido
  Left = 292
  Top = 187
  Width = 416
  Height = 323
  BorderIcons = []
  Caption = 'Pedido - GRADE'
  Color = clBtnFace
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Height = 195
    Selected.Strings = (
      'NUMERACAO'#9'20'#9'N'#218'MERO'#9#9
      'QTDE'#9'10'#9'QTDE.'#9#9
      'QTDE_REC'#9'10'#9'RECEBIDO'#9#9
      'FALTA'#9'10'#9'FALTA'#9'T'#9)
  ...
  object dsgrade_produto: TDataSource
    DataSet = qrgrade_pedido
    Left = 33
    Top = 25
  end
  object qrgrade_pedido: TZQuery
    Connection = frmmodulo.Conexao
    OnCalcFields = qrgrade_pedidoCalcFields
    BeforeInsert = qrgrade_pedidoBeforeInsert
    AfterInsert = qrgrade_pedidoAfterInsert
    BeforeEdit = qrgrade_pedidoBeforeEdit
    AfterPost = qrgrade_pedidoAfterPost
    Active = True
    SQL.Strings = (
      'select * from c000039')
    Params = <>
    Left = 168
    Top = 120
    object qrgrade_pedidoNUMERACAO: TStringField
    ...
    object qrgrade_pedidoQTDE: TFloatField
      DisplayLabel = 'QTDE.'
      DisplayWidth = 10
      FieldName = 'QTDE'
    end
    object qrgrade_pedidoQTDE_REC: TFloatField
      DisplayLabel = 'RECEBIDO'
      DisplayWidth = 10
      FieldName = 'QTDE_REC'
      DisplayFormat = '###,###,##0.00'
    end
    object qrgrade_pedidoFALTA: TFloatField
      DisplayWidth = 10
    ...
    object qrgrade_pedidoCODGRADE: TStringField
      DisplayWidth = 6
      FieldName = 'CODGRADE'
      Visible = False
      Size = 6
    end
    object qrgrade_pedidoCODIGO: TStringField
      DisplayWidth = 6
      FieldName = 'CODIGO'
      Required = True
      Visible = False
    ...
    object qrgrade_pedidoCODPRODUTO: TStringField
      DisplayWidth = 6
      FieldName = 'CODPRODUTO'
      Visible = False
      Size = 6
    end
    object qrgrade_pedidoCODNOTA: TStringField
      DisplayWidth = 6
      FieldName = 'CODNOTA'
      Visible = False
      Size = 6
    end
    object qrgrade_pedidoCODITEM: TStringField
      DisplayWidth = 6
      FieldName = 'CODITEM'
      Visible = False
      Size = 6
