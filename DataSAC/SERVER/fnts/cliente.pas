...
uses modulo, principal, loc_regiao, regiao, loc_funci, 
  ...
  cliente_inicio, xloc_cidade, xloc_cnae, webcam2, pedido;
...
begin
  ...
  if frmxloc_cliente <> nil then
     begin
       frmxloc_cliente.loc.Text := frmmodulo.qrcliente.fieldbyname('nome').AsString;
       frmxloc_cliente.buscacliente;
       close;
     end;
  ...
  BEGIN
    ...
    begin
     if pos('-',dbedit12.text) = 0 then
       frmmodulo.qrcliente.fieldbyname('CELULAR').asstring := FormatMaskText('(99)99999-9999;0;_',dbedit12.text);
    END;
  END;
end;
