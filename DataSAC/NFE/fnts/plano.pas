...
uses modulo, principal, xloc_conta, lista_planocontas2, principal2;
...
begin
  ...
  frmmodulo.qrplano.fieldbyname('codigo').asstring := frmprincipal2.codifica('000035');
  pficha.Enabled := true;
...
begin
  ...
  if frmprincipal2.autentica('Excluir plano',4) then
  begin
  ...
  if (frmmodulo.qrplano.State = dsinsert) or (frmmodulo.qrplano.State = dsedit) then
    begin
        ...
        begin
          ...
          frmprincipal2.qrmestre.sql.add('update c000000 set sequencia = sequencia - 1 where codigo = ''000035''');
  ...
  begin
    ...
    begin
      ...
      begin
       ...
       begin
          ...
          conta := resultado_pesquisa3+'.'+frmprincipal2.texto_justifica(inttostr(strtoint(conta)+1),3,'0','E');
       end
       else
       begin
    ...
    begin
       ...
       begin
          ...
          if COMBOGRUPO.ItemIndex = 0 then conta := '2.'+frmprincipal2.texto_justifica(inttostr(strtoint(conta)+1),2,'0','E');
          if COMBOGRUPO.ItemIndex = 1 then conta := '1.'+frmprincipal2.texto_justifica(inttostr(strtoint(conta)+1),2,'0','E');
       end
       else
       begin
