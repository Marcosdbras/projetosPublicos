object frmproduto_auto: Tfrmproduto_auto
  ...
  Width = 796
  Height = 523
  Caption = ' PRODUTOS AUTO | Ficha de Cadastro'
  Color = clBtnFace
  ...
  object PageView1: TPageView
    ...
    object PageSheet2: TPageSheet
      ...
      Width = 788
      Height = 229
      Caption = 'Informa'#231#245'es Complementares do Ve'#237'culo'
      DisplayMode = tdGlyph
      ImageIndex = 0
      Margin = 0
      PageIndex = 5
      ...
      object wwDBComboBox1: TwwDBComboBox
        ...
        MapList = False
        AllowClearKey = False
        DataField = 'VEIC_TIPO_COMBUSTIVEL'
        DataSource = dsproduto2
        DropDownCount = 8
        ItemHeight = 0
        Items.Strings = (
      ...
      object wwDBComboBox5: TwwDBComboBox
        ...
        UnboundDataType = wwDefault
        Visible = False
        OnKeyPress = wwDBComboBox5KeyPress
      end
      object wwDBComboBox6: TwwDBComboBox
        ...
        UnboundDataType = wwDefault
        Visible = False
        OnKeyPress = wwDBComboBox6KeyPress
      end
