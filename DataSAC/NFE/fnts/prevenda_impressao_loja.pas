...
uses modulo, principal, ecf,
  ...
  prevenda_fechamento_loja, principal2;
...
// LINHA NORMAL         --> #27#50
  ...
  frmmodulo.qrnotafiscal.FieldByName('codigo').asstring := frmprincipal2.codifica('000061');
  frmmodulo.qrfilial.open;
  frmmodulo.qrfilial.Locate('codigo','000001',[loCaseInsensitive]);


  frmprevenda_nf_loja := tfrmprevenda_nf_loja.create(self);
  frmprevenda_nf_loja.enf.text := frmprincipal2.zerarcodigo(frmmodulo.qrFilial.fieldbyname('notafiscal').asstring,6);
  ...
  if frmprincipal2.vfil_simples  = 'S' then frmmodulo.qrnotafiscal.fieldbyname('INF2').asSTRING := 'OPTANTE PELO SIMPLES NACIONAL';
  if frmprincipal2.vfil_ssimples = 'S' then frmmodulo.qrnotafiscal.fieldbyname('INF2').asSTRING := 'OPTANTE PELO SUPER SIMPLES';
 ...
 ICMS := 0;
  ...
  writeln(arquivo,'');
  writeln(arquivo,'                                                                                                                             '+#18+#27#71+#20+frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('numero').asstring,6,'0','E')+#15+#27#72+#20);
  WRITELN(arquivo,'                                                                                   X');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  ...
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('natureza').asstring,41,' ','D')+' '+frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('CFOP').asstring,6,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  ...
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('NOME').asstring,90,' ','D')+' '+ frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('CPF').asstring,32,' ','D')+' '+frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('DATA').asstring,10,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('ENDERECO').asstring,68,' ','D')+' '+ frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('BAIRRO').asstring,24,' ','D')+' '+frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('CEP').asstring,29,' ','D')+' '+frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('DATA').asstring,10,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('CIDADE').asstring,50,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('TELEFONE1').asstring+'  '+frmmodulo.qrCLIENTE.fieldbyname('TELEFONE2').asstring,27,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('UF').asstring,6,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('RG').asstring,38,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(timetostr(time),10,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  ...
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_NUMERO1').asstring,31,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(texto1,15,' ','E')+'     '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_DATA1').asstring,17,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_NUMERO2').asstring,31,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(texto2,16,' ','E')+'     '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_DATA2').asstring,10,' ','D'));
  writeln(arquivo,'');
  ...
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_NUMERO3').asstring,31,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(texto1,15,' ','E')+'     '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_DATA3').asstring,17,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_NUMERO4').asstring,31,' ','D')+' '+
                  frmprincipal2.Texto_Justifica(texto2,16,' ','E')+'     '+
                  frmprincipal2.Texto_Justifica(frmmodulo.qrNOTAFISCAL.fieldbyname('FATURAMENTO_DATA4').asstring,10,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
//  writeln(arquivo,'');
//  writeln(arquivo,'');
...
//  writeln(arquivo,'');
  ...
  begin
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('codproduto').asstring,9,' ','D')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('Produto').asstring,59,' ','D')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('CF').asstring,0,' ','D')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('STR').asstring,5,' ','D')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('UN').asstring,3,' ','D')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('QTDE').asstring,9,' ','E')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('UNITARIO').asstring,13,' ','E')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('TOTAL').asstring,18,' ','E')+' ');
    write(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('ICMS').asstring,4,' ','E')+' ');
    writeln(arquivo,frmprincipal2.Texto_Justifica(frmprevenda.qrapoio.fieldbyname('IPI').asstring,3,' ','E'));
    writeln(arquivo,'');
    frmprevenda.qrapoio.next;
  end;

   if (frmmodulo.qrnotafiscal.fieldbyname('BASE_CALCULO').asfloat <> 0) and (frmprincipal2.vfil_ssimples = 'N') then texto1 := FORMATFLOAT('###,###,##0.00',frmmodulo.qrnotafiscal.fieldbyname('BASE_CALCULO').asfloat) else texto1 := '';
   if (frmmodulo.qrnotafiscal.fieldbyname('VALOR_ICMS').asfloat <> 0)  and (frmprincipal2.vfil_ssimples = 'N') then texto2 := FORMATFLOAT('###,###,##0.00',frmmodulo.qrnotafiscal.fieldbyname('VALOR_ICMS').asfloat) else texto2 := '';
   if (frmmodulo.qrnotafiscal.fieldbyname('BASE_SUB').asfloat <> 0)  and (frmprincipal2.vfil_ssimples = 'N') then texto3 := FORMATFLOAT('###,###,##0.00',frmmodulo.qrnotafiscal.fieldbyname('BASE_SUB').asfloat) else texto3 := '';
   if (frmmodulo.qrnotafiscal.fieldbyname('ICMS_SUB').asfloat <> 0)  and (frmprincipal2.vfil_ssimples = 'N') then texto4 := FORMATFLOAT('###,###,##0.00',frmmodulo.qrnotafiscal.fieldbyname('ICMS_SUB').asfloat) else texto4 := '';
  ...
  write(arquivo,frmprincipal2.Texto_Justifica(texto1,24,' ','E')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(texto2,25,' ','E')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(texto3,25,' ','E')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(texto4,25,' ','E')+' ');
  writeLN(arquivo,frmprincipal2.Texto_Justifica(texto5,25,' ','E')+' ');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  ...
  writeln(arquivo,'');
  writeln(arquivo,'');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('transportador').asstring,74,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('FRETE_CONTA').asstring,4,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('placa').asstring,18,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('placa_uf').asstring,8,' ','D')+' ');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('transp_cpf').asstring,25,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('transp_ENDERECO').asstring,59,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('TRANSP_CIDADE').asstring,37,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('TRANSP_UF').asstring,15,' ','D')+' ');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('transp_RG').asstring,25,' ','D'));
//  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('VOL_QTDE').asstring,22,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('VOL_ESPECIE').asstring,25,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('VOL_MARCA').asstring,20,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('VOL_NUMERO').asstring,25,' ','D')+' ');
  write(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('PESO_BRUTO').asstring,20,' ','D')+' ');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('PESO_LIQUIDO').asstring,20,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  ...
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('INF1').asstring,80,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('INF2').asstring,80,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('INF3').asstring,80,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('INF4').asstring,80,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,frmprincipal2.Texto_Justifica(frmmodulo.qrnotafiscal.fieldbyname('INF5').asstring,80,' ','D'));
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
  writeln(arquivo,'');
...
begin
  TRY
     ...
     begin
       ...
       FRMMODULO.qrecf_comando.FieldByName('sequencia').AsString := frmprincipal2.codifica('000072');
     ...
     begin
      ...
      begin
        ...
        BEGIN
          ...
          if ecf_vende_item_completo(ecf_modelo,frmmodulo.qrproduto.fieldbyname('codigo').asstring,
                                  frmprincipal2.RemoveAcentos(produto),
                                  aliquota,
      ...
      if ecf_termina_fechamento(ecf_modelo,frmprincipal2.Texto_Justifica('CLIENTE.: '+frmmodulo.qrcliente.fieldbyname('nome').asstring,48,' ','D')+#10+
                                         frmprincipal2.Texto_Justifica(('ENDERECO: '+frmmodulo.qrcliente.fieldbyname('endereco').asstring+' '+
                                                                         frmmodulo.qrcliente.fieldbyname('bairro').asstring+' '+
                                                                         frmmodulo.qrcliente.fieldbyname('cidade').asstring),48,' ','D')+#10+
                                          frmprincipal2.Texto_Justifica('CPF/CNPJ: '+frmmodulo.qrcliente.fieldbyname('cpf').asstring,42,' ','D')+#10+
                                            '------------------------------------------------'+#10+
         ...
         begin
           ...
           if ecf_cupom_vinculado_produtos = '1' then
             begin
               ...
               while not FRMPREvenda.QROrcamento_produto.eof do
                 begin
                   if ecf_usa_CNFV(ecf_modelo,frmprincipal2.texto_justifica(FRMPREvenda.QROrcamento_produto.fieldbyname('codproduto').asstring,6,'0','E')+' '+
                          frmprincipal2.texto_justifica(FRMPREvenda.QROrcamento_produto.fieldbyname('produto').asstring,19,' ','D')+
                          frmprincipal2.texto_justifica(formatfloat('######0',FRMPREvenda.QROrcamento_produto.fieldbyname('qtde').asfloat),4,' ','E')+
                          frmprincipal2.texto_justifica(formatfloat('######0.00',FRMPREvenda.QROrcamento_produto.fieldbyname('unitario').asfloat),9,' ','E')+
                          frmprincipal2.texto_justifica(formatfloat('######0.00',FRMPREvenda.QROrcamento_produto.fieldbyname('total').asfloat),9,' ','E')) = 'ERRO' then exit;
                   FRMPREvenda.QROrcamento_produto.Next;
                 end;
              end;
           if ecf_usa_CNFV(ecf_modelo,'------------------------------------------------' ) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,'TOTAL DOS PRODUTOS .................R$ '+frmprincipal2.texto_justifica(formatfloat('######0.00',frmprevenda_fechamento_loja.RSUBTOTAL.VALUE),9,' ','E')) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,'DESCONTO ...........................R$ '+frmprincipal2.texto_justifica(formatfloat('######0.00',frmprevenda_fechamento_loja.rdesconto2.VALUE),9,' ','E')) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,'T O T A L ..........................R$ '+frmprincipal2.texto_justifica(formatfloat('######0.00',frmprevenda_fechamento_loja.rtotal.VALUE),9,' ','E')) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,'------------------------------------------------' ) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,' ' ) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,' ' ) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,' ' ) = 'ERRO' then exit;
           ...
           if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('CPF/CNPJ: '+frmmodulo.qrcliente.fieldbyname('cpf').asstring+ ' RG/INSC: '+frmmodulo.qrcliente.fieldbyname('rg').asstring,48,' ','D')) = 'ERRO' then exit;
           if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('VENDEDOR: '+frmPrevenda.qrorcamento.fieldbyname('codvendedor').asstring+'-'+frmPrevenda.qrorcamento.fieldbyname('vendedor').asstring,48,' ','D')) = 'ERRO' then exit;
           ...
           begin
             ...
             begin
               ...
               if ecf_usa_CNFV(ecf_modelo,'------------------------------------------------' ) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('CUPOM.....: '+NUMERO_CUPOMx,48,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('DOCUMENTO.: '+frmPrevenda.qrvenda_contasreceber.FieldByName('documento').asstring,48,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('VENDEDOR..: '+frmPrevenda.qrorcamento.fieldbyname('codvendedor').asstring+'-'+frmPrevenda.qrorcamento.fieldbyname('vendedor').asstring,48,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,'------------------------------------------------' ) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('CLIENTE...: '+frmmodulo.qrcliente.fieldbyname('codigo').asstring+'-'+frmmodulo.qrcliente.fieldbyname('nome').asstring,48,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica(('ENDERECO..: '+frmmodulo.qrcliente.fieldbyname('endereco').asstring+' '+frmmodulo.qrcliente.fieldbyname('cidade').asstring+'/'+frmmodulo.qrcliente.fieldbyname('uf').asstring),48,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('CPF/CNPJ..: '+frmmodulo.qrcliente.fieldbyname('cpf').asstring+ ' RG/INSC: '+frmmodulo.qrcliente.fieldbyname('rg').asstring,48,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('IE/RG.....: '+frmmodulo.qrcliente.fieldbyname('rg').asstring,42,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,'------------------------------------------------' ) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,'   Este comprovante não é um documento fiscal   ' ) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,'------------------------------------------------' ) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('PARCELA...: '+frmprincipal2.zerarcodigo(frmPrevenda.qrvenda_contasreceber.fieldbyname('prestacao').asstring,6),42,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('VENCIMENTO: '+frmPrevenda.qrvenda_contasreceber.FieldByName('vencimento').AsString,42,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,frmprincipal2.Texto_Justifica('VALOR.....: '+formatfloat('#,###,##0.00',frmPrevenda.qrvenda_contasreceber.FieldByName('valor').AsFloat),38,' ','D')) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,'------------------------------------------------' ) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,' ' ) = 'ERRO' then exit;
               if ecf_usa_CNFV(ecf_modelo,' ' ) = 'ERRO' then exit;
...
begin
  ...
  BEGIN
    ...
    BEGIN
        ...
        Writeln(f,'  '+frmprincipal2.texto_justifica(formatfloat('###,###,###,##0.00',VALOR_NOTAZ),10,' ','E')+'       '+
        frmprincipal2.texto_justifica(NUMERO_NOTAZ,10,' ','D')+'   '+
        frmprincipal2.texto_justifica(formatfloat('###,###,###,##0.00',frmprevenda.QRVENDA_CONTASRECEBER.fieldbyname('VALOR').asfloat),10,' ','E')+
                  '   '+frmprincipal2.texto_justifica(NUMERO_NOTAZ+'/'+frmprincipal2.zerarcodigo(INTTOSTR(ITEM),2),10,' ','D')+
                  ' '+frmprincipal2.texto_justifica(datetostr(frmprevenda.QRVENDA_CONTASRECEBER.fieldbyname('vencimento').asdatetime),10,' ','D'));
