object frmCidade: TfrmCidade
  ...
  object grid: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'CIDADE'#9'45'#9'Cidade'
      'UF'#9'2'#9'UF'
      'IBGE'#9'5'#9'IBGE'
      'MUNICIPIO'#9'10'#9'Munic'#237'pio'
  ...
  object qrcidade: TZQuery
    ...
    Left = 336
    Top = 40
    object qrcidadeCODIGO: TStringField
    ...
    object qrcidadeCIDADE: TStringField
      DisplayLabel = 'Cidade'
      DisplayWidth = 45
      FieldName = 'CIDADE'
      Size = 40
    end
    object qrcidadeUF: TStringField
      DisplayWidth = 2
      FieldName = 'UF'
      Size = 2
    end
    object qrcidadeIBGE: TStringField
      DisplayWidth = 5
      FieldName = 'IBGE'
      Size = 10
    end
    object qrcidadeMUNICIPIO: TStringField
      DisplayLabel = 'Munic'#237'pio'
      DisplayWidth = 10
      FieldName = 'MUNICIPIO'
      Size = 10
    end
    object qrcidadeESTADO: TStringField
      DisplayLabel = 'Estado'
      DisplayWidth = 10
      FieldName = 'ESTADO'
      Size = 10
    end
    object qrcidadeCEP: TStringField
      DisplayWidth = 10
      FieldName = 'CEP'
      Visible = False
      Size = 10
