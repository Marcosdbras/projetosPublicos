object frmvenda_fechamento_vidalink: Tfrmvenda_fechamento_vidalink
  Left = 384
  Top = 166
  ...
  object bimp_comprovante: TButton
    Left = 360
    Top = 464
    Width = 241
    Height = 25
    Caption = 'IMPRIME COMPROVANTE CONVENIO'
    TabOrder = 17
    Visible = False
    OnClick = bimp_comprovanteClick
  end
  ...
  object rconveniv: TRxCalcEdit
    ...
    ParentFont = False
    TabOrder = 21
    OnEnter = rconvenivEnter
    OnExit = rconvenivExit
    OnKeyPress = rdesconto1KeyPress
  end
