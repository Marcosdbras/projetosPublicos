object frmmemorando_menu: Tfrmmemorando_menu
  Left = 225
  Top = 94
  Width = 787
  Height = 545
  Caption = 'MEMORANDO DE EXPORTA'#199#195'O | Rela'#231#227'o'
  Color = clBtnFace
  ...
  object AdvOfficeStatusBar2: TAdvOfficeStatusBar
    ...
    SizeGrip = False
    URLColor = clBlue
    Styler = AdvOfficeStatusBarOfficeStyler5
    Version = '1.3.0.2'
  ...
  object tab_principal: TAdvToolBarPager
    ...
    object AdvPage1: TAdvPage
      ...
      Width = 779
      Height = 410
      Caption = 'Rela'#231#227'o de Memorando'
      ImageIndex = 28
      ...
      object HeaderView2: THeaderView
        ...
        object grid: TwwDBGrid
          ...
          Selected.Strings = (
            'MEMORANDO'#9'6'#9'MEMORANDO'
            'NOTAFISCAL_DATA'#9'10'#9'DATA'
            'NOTAFISCAL'#9'6'#9'NOTA FISCAL'
            'NOTAFISCAL_MODELO'#9'10'#9'MODELO'
            'NOTAFISCAL_SERIE'#9'5'#9'SERIE'#9'F')
  ...
  object qrmemorando: TZQuery
    ...
    object qrmemorandocliente: TStringField
      FieldKind = fkLookup
      FieldName = 'cliente'
  ...
  object dsmemorando: TDataSource
    DataSet = qrmemorando
    OnDataChange = dsmemorandoDataChange
    Left = 81
    Top = 342
  end
  object qrfornecedor: TZQuery
    ...
    object qrfornecedorAPELIDO: TStringField
      FieldName = 'APELIDO'
      Size = 50
    end
    ...
    object qrfornecedorMORADIA: TIntegerField
      FieldName = 'MORADIA'
    end
    object qrfornecedorTIPO: TIntegerField
      FieldName = 'TIPO'
    end
    object qrfornecedorSITUACAO: TIntegerField
      FieldName = 'SITUACAO'
    end
    ...
    object qrfornecedorTELEFONE3: TStringField
      FieldName = 'TELEFONE3'
    end
    ...
    object qrfornecedorRG: TStringField
      FieldName = 'RG'
      Size = 25
    end
    object qrfornecedorCPF: TStringField
      FieldName = 'CPF'
      Size = 18
    end
    object qrfornecedorFILIACAO: TStringField
      FieldName = 'FILIACAO'
      Size = 80
    end
    object qrfornecedorESTADOCIVIL: TStringField
      FieldName = 'ESTADOCIVIL'
      Size = 15
    end
    object qrfornecedorCONJUGE: TStringField
      FieldName = 'CONJUGE'
      Size = 60
    end
    object qrfornecedorPROFISSAO: TStringField
      FieldName = 'PROFISSAO'
      Size = 30
    end
    object qrfornecedorEMPRESA: TStringField
      FieldName = 'EMPRESA'
      Size = 40
    end
    object qrfornecedorRENDA: TFloatField
      FieldName = 'RENDA'
    end
    object qrfornecedorLIMITE: TFloatField
      FieldName = 'LIMITE'
    end
    object qrfornecedorREF1: TStringField
      FieldName = 'REF1'
      Size = 50
    end
    object qrfornecedorREF2: TStringField
      FieldName = 'REF2'
      Size = 50
    end
    object qrfornecedorCODVENDEDOR: TStringField
      FieldName = 'CODVENDEDOR'
      Size = 6
    end
    object qrfornecedorDATA_CADASTRO: TDateTimeField
      FieldName = 'DATA_CADASTRO'
    end
    object qrfornecedorDATA_ULTIMACOMPRA: TDateTimeField
    ...
    object qrfornecedorOBS4: TStringField
      FieldName = 'OBS4'
      Size = 80
    end
    object qrfornecedorOBS5: TStringField
      FieldName = 'OBS5'
      Size = 80
    end
    object qrfornecedorOBS6: TStringField
      FieldName = 'OBS6'
      Size = 80
    end
    object qrfornecedorNASCIMENTO: TStringField
      FieldName = 'NASCIMENTO'
      Size = 10
    end
    object qrfornecedorCODREGIAO: TStringField
      FieldName = 'CODREGIAO'
      Size = 6
    end
    object qrfornecedorCODCONVENIO: TStringField
      FieldName = 'CODCONVENIO'
      Size = 6
    end
    object qrfornecedorCODUSUARIO: TStringField
      FieldName = 'CODUSUARIO'
      Size = 6
    end
    object qrfornecedorSEXO: TStringField
      FieldName = 'SEXO'
      Size = 1
    end
    object qrfornecedorHISTORICO: TBlobField
      FieldName = 'HISTORICO'
    end
    object qrfornecedorPREVISAO: TDateTimeField
      FieldName = 'PREVISAO'
    end
    ...
    object qrfornecedorTAMANHO_CALCA: TStringField
      FieldName = 'TAMANHO_CALCA'
      Size = 5
    end
    object qrfornecedorTAMANHO_BLUSA: TStringField
      FieldName = 'TAMANHO_BLUSA'
      Size = 5
    end
    object qrfornecedorTAMANHO_SAPATO: TStringField
      FieldName = 'TAMANHO_SAPATO'
      Size = 5
    end
    object qrfornecedorRG_ORGAO: TStringField
      FieldName = 'RG_ORGAO'
      Size = 5
    end
    object qrfornecedorRG_ESTADO: TStringField
      FieldName = 'RG_ESTADO'
      Size = 2
    end
    object qrfornecedorRG_EMISSAO: TDateTimeField
  ...
  object qrmemorando_entrada: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select * from c000095 where notafiscal = 000001')
    Params = <>
    Left = 120
    Top = 312
    object qrmemorando_entradaMEMORANDO: TStringField
      DisplayWidth = 11
      FieldName = 'MEMORANDO'
      Size = 6
    end
    object qrmemorando_entradaNOTAFISCAL: TStringField
    ...
    object qrmemorando_entradaNF_MODELO: TStringField
      DisplayLabel = 'MOD'
      DisplayWidth = 4
      FieldName = 'NF_MODELO'
      Size = 10
    end
    object qrmemorando_entradaNF_QUANTIDADE: TFloatField
      DisplayLabel = 'QTDE'
      DisplayWidth = 10
      FieldName = 'NF_QUANTIDADE'
      DisplayFormat = '###,###,##0.000'
    end
    object qrmemorando_entradaNF_UNIDADE: TStringField
      DisplayLabel = 'UN'
      DisplayWidth = 2
      FieldName = 'NF_UNIDADE'
      Size = 2
    end
    object qrmemorando_entradaNF_DATA: TDateTimeField
      DisplayLabel = 'DATA'
      DisplayWidth = 10
      FieldName = 'NF_DATA'
    end
    object qrmemorando_entradaNF_SERIE: TStringField
      DisplayLabel = 'SERIE'
      DisplayWidth = 10
      FieldName = 'NF_SERIE'
      Visible = False
  ...
  object dsmemorando_entrada: TDataSource
    DataSet = qrmemorando_entrada
    Left = 121
    Top = 342
  end
  ...
  object qrnotafiscal_item: TZQuery
    ...
    Active = True
    SQL.Strings = (
      'select * from c000062  where codnota = 000001')
    Params = <>
    Left = 192
    Top = 312
  ...
  object qrnotafiscal: TZQuery
    ...
    Active = True
    SQL.Strings = (
      'select * from c000061  where numero = 000001')
    Params = <>
    Left = 160
    Top = 312
