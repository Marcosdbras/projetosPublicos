...
uses modulo, agenda_ficha, principal, principal2;
...
begin
  ...
  frmmodulo.qragenda.fieldbyname('codigo').asstring := frmprincipal2.codifica('000034');
...
begin
  if frmprincipal2.autentica('Excluir contato',2) then
  begin
