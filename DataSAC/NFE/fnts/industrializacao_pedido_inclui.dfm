object frmindustrializacao_pedido_inclui: Tfrmindustrializacao_pedido_inclui
  Left = 411
  Top = 195
  BorderIcons = [biSystemMenu]
  BorderStyle = bsToolWindow
  Caption = 'PEDIDO | Inclus'#227'o de Itens'
  ClientHeight = 325
  ClientWidth = 437
  Color = clBtnFace
  ...
  object FlatPanel5: TFlatPanel
    ...
    object etamanho: TRzComboBox
      ...
      ItemHeight = 13
      TabOrder = 2
      OnKeyPress = etamanhoKeyPress
    end
    object ecor: TRzComboBox
      Left = 72
      Top = 112
      Width = 145
      Height = 21
  ...
  object dstamanho: TwwDataSource
    DataSet = frmmodulo.qrtamanho
    Left = 304
    Top = 136
  end
  object dscor: TwwDataSource
    DataSet = frmmodulo.qrcor
    Left = 368
    Top = 136
  end
