...
begin
  ...
  frmmodulo.qrCONVENIO.fieldbyname('codigo').asstring := frmprincipal2.codifica('000071');
  pficha.Enabled := true;
...
begin
  if frmprincipal2.autentica('Excluir CONVENIO',4) then
  begin
...
begin
  ...
  begin
    if frmprincipal2.autentica('Alterar Convênio',3) then
   begin
      //
    end
    else
