...
uses modulo, principal, loc_regiao, regiao, loc_funci, principal2;
...
begin
  ...
  frmmodulo.qrCONDPGTO.fieldbyname('codigo').asstring := frmprincipal2.codifica('000015');
  pficha.Enabled := true;
  dbedit2.setfocus;
...
begin
  if frmprincipal2.autentica('Excluir CONDPGTO',4) then
  begin
...
begin
  ...
  begin
    ...
    frmmodulo.qrcondpgto_parcela.fieldbyname('codigo').asstring := frmprincipal2.codifica('000016');
