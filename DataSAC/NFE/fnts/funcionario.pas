...
uses modulo, principal, loc_regiao, regiao, loc_funci, xloc_funcionario,
  lista_funcionario2, xloc_cidade, principal2;
...
begin
  ...
  frmmodulo.qrfunci.fieldbyname('codigo').asstring := frmprincipal2.codifica('000008');
...
begin
  if frmprincipal2.autentica('Excluir funci',4) then
  begin
...
begin
tedit(sender).Color := clwindow;
frmmodulo.qrfunci.fieldbyname('numero').asstring := frmprincipal2.zerarcodigo(dbedit38.text,5);
end;
