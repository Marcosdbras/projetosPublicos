...
uses modulo, principal, loc_cfop,  Math, loc_cliente, notafiscal_item,
  ...
  notafiscal_importacupom, sintegra_gerar, principal2;
  ...
  if check_prestacao.Checked then
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              query2.parambyname('codigo').asstring          := frmnotafiscal_menu.qrnota.fieldbyname('numero').asstring+'/'+frmprincipal2.zerarcodigo(qrreceber.fieldbyname('numero').asstring,2);
    ...
    (***************************************************************)
     ...
     begin
       ...
       begin
         ...
         begin
           ...
           begin
             ...
             frmmodulo.qrproduto_mov.fieldbyname('SERIAL').AsString := qrnotafiscal_item.fieldbyname('SERIAL').asstring; //FRMPRINCIPAL2.zerarcodigo(INTTOSTR(ITEM),3);
           ...
           begin
             ...
             BEGIN
               ...
               begin
                 ...
                 begin
                    query.sql.add(',codigo = '''+frmprincipal2.codifica('000062')+'''');
      ...
      frmnotafiscal_menu.qrnota.fieldbyname('valor_produtos').asfloat := frmprincipal2.Arredondar(frmnotafiscal_menu.qrnota.fieldbyname('valor_produtos').asfloat,2);
      frmnotafiscal_menu.qrnota.fieldbyname('total_nota').asfloat     := frmprincipal2.Arredondar(frmnotafiscal_menu.qrnota.fieldbyname('total_nota').asfloat,2);
...
begin
  ...
  begin
    ...
    begin
      efilial.Text := frmprincipal2.zerarcodigo(efilial.text,6);

      if not FrmPrincipal2.Locregistro(frmmodulo.qrfilial,efilial.text,'codigo') then
      begin
      ...
      begin
        ...
        begin
          ...
          frmprincipal2.zerarcodigo(frmmodulo.qrFilial.fieldbyname('notafiscal').asstring,6);
...
begin
  ...
  if frmprincipal2.autentica('Excluir produto NF',4) then
  begin
...
begin
  ...
  if (frmnotafiscal_menu.qrnota.State = dsinsert) or (frmnotafiscal_menu.qrnota.State = dsedit) then
    frmnotafiscal_menu.qrnota.FieldByName('numero').asstring := frmprincipal2.zerarcodigo(ENUMERO.text,6);
...
begin
  ...
  IF (frmnotafiscal_menu.qrnota.state = dsinsert) or (frmnotafiscal_menu.qrnota.State = dsedit) then
  begin
    frmnotafiscal_menu.qrnota.fieldbyname('codtransportador').asstring := frmprincipal2.zerarcodigo(etransportador.text,6);
    if etransportador.text <> '000000' then
    BEGIN
      if not FrmPrincipal2.Locregistro(frmmodulo.qrtransportador,etransportador.text,'codigo') then bloctransportadorclick(frmnotafiscal)
      else
      BEGIN
        frmnotafiscal_menu.qrnota.FieldByName('placa').ASSTRING := FRMMODULO.qrtransportador.FIELDBYNAME('placa').ASSTRING;
         frmnotafiscal_menu.qrnota.FieldByName('placa_uf').ASSTRING := FRMMODULO.qrtransportador.FIELDBYNAME('ufplaca').ASSTRING;
...
{  if FRMSINTEGRA_GERAR.RoundNum(vsoma_total_nota,2) <> FRMSINTEGRA_GERAR.RoundNum(frmnotafiscal_menu.qrnotaTOTAL_NOTA.AsFloat,2) then
  ...
  TRY
      ...
      //vvalor_cfop1 := frmprincipal2.Arredondar(qrsoma.fieldbyname('total_geral').asfloat,2);
      ...
      begin
       ...
       begin
        ...
        vvalor_cfop2 := (frmnotafiscal_menu.qrnota.fieldbyname('total_nota').AsFloat*qrsoma.fieldbyname('total_geral').asfloat)/
                frmnotafiscal_menu.qrnota.fieldbyname('valor_produtos').AsFloat;
        //vvalor_cfop2 := frmprincipal2.Arredondar((frmnotafiscal_menu.qrnota.fieldbyname('total_nota').AsFloat*qrsoma.fieldbyname('total_geral').asfloat)/
...

{
    ...
    RVALOR.Value := frmPrincipal2.Arredondar(QUERY.fieldbyname('total').asfloat,2);
  ...
  if vtot_cfop > 1 then
    ...
    //ShowMessage('Total CFOP Novo : '+FloatToStr(frmPrincipal2.Arredondar(vtotal_cfop,2)));
...
begin
  ...
  begin
    ...
    qrnotafiscal_item.sql.add('codigo = '''+frmprincipal2.codifica('000062')+'''');
...
begin
  ...
  begin
    ...
    frmnotafiscal_menu.qrnota.fieldbyname('modelo_nf').asstring := frmprincipal2.zerarcodigo(tedit(sender).Text,2);
...
begin
  if key = #13 then
    begin
      ...
      frmnotafiscal_menu.qrnota.fieldbyname('codcliente').asstring := frmprincipal2.zerarcodigo(ecliente.Text,6);
...
begin
  ...
  begin
    ...
    BEGIN
      if tedit(sender).text <> '' then
      begin
        frmnotafiscal_menu.qrnota.fieldbyname('os_cod1').asstring := frmPrincipal2.zerarcodigo(tedit(sender).text,6);
...
begin
  ...
  begin
    ...
    BEGIN
      if tedit(sender).text <> '' then
      begin
        frmnotafiscal_menu.qrnota.fieldbyname('os_cod2').asstring := frmPrincipal2.zerarcodigo(tedit(sender).text,6);
...
begin
  ...
  begin
    ...
    BEGIN
      if tedit(sender).text <> '' then
      begin
        frmnotafiscal_menu.qrnota.fieldbyname('os_cod3').asstring := frmPrincipal2.zerarcodigo(tedit(sender).text,6);
...
begin
  ...
  begin
    ...
    BEGIN
      if tedit(sender).text <> '' then
      begin
        frmnotafiscal_menu.qrnota.fieldbyname('os_cod4').asstring := frmPrincipal2.zerarcodigo(tedit(sender).text,6);
...
begin
  ...
  begin
    ...
    BEGIN
      if tedit(sender).text <> '' then
      begin
        frmnotafiscal_menu.qrnota.fieldbyname('os_cod5').asstring := frmPrincipal2.zerarcodigo(tedit(sender).text,6);
...
begin
  ...
  begin
    ...
    BEGIN
      if tedit(sender).text <> '' then
      begin
        frmnotafiscal_menu.qrnota.fieldbyname('os_cod6').asstring := frmPrincipal2.zerarcodigo(tedit(sender).text,6);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            qrreceber.Insert;
            qrreceber.FieldByName('numero').asstring :=  frmprincipal2.zerarcodigo(inttostr( prestacao),2);
...
begin
  if qrreceber.state = dsinsert then
     qrreceber.fieldbyname('codigo').asstring := frmprincipal2.codifica('000062');
