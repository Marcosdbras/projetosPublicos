...
uses contasreceber, modulo, principal, troco, contasreceber_banco, temp,
    ...
    begin // apenas 01 conta
      ...
      if rdiferenca.Value <> 0 then
        begin
          ...
          begin
            if application.messagebox('Deseja Gerar uma parcela do restante do Débito?','Aviso',mb_yesno+MB_ICONWARNING+MB_DEFBUTTON2) = idyes then
              vgera_parcela := 1;
          end;
        end;
       ...
       vqtde_parcelas := vqtde_parcelas-1;
        ...
        begin
          ...
          begin
            ...
            frmcontasreceber.qrcontasreceber.fieldbyname('codigo').asstring          := FRMPRINCIPAL.codifica('000049')+'/RE';
