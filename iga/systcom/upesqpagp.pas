...
procedure TfrmPesqPagp.FormShow(Sender: TObject);
var
   vardir: String;
begin
...
procedure TfrmPesqPagp.ediOSExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqPagp.ediosefExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqPagp.ediparcExit(Sender: TObject);
var
   valor : integer;
begin
...
procedure TfrmPesqPagp.edimaxparcExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqPagp.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  frmPesqpagp:=nil;
  form_ativo := '';
...
procedure TfrmPesqPagp.mmoobsKeyPress(Sender: TObject; var Key: Char);
begin
   if (key = #13) then SelectNext(ActiveControl,True,True);
end;

procedure TfrmPesqPagp.dbgpagKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then
...
procedure TfrmPesqPagp.dbgpagEnter(Sender: TObject);
begin
tabela := 'Pagar';
end;

procedure TfrmPesqPagp.spdconfirmaClick(Sender: TObject);
begin
close;
end;

procedure TfrmPesqPagp.spdcancelaClick(Sender: TObject);
begin
close;
end;

procedure TfrmPesqPagp.spdfiltrarClick(Sender: TObject);
var
...
procedure TfrmPesqPagp.spdlimparClick(Sender: TObject);
begin
  edicodigoi.Text := '';
  edicodigof.Text := '';
...
procedure TfrmPesqPagp.edidescChange(Sender: TObject);
begin
if (edidesc.Text <> '') and (sclassificar <> 'Dte') and (sclassificar <> 'Dtv') and (sclassificar <> 'Dtl') and (sclassificar <> 'Dtb') then
   frmdados.cds_Pagar.Locate(frmpesqpagp.sClassificar,edidesc.text,[loPartialKey,loCaseInsensitive]);
//endi
end;

procedure TfrmPesqPagp.cbxclassificarKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure TfrmPesqPagp.cbxclassificarKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key := 0;
end;

procedure TfrmPesqPagp.edidescKeyPress(Sender: TObject; var Key: Char);
begin
edicodigoi.Text := '';
edicodigof.Text := '';
if key = #13 then
...
procedure TfrmPesqPagp.edicodigoiKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure TfrmPesqPagp.edicodigofKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure TfrmPesqPagp.dbgpagExit(Sender: TObject);
begin
  if frmdados.Cds_Pagar.State in [dsinsert, dsedit] then
     frmdados.Cds_Pagar.Post;
  //endi
...
procedure TfrmPesqPagp.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = 27 then
   close;
...
procedure TfrmPesqPagp.cbxclassificar2KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key := 0;
...
procedure TfrmPesqPagp.cbxclassificar2KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure TfrmPesqPagp.cbxclassificarClick(Sender: TObject);
begin
habdedidesc;
spdfiltrar.Click;
end;

procedure tfrmPesqPagp.habdedidesc;
begin
...
procedure TfrmPesqPagp.cbxnomeforClick(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqPagp.cbxnomeforEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqPagp.cbxnomeclaClick(Sender: TObject);
begin
tabela := 'temp';
end;

procedure TfrmPesqPagp.cbxnomeclaEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqPagp.cbxnomeforKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmPesqPagp.cbxnomesitpagarClick(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqPagp.cbxnomesitpagarEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqPagp.cbxnomeclaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_delete then
   frmdados.Cds_temp.edit;
...
procedure TfrmPesqPagp.cbxnomesitpagarKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key = vk_delete then
   frmdados.Cds_temp.edit;
...
procedure TfrmPesqPagp.spdIncluir171Click(Sender: TObject);
begin
if frmdados.Cds_Pagar.State in [dsinsert, dsedit] then
   begin
     frmdados.Cds_Pagar.CancelUpdates;
...
procedure TfrmPesqPagp.spdAlterar172Click(Sender: TObject);
begin
sOpcao := 'A';
...
procedure TfrmPesqPagp.spdExcluir173Click(Sender: TObject);
begin
sOpcao := 'E';
spdgravar.Visible := true;
spdcancelar2310.Left := iSpdcancelar2310a;
...
procedure TfrmPesqPagp.spdConsultar174Click(Sender: TObject);
begin
sOpcao := 'C';
...
procedure TfrmPesqPagp.sPdGravarClick(Sender: TObject);
var
 J : TJPEGImage;
 figura : tbitmap;
 S : TMemoryStream;
...
procedure TfrmPesqPagp.spdcancelar2310Click(Sender: TObject);
begin
...
procedure TfrmPesqPagp.AlternaF;
begin
...
procedure TfrmPesqPagp.AlternaL;
begin
dbgpag.Visible := true;
...
procedure TfrmPesqPagp.bloqueiacampos;
begin
pnlficha.Enabled         := false;
end;

procedure TfrmPesqPagp.desbloqueiacampos;
begin
...
procedure tfrmPesqPagp.bloqueiabotoes;
begin
...
procedure tfrmPesqPagp.desbloqueiabotoes;
begin
...
procedure TfrmPesqPagp.spdantClick(Sender: TObject);
begin
tabela := 'Pagar';
if frmdados.Cds_pagar.State in [dsinsert, dsedit] then
   begin
...
procedure TfrmPesqPagp.spdproxClick(Sender: TObject);
begin
tabela := 'Pagar';
if frmdados.Cds_Pagar.State in [dsinsert, dsedit] then
   begin
...
procedure TfrmPesqPagp.edidescricaoKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
