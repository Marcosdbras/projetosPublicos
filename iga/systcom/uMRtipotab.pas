...
var
  frmMRtipotab: TfrmMRtipotab;

implementation

uses uGeral, uPrincipal, uDados, ureltipotab ;

{$R *.DFM}

procedure TfrmMRtipotab.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmreltipotab := tfrmreltipotab.Create(self);
     frmreltipotab.relatorio.Preview;
     frmreltipotab.Free;
   end;
//endi
...
procedure TfrmMRtipotab.FormShow(Sender: TObject);
begin
...
procedure TfrmMRtipotab.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRtipotab.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRtipotab.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRtipotab.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure tfrmMRtipotab.Impetq;
var I , J : longint;
