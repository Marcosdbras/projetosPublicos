...
var
  frmMRcfun: TfrmMRcfun;

implementation

uses uGeral, uPrincipal, uDados, urelcfun, urelcfuns ;

{$R *.DFM}

procedure TfrmMRcfun.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelcfun := tfrmrelcfun.Create(self);
     frmrelcfun.relatorio.Preview;
     frmrelcfun.Free;
   end;
//endi
...
if rgbtiporel.ItemIndex = 1 then
   begin
     frmrelcfuns := tfrmrelcfuns.create(self);
     frmrelcfuns.relatorio.preview;
     frmrelcfuns.free;
   end;
//endi
...
procedure TfrmMRcfun.FormShow(Sender: TObject);
begin
...
procedure TfrmMRcfun.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRcfun.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRcfun.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRcfun.FormClose(Sender: TObject; var Action: TCloseAction);
begin
