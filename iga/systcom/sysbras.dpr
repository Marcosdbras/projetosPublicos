...
uses
  ...
  uimporcent in 'uimporcent.pas' {frmimporcent},
  ...
  Uemailent in 'Uemailent.pas' {frmemailent},
  ...
  uimpnfent in 'uimpnfent.pas' {frmimpnfent},
  ...
  uFecEnt in 'uFecEnt.pas' {frmfecent},
  ...
  uMRENT in 'uMRENT.pas' {frmMRENT},
  uimpent in 'uimpent.pas' {FrmImpEnt},
