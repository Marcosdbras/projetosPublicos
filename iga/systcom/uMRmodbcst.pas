...
var
  frmMRmodbcst: TfrmMRmodbcst;

implementation

uses uGeral, uPrincipal, uDados, urelmodbcst ;

{$R *.DFM}

procedure TfrmMRmodbcst.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRmodbcst.FormShow(Sender: TObject);
begin
...
procedure TfrmMRmodbcst.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRmodbcst.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRmodbcst.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRmodbcst.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure tfrmMRmodbcst.Impetq;
var I , J : longint;
