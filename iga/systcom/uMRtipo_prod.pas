...
var
  frmMRtipo_prod: TfrmMRtipo_prod;

implementation

uses uGeral, uPrincipal, uDados, ureltipo_prod ;

{$R *.DFM}

procedure TfrmMRtipo_prod.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmreltipo_prod := tfrmreltipo_prod.Create(self);
     frmreltipo_prod.relatorio.Preview;
     frmreltipo_prod.Free;
   end;
//endi
...
procedure TfrmMRtipo_prod.FormShow(Sender: TObject);
begin
...
procedure TfrmMRtipo_prod.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRtipo_prod.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRtipo_prod.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRtipo_prod.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure tfrmMRtipo_prod.Impetq;
var I , J : longint;
