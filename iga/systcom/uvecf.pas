...
implementation
  ...
  ucaixaap, ualterap, uMp20i, usangria, uingestao;

{$R *.dfm}


procedure tfrmvecf.limpar;
var
...
procedure Tfrmvecf.FormShow(Sender: TObject);
var
Erro:word;
...
procedure Tfrmvecf.xxxEnter(Sender: TObject);
begin
habilita;
end;

procedure Tfrmvecf.xxxExit(Sender: TObject);
begin
desabilita;
end;

procedure Tfrmvecf.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmvecf.dbgvenctoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure tfrmvecf.buscarprodutos;
begin
if sDescricao = '' then
   exit;
//endi
...
procedure Tfrmvecf.edicproExit(Sender: TObject);
begin
buscarprodutos;
end;

procedure Tfrmvecf.edidescricaoKeyPress(Sender: TObject; var Key: Char);
begin
if iImp = 1 then
   if key = #13 then
      begin
...
procedure Tfrmvecf.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
//endi
if rchrodape.Lines.Count = 1 then
   begin
     rchrodape.Clear;
...
procedure Tfrmvecf.ckbentradaClick(Sender: TObject);
begin
if edidescricao.Enabled then
   edidescricao.SetFocus;
//endi   
...
procedure Tfrmvecf.spdsalvar233Click(Sender: TObject);
...
procedure Tfrmvecf.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure Tfrmvecf.spdconsultaprodutoClick(Sender: TObject);
begin
  if edidescricao.Enabled then
     edidescricao.SetFocus;
  //endi   
...
procedure Tfrmvecf.dbgprodutosPaintPanel(DBCtrlGrid: TDBCtrlGrid;
  Index: Integer);
begin
...
procedure Tfrmvecf.cbxnomefunKeyPress(Sender: TObject; var Key: Char);
begin
  if (key = #13) then
     begin
       key := #0;
...
procedure Tfrmvecf.spdExcluir234Click(Sender: TObject);
begin
...
procedure tfrmvecf.desativabotoes;
begin
...
procedure tfrmvecf.ativabotoes;
begin
...
procedure Tfrmvecf.FormCreate(Sender: TObject);
begin
...
procedure Tfrmvecf.AplEventoException(Sender: TObject;
  E: Exception);
var
  NomeDoLog: string;
  Arquivo: TextFile;
...
procedure Tfrmvecf.ckbentregaClick(Sender: TObject);
begin
if edidescricao.Enabled then
   edidescricao.SetFocus;
//endi
...
procedure Tfrmvecf.spdfechamentoClick(Sender: TObject);
var x:integer;
...
procedure tfrmvecf.imporcrazao30x80;
var
...
procedure tfrmvecf.imporcrazao30x140;
var
  s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,sImp:string;
  ResultSet : tCustomSqlDataSet;
  SqlStMt : String;
...
if strtofloat(lbltroco.Caption) > 0 then
   begin
     iLin := iLin + 1;
     sayprint.Say(iLin,0,'Troco   ( R$      '+formatfloat('###,##0.00', strtofloat(lbltroco.Caption)  )+'  )');
   end;
//endi
...
if frmdados.Cds_Indice.FieldByName('impvlrreccli').asString = 'T' then
   begin
     iLin := iLin + 1;
     sayprint.Say(iLin,0,'Vlr.Rec.( R$      '+formatfloat('###,##0.00', strtofloat(edidin.text)  )+'  )');
   end;
//endi
...
procedure Tfrmvecf.spdConsultaCliente239Click(Sender: TObject);
begin
if iccli = 0 then
   begin
     iccli := 0;
...
procedure Tfrmvecf.edipdescExit(Sender: TObject);
begin
...
function Tfrmvecf.AlinEdNumD(texto:TEdit):string;
var
  n: Integer;
  c: TCanvas;
  h: HWND;
...
procedure Tfrmvecf.edivaldescExit(Sender: TObject);
...
procedure Tfrmvecf.editotpagarExit(Sender: TObject);
begin
...
procedure Tfrmvecf.edidinExit(Sender: TObject);
begin
try
...
procedure Tfrmvecf.edipdescKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmvecf.editotpagarKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmvecf.edidinKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmvecf.edivaldescKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmvecf.spdfechar236Click(Sender: TObject);
begin
...
procedure Tfrmvecf.spdcancfecClick(Sender: TObject);
begin
try
...
procedure Tfrmvecf.edincopiasKeyPress(Sender: TObject; var Key: Char);
begin
If not( key in['0'..'9',#8] ) then
  begin
  beep;
...
procedure Tfrmvecf.edinparcKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmvecf.dbgvenctoEnter(Sender: TObject);
begin

tabela := 'Vencimentos';
end;

procedure Tfrmvecf.dbgvenctoExit(Sender: TObject);
begin
if frmdados.Cds_vencto.State in [dsinsert, dsedit] then
   frmdados.Cds_vencto.Post;
//endi
...
procedure Tfrmvecf.edinparcExit(Sender: TObject);
begin
...
procedure Tfrmvecf.edipdescEnter(Sender: TObject);
begin
apafec;
edidin.Text := '0,00';
edidin.Text := AlinEdNumD(edidin);
...
procedure Tfrmvecf.edivaldescEnter(Sender: TObject);
begin
apafec;
edidin.Text := '0,00';
edidin.Text := AlinEdNumD(edidin);
...
procedure Tfrmvecf.edidinEnter(Sender: TObject);
begin
apafec;
end;

procedure Tfrmvecf.rgbtipoopClick(Sender: TObject);
begin
//showmessage(rgbtipoop.Items.Text);  
ajustargbtipoop;
end;

procedure Tfrmvecf.rchrodapeEnter(Sender: TObject);
begin
SelectNext(ActiveControl,True,True);

end;

procedure Tfrmvecf.rgbtipoentClick(Sender: TObject);
begin
ajustargbttipoent;
end;


procedure Tfrmvecf.limparrgb;
begin
...
procedure tfrmvecf.ajustargbtipoop;
begin
if bReimp then
   exit;
//endi
...
procedure tfrmvecf.ajustargbttipoent;
begin
if bReimp then
   exit;
//endi
...
procedure Tfrmvecf.cbxnomefunExit(Sender: TObject);
begin
...
procedure Tfrmvecf.cbxnomefunEnter(Sender: TObject);
begin
tabela := 'MovReg';
icfun := 0;
fpcomf := 0;
...
procedure Tfrmvecf.spdorcClick(Sender: TObject);
begin
...
procedure tfrmvecf.buscaorcamento;
begin
...
procedure tfrmvecf.buscapedido;
begin
...
procedure Tfrmvecf.spdcancelar2310Click(Sender: TObject);
begin
dbgprodutos.Enabled := true;
edidescricao.Enabled := true;
cbxnomefun.Enabled := true;
...
procedure Tfrmvecf.dbgvenctoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmvecf.dbgvenctoColEnter(Sender: TObject);
begin
  sColuna := dbgvencto.SelectedField.FieldName;

end;

procedure Tfrmvecf.spdcaixaapClick(Sender: TObject);
begin
...
procedure Tfrmvecf.spdAlterar232Click(Sender: TObject);
begin
  if dbgprodutos.Focused then
     begin
...
procedure Tfrmvecf.spdsangriaClick(Sender: TObject);
begin
...
procedure Tfrmvecf.spdtrocoClick(Sender: TObject);
begin
