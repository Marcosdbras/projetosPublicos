...
var
  frmMRSprodb: TfrmMRSprodb;

implementation

uses uGeral, uPrincipal, uDados, urelSprodb ;

{$R *.DFM}

procedure TfrmMRSprodb.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelSprodb := tfrmrelSprodb.Create(self);
     frmrelSprodb.relatorio.Preview;
     frmrelSprodb.Free;
   end;
//endi
...
procedure TfrmMRSprodb.FormShow(Sender: TObject);
begin
...
procedure TfrmMRSprodb.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRSprodb.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRSprodb.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRSprodb.FormClose(Sender: TObject; var Action: TCloseAction);
begin
