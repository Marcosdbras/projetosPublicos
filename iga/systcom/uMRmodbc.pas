...
var
  frmMRmodbc: TfrmMRmodbc;

implementation

uses uGeral, uPrincipal, uDados, urelmodbc ;

{$R *.DFM}

procedure TfrmMRmodbc.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRmodbc.FormShow(Sender: TObject);
begin
...
procedure TfrmMRmodbc.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRmodbc.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRmodbc.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRmodbc.FormClose(Sender: TObject; var Action: TCloseAction);
begin
