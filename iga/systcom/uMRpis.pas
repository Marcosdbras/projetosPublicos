...
uses uGeral, uPrincipal, uDados, urelpis ;

{$R *.DFM}

procedure TfrmMRpis.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRpis.FormShow(Sender: TObject);
begin
...
procedure TfrmMRpis.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRpis.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRpis.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRpis.FormClose(Sender: TObject; var Action: TCloseAction);
begin
