...
var
  frmMRsitb: TfrmMRsitb;

implementation

uses uGeral, uPrincipal, uDados, urelsitb ;

{$R *.DFM}

procedure TfrmMRsitb.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRsitb.FormShow(Sender: TObject);
begin
...
procedure TfrmMRsitb.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRsitb.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRsitb.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRsitb.FormClose(Sender: TObject; var Action: TCloseAction);
begin
