...
type
  Tfrmfecped = class(TForm)
    ...
    procedure cbxcondpgtoEnter(Sender: TObject);
    procedure abrirtabelas;
    procedure cbxcondpgtoExit(Sender: TObject);
    procedure cbxcondpgtoKeyPress(Sender: TObject; var Key: Char);
  ...
  private
    ...
    sFantasia, sTelefones, scustopecas, sNroEnt:string;
...
var
  frmfecped: Tfrmfecped;

implementation
  uses ugeral, upesqvd, uDados, uimpnf, Uemailped, uimpped;
{$R *.dfm}

procedure Tfrmfecped.spdcancelar2310Click(Sender: TObject);
begin
...
procedure Tfrmfecped.FormShow(Sender: TObject);
var
...
begin
  ...
  frmdados.Cds_TempCOD2.AsInteger :=  frmdados.Cds_Clientesccondpagto.AsInteger;
  ...
  scustopecas :=  frmpesqvd.lbltotalc.Caption;

  ediparc.Enabled := false;
  cbxcondpgto.Enabled := false;
  ...
  with frmdados do
     begin
       ...
       cds_venctodescricao.DefaultExpression := QuotedStr('Parcela Pedido');
       cds_venctoehvenda.DefaultExpression := 'F';
          ...
          begin
            ...
            with frmdados do
              begin
                ...
                dbx_exec.SQL.Clear;
                dbx_exec.SQL.Add('delete from Vencimentos where (c_sVenda = '+ inttostr( frmdados.cds_sVenda.fieldbyname('codigo').asInteger )+')');
                dbx_exec.ExecSQL;
...
procedure Tfrmfecped.edipdescKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivaldescKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediliquidoKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edidinKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edinumdup1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edinumdup2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edinumdup3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivlrdup1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivlrdup2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivlrdup3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivctdup1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivctdup2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivctdup3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.cbxnaturezaKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.cbxcfopKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediBASECALCICMSSUBKeyPress(Sender: TObject;
  var Key: Char);
begin
if (key = #13) then
   begin
...
procedure Tfrmfecped.ediVLRICMSSUBKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivlrfreteKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edivlrseguroKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edioutdespKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediplacaveiKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.cbxntranspKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediufveiKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediquantidadeKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediespecieKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edimarcaKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edinumeroKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edipesobKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edipesolKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.edipdescExit(Sender: TObject);
var
...
procedure Tfrmfecped.edivaldescExit(Sender: TObject);
var
  ftot, fpdesc, fvaldesc:real;
  spdesc:string;
...
procedure Tfrmfecped.ediliquidoExit(Sender: TObject);
...
procedure tfrmfecped.ler_linha_col_nf(icodconfnf:integer);
begin
...
procedure Tfrmfecped.spdlancarClick(Sender: TObject);
var ftotal:currency;
    ftotalprazo:integer;
    ResultSet : tCustomSqlDataSet;
    SqlStMt : String;
...
if frmpesqvd.rgbtipoop.ItemIndex = 0 then
   ...
   begin
     if frmdados.Cds_sVenda.FieldByName('nped').asInteger = 0 then
        ...
        begin
          iNped := frmdados.Cds_sVenda.FieldByName('nped').asInteger;
        end;
     //endi
     ...
     with frmdados do
          begin
            ...
            dbx_exec.Active := false;
            dbx_exec.SQL.Clear;
            dbx_exec.SQL.Add('update Vencimentos set nped = '+inttostr(frmdados.Cds_sVenda.FieldByName('nped').asInteger)+' where (c_svenda = '+ inttostr( cds_svenda.fieldbyname('codigo').asInteger)+')'  );
            dbx_exec.ExecSQL;
            ...
            if Cds_sVenda.FieldByName('lancado').asString = 'F' then
               begin
                 ...
                 if not ckbdescunit.Checked then
                    begin
                 ...
                 cds_nf.FieldByName('ctab').AsInteger := cds_svenda.fieldbyname('ctab').asInteger;
                 cds_nf.Post;
                   ...
                   begin
                     ...
                     if dbx_exec.FieldByName('treg').AsInteger = 0 then
                        begin
                          ...
                          cds_nfp.FieldByName('indtot').asString := cds_dvenda.fieldbyname('indtot').asstring;
                          cds_nfp.FieldByName('ncm').asString := cds_dvenda.fieldbyname('ncm').asstring;
                     ...
                     if cds_svenda.fieldbyname('cfun').asInteger > 0 then
                        begin
                     ...
                     //endi
                     if cds_svenda.fieldbyname('crep').asInteger > 0 then
                        begin

                          cds_Comissao.FieldByName('crep').asInteger := cds_svenda.fieldbyname('crep').asInteger;
                          dbx_exec.Active := false;
                          dbx_exec.SQL.Clear;
                          dbx_exec.SQL.Add('Select comissao from Representantes where codigo = '+inttostr(cds_svenda.fieldbyname('crep').asInteger));
                          dbx_exec.Active := true;

                          cds_comissao.FieldByName('pcomr').asfloat := dbx_exec.fieldbyname('comissao').asfloat;
                          cds_comissao.FieldByName('vcomr').asfloat := ( dbx_exec.fieldbyname('comissao').asfloat / 100 ) * (   cds_dvenda.fieldbyname('Subtotal').asfloat  - (   cds_dvenda.fieldbyname('Subtotal').asfloat * cds_svenda.fieldbyname('pdesc_p').asfloat / 100 ) );

                        end;
                     //endi
                     cds_Comissao.FieldByName('Descricao').asString := 'Pedido N.o '+ formatfloat('00000', Cds_sVenda.FieldByName('nped').asInteger) ;
...
frmdados.cds_vencto.EnableControls;   // volta

end;

procedure Tfrmfecped.ediparcKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure tfrmfecped.bloqueiaparcelas;
begin
  //
end;

procedure Tfrmfecped.edidinExit(Sender: TObject);
begin
limparp;
bloqueiaparcelas;
   ...
   begin
      if frmdados.Cds_sVenda.FieldByName('din_p').asfloat < frmdados.Cds_sVenda.FieldByName('liquido_p').asfloat  then
         begin
           ...
           //endi
           if cbxcondpgto.Enabled then
              cbxcondpgto.SetFocus;
           //endi
...
procedure tfrmfecped.limparP;
begin
//
end;


procedure Tfrmfecped.ediparcExit(Sender: TObject);
begin
...
procedure Tfrmfecped.edidinEnter(Sender: TObject);
begin
lbltroco.Caption := '0,00';
...
procedure Tfrmfecped.ediprazo1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediprazo2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediprazo3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.ediparcEnter(Sender: TObject);
begin
  if frmdados.Cds_Clientes.FieldByName('prazo').asInteger > 0 then
     begin
       if rgblanca.ItemIndex = 0 then
...
procedure Tfrmfecped.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure tfrmfecped.desbloqueiar;
begin
edipdesc.Enabled :=true;
edivaldesc.Enabled := true;
ediliquido.Enabled := true;
...
procedure tfrmfecped.desbloqueiaf;
begin
edipdesc.Enabled :=true;
edivaldesc.Enabled := true;
ediliquido.Enabled := true;
...
procedure Tfrmfecped.cbxtipoKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure Tfrmfecped.dbgvenctoKeyPress(Sender: TObject; var Key: Char);
begin
if rgblanca.ItemIndex = 0 then
   if frmdados.Cds_sVenda.FieldByName('lancado').asString = 'T' then
      begin
...
procedure Tfrmfecped.dbgvenctoExit(Sender: TObject);
begin
   ...
   begin
     ...
     if frmdados.Cds_sVenda.FieldByName('parc_p').asInteger > 0 then
        begin
          ...
          //showmessage(frmdados.Cds_sVenda.fieldbyname('din_p').Asstring);
          //fvlrparc :=   (     frmdados.Cds_sVenda.fieldbyname('liquido_p').AsFloat    -  frmdados.Cds_sVenda.fieldbyname('din_p').AsFloat    ) / strtofloat(tirapontos(ediparc.Text));
...
procedure tfrmfecped.criaparcpedido;
var x, iparc, iaprazo:integer;
    fvlrparc:currency;
    fvalor:currency;
    sdata:string;
...
try
          ...
          frmdados.dbx_conddetalhe_pgto.SQL.Clear;
          frmdados.dbx_conddetalhe_pgto.SQL.Add('select * from conddetalhepgto where ccondpgto = '+ inttostr( frmdados.cds_temp.fieldbyname('cod2').asInteger ) );
          frmdados.dbx_conddetalhe_pgto.Active := true;
          frmdados.cds_conddetalhe_pgto.Active := true;
          ...
          while not frmdados.cds_conddetalhe_pgto.Eof do
              begin
                ...
                frmdados.Dbx_Exec.Active := false;
                frmdados.Dbx_Exec.SQL.Clear;
                frmdados.Dbx_Exec.SQL.Add('insert into vencimentos (prazo, dtv, valorreal, originado, ccli, c_tipo_pgto, csit, parc, doc, parte, ehvenda, c_sVenda)');
                frmdados.Dbx_Exec.SQL.Add('values ( :prazo, :dtv, :valorreal, :originado, :ccli, :c_tipo_pgto, :csit, :parc, :doc, :parte, :ehvenda, :c_sVenda )') ;

                frmdados.Dbx_Exec.ParamByName('prazo').asInteger := frmdados.cds_conddetalhe_pgto.FieldByName('dias').asInteger;

                sdata :=  calc_data(sdata,frmdados.cds_conddetalhe_pgto.FieldByName('dias').asInteger);

                frmdados.Dbx_Exec.ParamByName('dtv').asstring := formatdatetime('DD.MM.YYYY',strtodate(sdata));;

                fvalor := (     strtofloat(tirapontos(ediliquido.Text))    -  strtofloat(tirapontos(edidin.Text))    ) * (frmdados.cds_conddetalhe_pgto.fieldbyname('perc').AsFloat / 100 );

                frmdados.Dbx_Exec.ParamByName('valorreal').asfloat := fvalor  ;
                frmdados.Dbx_Exec.ParamByName('originado').asString := '2'+frmdados.Cds_sVenda.fieldbyname('tipoop').asString;
                frmdados.Dbx_Exec.ParamByName('ccli').asInteger := frmdados.Cds_sVenda.fieldbyname('ccli').asInteger;
                ...
                frmdados.Cds_vencto.Append;
                frmdados.Cds_vencto.FieldByName('prazo').asInteger := frmdados.cds_conddetalhe_pgto.FieldByName('dias').asInteger;
                frmdados.Cds_vencto.FieldByName('dtv').asString := calc_data(sdata,frmdados.Cds_vencto.FieldByName('prazo').asInteger);

                frmdados.Cds_vencto.FieldByName('valorreal').asfloat := (     strtofloat(tirapontos(ediliquido.Text))    -  strtofloat(tirapontos(edidin.Text))    ) * (frmdados.cds_conddetalhe_pgto.fieldbyname('perc').AsFloat / 100 )    ;
                frmdados.Cds_vencto.FieldByName('originado').asString := '2'+frmdados.Cds_sVenda.fieldbyname('tipoop').asString;
                frmdados.Cds_vencto.FieldByName('ccli').asInteger := frmdados.Cds_sVenda.fieldbyname('ccli').asInteger;
                frmdados.Cds_vencto.FieldByName('c_tipo_pgto').asInteger := frmdados.Cds_Indice.fieldbyname('parcpadrao').asInteger;
                frmdados.Cds_vencto.FieldByName('csit').asInteger := frmdados.Cds_Indice.fieldbyname('csitr').asInteger;
                frmdados.Cds_vencto.FieldByName('parc').asstring := formatfloat('00',frmdados.cds_conddetalhe_pgto.FieldByName('dias').asInteger)+'/'+ formatfloat('00',frmdados.cds_conddetalhe_pgto.RecordCount);
                frmdados.Cds_vencto.FieldByName('doc').asstring := lblnped.Caption+'-'+chr(64+frmdados.cds_conddetalhe_pgto.FieldByName('dias').asInteger);
                frmdados.Cds_vencto.FieldByName('parte').asstring := chr(64+frmdados.cds_conddetalhe_pgto.FieldByName('dias').asInteger);
                frmdados.Cds_vencto.FieldByName('ehvenda').asstring := 'F';
                ...
                frmdados.cds_conddetalhe_pgto.Next;
          ...
          if fsobra > 0 then
             begin
               showmessage(  floattostr(arredondar(fsobra,3) )   );

               frmdados.Cds_vencto.Last;
               frmdados.Cds_vencto.Edit;
               frmdados.Cds_vencto.FieldByName('valorreal').asfloat := frmdados.Cds_vencto.FieldByName('valorreal').asfloat + arredondar(  fsobra, 3);
               frmdados.Cds_vencto.Post;
             end;
          //end
          ...
          ediparc.Enabled := false;
          ediparc.Text := inttostr(frmdados.cds_conddetalhe_pgto.RecordCount);
...
procedure tfrmfecped.apagaparc;
begin
  with frmdados do
    begin
...
procedure Tfrmfecped.dbgvenctoEnter(Sender: TObject);
begin
if rgblanca.ItemIndex = 0 then
   tabela := 'Vencimentos';
//endi
...
procedure Tfrmfecped.dbgvenctoColEnter(Sender: TObject);
begin
  sColuna := dbgvencto.SelectedField.FieldName;
end;

procedure Tfrmfecped.rgblancaClick(Sender: TObject);
begin
if rgblanca.ItemIndex = 0 then
   begin
     tabela := 'Vencimentos';
...
procedure Tfrmfecped.dbgvenctoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if rgblanca.ItemIndex = 0 then
   if frmdados.Cds_sVenda.FieldByName('lancado').asString = 'T' then
...
procedure Tfrmfecped.imporcrazao66x80;
var
...
procedure tfrmfecped.imporcrazao66x140;
var
  s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,sImp:string;
  ResultSet : tCustomSqlDataSet;
  SqlStMt : String;
...
while true do
  begin
    ...
    //                 xx.xxx,xxx    xxx xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxxxxxxxxx  xxxxx  xxx,xxx.xx  xxx,xxx.xx
    sayprint.Say(13,0,sDelimitador);
         ...
         begin
           ...
           while true do
              begin
                ...
                sayprint.Say(iLin,0,sQtdeImp);
                sayprint.Say(iLin,14,sUniImp);
                sayprint.Say(iLin,18,sDescricaoImp);
...
procedure Tfrmfecped.edincopiasExit(Sender: TObject);
begin
try
...
procedure Tfrmfecped.ckbemailClick(Sender: TObject);
begin
...
procedure Tfrmfecped.bloqueiacampos;
begin
...
procedure Tfrmfecped.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  frmfecped:=nil;
...
procedure Tfrmfecped.cbxcondpgtoEnter(Sender: TObject);
begin
tabela := 'Temp';
end;


procedure tfrmfecped.abrirtabelas;
begin
...
if rgblanca.ItemIndex = 0 then
   begin
     ...
     frmdados.cds_venctodescricao.DefaultExpression := QuotedStr('Parcela Pedido');
     frmdados.cds_venctoehvenda.DefaultExpression := 'F';
...
procedure Tfrmfecped.cbxcondpgtoExit(Sender: TObject);
begin
if cbxcondpgto.Text <> '' then
   begin
     abrirtabelas;
     criaparcpedido;
...
procedure Tfrmfecped.cbxcondpgtoKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
