...
var
  frmMRsita: TfrmMRsita;

implementation

uses uGeral, uPrincipal, uDados, urelsita ;

{$R *.DFM}

procedure TfrmMRsita.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRsita.FormShow(Sender: TObject);
begin
...
procedure TfrmMRsita.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRsita.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRsita.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRsita.FormClose(Sender: TObject; var Action: TCloseAction);
begin
