...
var
  frmMRnatop: TfrmMRnatop;

implementation

uses uGeral, uPrincipal, uDados, urelnatop ;

{$R *.DFM}

procedure TfrmMRnatop.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRnatop.FormShow(Sender: TObject);
begin
...
procedure TfrmMRnatop.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRnatop.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRnatop.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRnatop.FormClose(Sender: TObject; var Action: TCloseAction);
begin
