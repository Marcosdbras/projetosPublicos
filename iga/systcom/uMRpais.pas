...
var
  frmMRpais: TfrmMRpais;

implementation

uses uGeral, uPrincipal, uDados, urelpais ;

{$R *.DFM}

procedure TfrmMRpais.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRpais.FormShow(Sender: TObject);
begin
...
procedure TfrmMRpais.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRpais.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRpais.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRpais.FormClose(Sender: TObject; var Action: TCloseAction);
begin
