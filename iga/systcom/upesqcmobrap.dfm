object frmPesqcmobrap: TfrmPesqcmobrap
  Left = 117
  Top = 18
  Width = 901
  Height = 709
  BorderIcons = []
  Caption = 'Pesquisa de M'#227'o-de-Obra'
  Color = clBtnFace
  ...
  object pnldir: TPanel
    ...
    object pgtmao: TPageControl
      ...
      object tbsmodulo: TTabSheet
        ...
        OnShow = tbsmoduloShow
        object dbgmodulo: TDBGrid
          Left = 0
          Top = 0
          Width = 682
          Height = 465
          Align = alClient
          DataSource = frmDados.Dts_Modulo
          TabOrder = 0
          ...
          TitleFont.Style = []
          OnEnter = dbgmoduloEnter
          OnExit = dbgmoduloExit
          OnKeyDown = dbgmoduloKeyDown
          OnKeyPress = dbgmoduloKeyPress
          Columns = <
            item
              Expanded = False
              FieldName = 'DESCRICAO'
      ...
      object tbscmobra: TTabSheet
        Caption = 'Tratamento'
        ImageIndex = 1
        OnShow = tbscmobraShow
        object dbgcmobra: TDBGrid
          Left = 0
          Top = 0
          Width = 682
          Height = 465
          ...
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnEnter = dbgcmobraEnter
          OnExit = dbgcmobraExit
          OnKeyDown = dbgcmobraKeyDown
          OnKeyPress = dbgcmobraKeyPress
          Columns = <
            item
              Expanded = False
              FieldName = 'DESCR'
