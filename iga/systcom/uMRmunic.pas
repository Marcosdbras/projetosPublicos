...
var
  frmMRmunic: TfrmMRmunic;

implementation

uses uGeral, uPrincipal, uDados, urelmunic ;

{$R *.DFM}

procedure TfrmMRmunic.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRmunic.FormShow(Sender: TObject);
begin
...
procedure TfrmMRmunic.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRmunic.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRmunic.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRmunic.FormClose(Sender: TObject; var Action: TCloseAction);
begin
