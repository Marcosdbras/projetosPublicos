object frmMRCla: TfrmMRCla
  ...
  object rgbtiporel: TRadioGroup
    ...
    Caption = 'Relat'#243'rios'
    Items.Strings = (
      'Resumo de contas Pagas - 1'#186' Semestre - Ano Atual'
      'Resumo de contas Pagas - 2'#186' Semestre - Ano Atual'
      'Resumo de contas Pagas - 1'#186' Semestre - Ano SubSeq'#252#234'nte'
      'Resumo de contas Pagas - 2'#186' Semestre - Ano SubSeq'#252#234'nte'
      'Detalhado'
      'Simplificado')
    TabOrder = 0
