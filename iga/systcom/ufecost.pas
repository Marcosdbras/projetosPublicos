...
var
  frmfecOST: TfrmfecOST;

implementation
  uses ugeral, upesqost, uDados, uImpOST;
{$R *.dfm}

procedure TfrmfecOST.spdcancelar2310Click(Sender: TObject);
begin
...
procedure TfrmfecOST.FormShow(Sender: TObject);
var
...
begin
  ...
  lbltotG.Caption :=  formatfloat('###,###,##0.00', strtofloat(tirapontos(frmpesqost.lbltotalMg.Caption)) - ftvalliq  );

  //scustopecas :=  frmpesqost.lbltotalc.Caption;
...
procedure TfrmfecOST.edipdescKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivaldescKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediliquidoKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edidinKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edinumdup1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edinumdup2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edinumdup3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivlrdup1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivlrdup2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivlrdup3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivctdup1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivctdup2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivctdup3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.cbxnaturezaKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.cbxcfopKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediBASECALCICMSSUBKeyPress(Sender: TObject;
  var Key: Char);
begin
if (key = #13) then
   begin
...
procedure TfrmfecOST.ediVLRICMSSUBKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivlrfreteKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edivlrseguroKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edioutdespKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediplacaveiKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.cbxntranspKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediufveiKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediquantidadeKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediespecieKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edimarcaKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edinumeroKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edipesobKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edipesolKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.edipdescExit(Sender: TObject);
var
...
procedure TfrmfecOST.edivaldescExit(Sender: TObject);
var
  ftot, fpdesc, fvaldesc:real;
  spdesc:string;
...
procedure TfrmfecOST.ediliquidoExit(Sender: TObject);
...
procedure tfrmfecOST.ler_linha_col_nf(icodconfnf:integer);
begin
...
procedure TfrmfecOST.spdlancarClick(Sender: TObject);
var ftotal:currency;
    ftotalprazo:integer;
    ResultSet : tCustomSqlDataSet;
    SqlStMt : String;
...
procedure TfrmfecOST.ediparcKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure tfrmfecOST.bloqueiaparcelas;
begin
  //
end;

procedure TfrmfecOST.edidinExit(Sender: TObject);
begin
limparp;
bloqueiaparcelas;
     ...
     begin
       if frmdados.Cds_sVenda.FieldByName('lancado').AsString <> 'T' then
          begin
            ...
            //frmdados.Cds_sVenda.FieldByName('liquido_p').asfloat := strtofloat(tirapontos(frmpesqost.lbltotal.Caption));
...
procedure tfrmfecOST.limparP;
begin
//
end;


procedure TfrmfecOST.ediparcExit(Sender: TObject);
begin
if rgblanca.ItemIndex = 0 then
   begin
...
procedure TfrmfecOST.edidinEnter(Sender: TObject);
begin
lbltroco.Caption := '0,00';
...
procedure TfrmfecOST.ediprazo1KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediprazo2KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediprazo3KeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.ediparcEnter(Sender: TObject);
begin
  if frmdados.Cds_Clientes.FieldByName('prazo').asInteger > 0 then
     begin
       if rgblanca.ItemIndex = 0 then
...
procedure TfrmfecOST.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure tfrmfecOST.desbloqueiar;
begin
edipdesc.Enabled :=true;
edivaldesc.Enabled := true;
ediliquido.Enabled := true;
...
procedure tfrmfecOST.desbloqueiaf;
begin
edipdesc.Enabled :=true;
edivaldesc.Enabled := true;
ediliquido.Enabled := true;
...
procedure TfrmfecOST.cbxtipoKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
   begin
     key := #0;
...
procedure TfrmfecOST.dbgvenctoKeyPress(Sender: TObject; var Key: Char);
begin
if rgblanca.ItemIndex = 0 then
   if frmdados.Cds_sVenda.FieldByName('lancado').asString = 'T' then
      begin
...
procedure TfrmfecOST.dbgvenctoExit(Sender: TObject);
begin
...
procedure tfrmfecOST.apagaparc;
begin
  with frmdados do
    begin
...
procedure TfrmfecOST.dbgvenctoEnter(Sender: TObject);
begin
if rgblanca.ItemIndex = 0 then
   tabela := 'Vencimentos';
//endi
...
procedure TfrmfecOST.dbgvenctoColEnter(Sender: TObject);
begin
  sColuna := dbgvencto.SelectedField.FieldName;
end;

procedure TfrmfecOST.rgblancaClick(Sender: TObject);
begin
if rgblanca.ItemIndex = 0 then
   begin
     tabela := 'Vencimentos';
...
procedure TfrmfecOST.dbgvenctoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if rgblanca.ItemIndex = 0 then
   if frmdados.Cds_sVenda.FieldByName('lancado').asString = 'T' then
...
procedure TfrmfecOST.imporcrazao66x80;
var
...
procedure tfrmfecOST.imporcrazao66x140;
var
  s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,sImp:string;
  ResultSet : tCustomSqlDataSet;
  SqlStMt : String;
...
procedure TfrmfecOST.edincopiasExit(Sender: TObject);
begin
try
...
procedure TfrmfecOST.ckbemailClick(Sender: TObject);
begin
...
procedure TfrmfecOST.bloqueiacampos;
begin
...
procedure TfrmfecOST.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  frmfecOst:=nil;
...
procedure tfrmfecOST.imporc70b;
var
  s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,sImp:string;
  ResultSet : tCustomSqlDataSet;
  SqlStMt : String;
