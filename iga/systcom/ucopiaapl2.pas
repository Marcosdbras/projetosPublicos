...
var
  frmcopiaapl2: Tfrmcopiaapl2;

implementation
  uses ugeral, udados, uprincipal;
{$R *.dfm}

procedure Tfrmcopiaapl2.SpeedButton1Click(Sender: TObject);
begin
  close;
end;

procedure Tfrmcopiaapl2.spdconfirmaClick(Sender: TObject);
var
  sValor:string;
begin
...
procedure Tfrmcopiaapl2.FormClose(Sender: TObject;
...
procedure Tfrmcopiaapl2.FormShow(Sender: TObject);
begin
   lblmensagem.Visible := false;
   lblmensagem2.Visible := false;
   antmove.Visible := false;
