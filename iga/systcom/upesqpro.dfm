object frmPesqProd: TfrmPesqProd
  ...
  object pnldir: TPanel
    ...
    object dbgprodutos: TDBGrid
      ...
      Width = 679
      Height = 133
      DataSource = frmDados.Dst_Produtos
    ...
    object pcldetalhe: TPageControl
      ...
      object tbscarac: TTabSheet
        ...
        object dbgdprodutos: TDBGrid
          ...
          TabStop = False
          Align = alClient
          DataSource = frmDados.Dst_dProdutos
          Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgAlwaysShowSelection, dgConfirmDelete, dgCancelOnExit]
          TabOrder = 0
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          ...
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnEnter = dbgdprodutosEnter
          OnExit = dbgdprodutosExit
          OnKeyPress = dbgdprodutosKeyPress
          Columns = <
            item
              Expanded = False
              FieldName = 'QUA'
            ...
            item
              Expanded = False
              FieldName = 'ULTCONT'
              Title.Caption = 'Dt. Invent'#225'rio'
              Width = 74
              Visible = True
            end
            item
