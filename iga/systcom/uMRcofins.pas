...
var
  frmMRcofins: TfrmMRcofins;

implementation

uses uGeral, uPrincipal, uDados, urelcofins, urelcofinss ;

{$R *.DFM}

procedure TfrmMRcofins.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 1 then
   begin
     frmrelcofinss := tfrmrelcofinss.Create(self);
     frmrelcofinss.relatorio.Preview;
     frmrelcofinss.Free;
   end;
//endi
...
procedure TfrmMRcofins.FormShow(Sender: TObject);
begin
...
procedure TfrmMRcofins.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRcofins.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRcofins.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRcofins.FormClose(Sender: TObject; var Action: TCloseAction);
begin
