...
uses uGeral, uPrincipal, uDados ,urelipi ;

{$R *.DFM}

procedure TfrmMRipi.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRipi.FormShow(Sender: TObject);
begin
...
procedure TfrmMRipi.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRipi.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRipi.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRipi.FormClose(Sender: TObject; var Action: TCloseAction);
begin
