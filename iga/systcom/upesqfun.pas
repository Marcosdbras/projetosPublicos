...
type
  TfrmPesqfun = class(TForm)
    ...
    procedure dbgFuncionariosKeyPress(Sender: TObject; var Key: Char);
    procedure dbgFuncionariosEnter(Sender: TObject);
    ...
    procedure dbgFuncionariosExit(Sender: TObject);
...
procedure TfrmPesqfun.FormShow(Sender: TObject);
var
   vardir: String;
begin
...
procedure TfrmPesqfun.ediOSExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqfun.ediosefExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqfun.ediparcExit(Sender: TObject);
var
   valor : integer;
begin
...
procedure TfrmPesqfun.edimaxparcExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqfun.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfrmPesqfun.mmoobsKeyPress(Sender: TObject; var Key: Char);
begin
   if (key = #13) then SelectNext(ActiveControl,True,True);
end;

procedure TfrmPesqfun.dbgFuncionariosKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then
...
procedure TfrmPesqfun.dbgFuncionariosEnter(Sender: TObject);
begin
tabela := 'Funcionarios';
end;

procedure TfrmPesqfun.spdconfirmaClick(Sender: TObject);
begin
close;
end;

procedure TfrmPesqfun.spdcancelaClick(Sender: TObject);
begin
close;
end;

procedure TfrmPesqfun.spdfiltrarClick(Sender: TObject);
var
...
procedure TfrmPesqfun.spdlimparClick(Sender: TObject);
begin
  edicodigoi.Text := '';
  edicodigof.Text := '';
...
procedure TfrmPesqfun.edidescChange(Sender: TObject);
begin
if edidesc.Text <> '' then
   frmdados.cds_Funcionarios.Locate(frmpesqfun.sClassificar,edidesc.text,[loPartialKey,loCaseInsensitive]);
//endi
end;

procedure TfrmPesqfun.cbxclassificarKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure TfrmPesqfun.cbxclassificarKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key := 0;
end;

procedure TfrmPesqfun.edidescKeyPress(Sender: TObject; var Key: Char);
begin
edicodigoi.Text := '';
edicodigof.Text := '';
if key = #13 then
...
procedure TfrmPesqfun.edicodigoiKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure TfrmPesqfun.edicodigofKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure TfrmPesqfun.dbgFuncionariosExit(Sender: TObject);
begin
  if frmdados.Cds_Funcionarios.State in [dsinsert, dsedit] then
     frmdados.Cds_Funcionarios.Post;
  //endi
...
procedure TfrmPesqfun.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = 27 then
   close;
...
procedure TfrmPesqfun.dbgFuncionariosKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
