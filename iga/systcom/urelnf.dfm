  ...
  object relatorio: TQuickRep
    ...
    object detalhe: TQRBand
      ...
      object lblvalordesc: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'lblvalordesc'
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
      object lblliqui: TQRLabel
        Left = 675
        Top = 0
        Width = 37
        Height = 17
