...
procedure Tfrmimpos.mostrararq_ext;
var
 J : TJPEGImage;
 figura : tbitmap;
 S : TMemoryStream;
...
procedure TFrmImpOs.detalheBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
procedure TFrmImpOs.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
  var pCodSit, pCodfunreb, pCodfuncon:Integer;
      VarDir, presttexto:String;
      S:TMemoryStream;
...
procedure TFrmImpOs.GroupHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFrmImpOs.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 if frmdados.Cds_dVenda.RecordCount > 0 then
    begin
...
procedure TFrmImpOs.GroupFooterBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFrmImpOs.GroupHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
procedure TFrmImpOs.QRSubDetail2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
if frmdados.Cds_exec.RecordCount > 0 then
   begin
...
procedure TFrmImpOs.QRSubDetail2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
try
...
procedure TFrmImpOs.GroupFooterBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  mmoobs1.Lines.Clear;
...
procedure TFrmImpOs.GroupHeaderBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFrmImpOs.QRSubDetail3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 if frmdados.Cds_Vencto.RecordCount > 0 then
    begin
...
procedure TFrmImpOs.GroupFooterBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
  var
    vardir:string;
begin
...
procedure TFrmImpOs.relatorioBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
