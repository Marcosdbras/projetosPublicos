object frmPesqtrans: TfrmPesqtrans
  Left = -4
  Top = -4
  Width = 1032
  Height = 746
  BorderIcons = []
  Caption = 'Pesquisa de Transportadores'
  Color = clBtnFace
  ...
  object pnldir: TPanel
    ...
    object pnlficha: TPanel
      ...
      object pnlcab: TPanel
        ...
        object DBText1: TDBText
          ...
          Height = 17
          DataField = 'CODIGO'
          DataSource = frmDados.Dts_Transportadores
        end
    ...
    object dbgTransportadores: TDBGrid
      Left = 4
      Top = 487
      Width = 681
      Height = 105
      ...
      TitleFont.Style = []
      OnEnter = dbgTransportadoresEnter
      OnExit = dbgTransportadoresExit
      OnKeyDown = dbgTransportadoresKeyDown
      OnKeyPress = dbgTransportadoresKeyPress
      Columns = <
        item
          Expanded = False
          FieldName = 'NOME'
