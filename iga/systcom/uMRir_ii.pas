...
var
  frmMRir_ii: TfrmMRir_ii;

implementation

uses uGeral, uPrincipal, uDados, urelir_ii ;

{$R *.DFM}

procedure TfrmMRir_ii.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelir_ii := tfrmrelir_ii.Create(self);
     frmrelir_ii.relatorio.Preview;
     frmrelir_ii.Free;
   end;
//endi
...
procedure TfrmMRir_ii.FormShow(Sender: TObject);
begin
...
procedure TfrmMRir_ii.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRir_ii.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRir_ii.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRir_ii.FormClose(Sender: TObject; var Action: TCloseAction);
begin
