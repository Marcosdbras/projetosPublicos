...
uses uGeral, uPrincipal, uDados, urelvf , urelvfd;

{$R *.DFM}

procedure Tfrmmrvf.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelvf := tfrmrelvf.Create(self);
     frmrelvf.relatorio.Preview;
     frmrelvf.Free;
   end;
//endi
...
if rgbtiporel.ItemIndex = 1 then
   begin
     frmrelvfd := tfrmrelvfd.create(self);
     frmrelvfd.relatorio.preview;
     frmrelvfd.free;
   end;
//endi
...
procedure Tfrmmrvf.FormShow(Sender: TObject);
begin
...
procedure Tfrmmrvf.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure Tfrmmrvf.spdSairClick(Sender: TObject);
begin
close;
end;

procedure Tfrmmrvf.Timer1Timer(Sender: TObject);
begin
...
procedure Tfrmmrvf.FormClose(Sender: TObject; var Action: TCloseAction);
begin
