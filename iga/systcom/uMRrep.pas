...
uses uGeral, uPrincipal, uDados, urelrep, urelreps ;

{$R *.DFM}

procedure TfrmMRrep.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelrep := tfrmrelrep.Create(self);
     frmrelrep.relatorio.Preview;
     frmrelrep.Free;
   end;
//endi
...
if rgbtiporel.ItemIndex = 1 then
   begin
     frmrelreps := tfrmrelreps.create(self);
     frmrelreps.relatorio.preview;
     frmrelreps.free;
   end;
//endi
...
procedure TfrmMRrep.FormShow(Sender: TObject);
begin
...
procedure TfrmMRrep.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRrep.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRrep.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRrep.FormClose(Sender: TObject; var Action: TCloseAction);
begin
