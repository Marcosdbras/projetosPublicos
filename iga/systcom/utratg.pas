...
procedure TfrmPesqcfunp1.FormShow(Sender: TObject);
var
   vardir: String;
begin
...
procedure TfrmPesqcfunp1.ediOSExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqcfunp1.ediosefExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqcfunp1.ediparcExit(Sender: TObject);
var
   valor : integer;
begin
...
procedure TfrmPesqcfunp1.edimaxparcExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure TfrmPesqcfunp1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  frmPesqcfunp:=nil;
  form_ativo := '';
...
procedure TfrmPesqcfunp1.mmoobsKeyPress(Sender: TObject; var Key: Char);
begin
   if (key = #13) then SelectNext(ActiveControl,True,True);
end;

procedure TfrmPesqcfunp1.dbgcfunKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmPesqcfunp1.dbgcfunEnter(Sender: TObject);
begin
tabela := 'Comissao';
end;

procedure TfrmPesqcfunp1.spdconfirmaClick(Sender: TObject);
begin
close;
end;

procedure TfrmPesqcfunp1.spdcancelaClick(Sender: TObject);
begin
close;
end;

procedure TfrmPesqcfunp1.spdfiltrarClick(Sender: TObject);
var
...
procedure TfrmPesqcfunp1.spdlimparClick(Sender: TObject);
begin
...
procedure TfrmPesqcfunp1.edidescChange(Sender: TObject);
begin
...
procedure TfrmPesqcfunp1.cbxclassificarKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure TfrmPesqcfunp1.cbxclassificarKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key := 0;
end;

procedure TfrmPesqcfunp1.edidescKeyPress(Sender: TObject; var Key: Char);
begin
edicodigoi.Text := '';
edicodigof.Text := '';
if key = #13 then
...
procedure TfrmPesqcfunp1.edicodigoiKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure TfrmPesqcfunp1.edicodigofKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure TfrmPesqcfunp1.dbgcfunExit(Sender: TObject);
begin
  if frmdados.Cds_Comissao.State in [dsinsert, dsedit] then
     frmdados.Cds_Comissao.Post;
  //endi
...
procedure TfrmPesqcfunp1.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = 27 then
   close;
...
procedure TfrmPesqcfunp1.cbxclassificar2KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key := 0;
...
procedure TfrmPesqcfunp1.cbxclassificar2KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure TfrmPesqcfunp1.cbxclassificarClick(Sender: TObject);
begin
spdfiltrar.Click;
habdedidesc;
end;

procedure tfrmPesqcfunp1.habdedidesc;
begin
...
procedure TfrmPesqcfunp1.spdprinterClick(Sender: TObject);
begin
...
procedure TfrmPesqcfunp1.cbxnomeforClick(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqcfunp1.cbxnomeforEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqcfunp1.cbxnomeclaClick(Sender: TObject);
begin
tabela := 'temp';
end;

procedure TfrmPesqcfunp1.cbxnomeclaEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqcfunp1.cbxnomeforKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmPesqcfunp1.cbxnomesitpagarClick(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqcfunp1.cbxnomesitpagarEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure TfrmPesqcfunp1.cbxnomesitpagarKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key = vk_delete then
   frmdados.Cds_temp.edit;
...
procedure TfrmPesqcfunp1.dbgcfunKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmPesqcfunp1.cbxnomefunDropDown(Sender: TObject);
begin
//showmessage('');
//tabela := 'Funcionarios';
...
procedure TfrmPesqcfunp1.spdrelatorios176Click(Sender: TObject);
begin
