object frmreltipopgtov: Tfrmreltipopgtov
  Left = 262
  Top = 442
  Width = 696
  Height = 479
  HorzScrollBar.Position = 23
  Caption = 'frmreltipopgtov'
  Color = clBtnFace
  ...
  object relatorio: TQuickRep
    ...
    DataSet = frmDados.cds_Tipo_Pgto
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
