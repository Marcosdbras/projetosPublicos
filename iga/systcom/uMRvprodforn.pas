...
var
  frmMRvprodforn: TfrmMRvprodforn;

implementation

uses uGeral, uPrincipal, uDados, urelprodforn ;

{$R *.DFM}

procedure TfrmMRvprodforn.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelprodforn := tfrmrelprodforn.Create(self);
     frmrelprodforn.relatorio.Preview;
     frmrelprodforn.Free;
   end;
//endi
...
procedure TfrmMRvprodforn.FormShow(Sender: TObject);
begin
...
procedure TfrmMRvprodforn.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRvprodforn.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRvprodforn.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRvprodforn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure tfrmMRvprodforn.Impetq;
var I , J : longint;
