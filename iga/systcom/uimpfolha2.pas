...
var
  FrmImpfolha2: TFrmImpfolha2;

implementation
 uses uGeral, udados, upesqos;
{$R *.DFM}

procedure TFrmImpfolha2.mostrararq_ext;
var
 J : TJPEGImage;
 figura : tbitmap;
 S : TMemoryStream;
...
procedure TFrmImpfolha2.detalheBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
procedure TFrmImpfolha2.QRSubDetail2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
try
...
procedure TFrmImpfolha2.GroupFooterBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
  var
    vardir:string;
begin
...
procedure TFrmImpfolha2.relatorioBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TFrmImpfolha2.tituloBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
     ...
     begin
       ...
       if (cds_indice.FieldByName('DESC9').asString <> '') then
          begin
             ...
             //lbltitdesc92.Caption := cds_indice.FieldByName('desc9').asString;
             //lbltitdesc92.Visible := true;

             //lbldesc92.Caption := cds_svenda.FieldByName('desc9').asString;
             //lbldesc92.Visible := true;
...
mmoobs1.Lines.Clear;
mmoobs1.Lines.Add(frmdados.Cds_Indice.fieldbyname('obs').asString);
