...
uses uGeral, uPrincipal, uDados, urelnfe, urelnfes ;

{$R *.DFM}

procedure TfrmMRnfe.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelnfe := tfrmrelnfe.Create(self);
     frmrelnfe.relatorio.Preview;
     frmrelnfe.Free;
   end;
//endi
...
if rgbtiporel.ItemIndex = 1 then
   begin
     frmrelnfes := tfrmrelnfes.create(self);
     frmrelnfes.relatorio.preview;
     frmrelnfes.free;
   end;
//endi
...
procedure TfrmMRnfe.FormShow(Sender: TObject);
begin
...
procedure TfrmMRnfe.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRnfe.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRnfe.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRnfe.FormClose(Sender: TObject; var Action: TCloseAction);
begin
