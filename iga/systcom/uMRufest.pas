...
var
  frmMRufest: TfrmMRufest;

implementation

uses uGeral, uPrincipal, uDados, urelufest ;

{$R *.DFM}

procedure TfrmMRufest.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelufest:= tfrmrelufest.Create(self);
     frmrelufest.relatorio.Preview;
     frmrelufest.Free;
   end;
//endi
...
procedure TfrmMRufest.FormShow(Sender: TObject);
begin
...
procedure TfrmMRufest.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRufest.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRufest.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRufest.FormClose(Sender: TObject; var Action: TCloseAction);
begin
