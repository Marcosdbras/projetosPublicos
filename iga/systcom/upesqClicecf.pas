...
var
  frmpesqClicecf: TfrmpesqClicecf;

implementation
   uses ugeral, ufrenteecf, uDados;
{$R *.dfm}

procedure TfrmpesqClicecf.cbxclassificarKeyDown(Sender: TObject;
...
procedure TfrmpesqClicecf.cbxclassificarKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure TfrmpesqClicecf.spdconfirmaClick(Sender: TObject);
begin
  ...
  frmfrenteecf.iccli := frmdados.Cds_Clientes.fieldbyname('codigo').asInteger;
  frmfrenteecf.lblncli.caption := frmdados.Cds_Clientes.fieldbyname('Nome').asString;
  tabela := 'Vendab';
  close;
...
procedure TfrmpesqClicecf.FormClose(Sender: TObject;
...
procedure TfrmpesqClicecf.spdadd178Click(Sender: TObject);
var
  contador, x: Integer;
begin
end;

procedure TfrmpesqClicecf.edinomecliChange(Sender: TObject);
begin
...
procedure TfrmpesqClicecf.FormShow(Sender: TObject);
var
   vardir: String;
...
begin
   ...
   if frmfrenteecf.iccli > 0 then
      edidesc.Text := frmfrenteecf.lblncli.caption;
   //endi

   if frmfrenteecf.bReimp then
      begin
...
procedure TfrmpesqClicecf.edinomecliKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then
   begin
     key := #0;
...
procedure TfrmpesqClicecf.dbgcliDblClick(Sender: TObject);
begin
spdconfirma.Click;
...
procedure TfrmpesqClicecf.inserircli;
begin
    {
     with frmdados do
       begin
...
procedure TfrmpesqClicecf.alteracli;
begin
...
procedure TfrmpesqClicecf.DBEdit1Exit(Sender: TObject);
begin
     with frmdados do
       begin
...
procedure TfrmpesqClicecf.DBEdit1Enter(Sender: TObject);
begin
frmdados.cds_ClientesCPF.EditMask := '';
end;

procedure TfrmpesqClicecf.spdIncluir111Click(Sender: TObject);
begin
...
procedure TfrmpesqClicecf.spdAlterar112Click(Sender: TObject);
begin
pnllistacli.Visible := false;
...
procedure TfrmpesqClicecf.edidescChange(Sender: TObject);
begin
if edidesc.Text <> '' then
   frmdados.cds_Clientes.Locate(frmpesqclicecf.sClassificar,edidesc.text,[loPartialKey,loCaseInsensitive]);
//endi
end;

procedure TfrmpesqClicecf.edidescKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then
   begin
     key := #0;
...
procedure TfrmpesqClicecf.filtrar;
var
...
procedure TfrmpesqClicecf.limpar;
begin
  ...
  filtrar;
   ...
   mmoobs.Clear;
   mmoobs.Lines.Add(frmfrenteecf.mmoinfent);
...
procedure TfrmpesqClicecf.aproximado;
begin
  with frmdados do
    begin
      if edidesc.Text <> '' then
...
procedure TfrmpesqClicecf.spdlimparClick(Sender: TObject);
begin
limpar;
end;

procedure TfrmpesqClicecf.DBEdit1KeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then
   begin
     key := #0;
...
procedure TfrmpesqClicecf.DBEdit2KeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then
   begin
     key := #0;
...
procedure TfrmpesqClicecf.FormKeyPress(Sender: TObject; var Key: Char);
begin
if key=#13 then
