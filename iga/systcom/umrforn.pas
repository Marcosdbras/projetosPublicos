...
var
  frmMRforn: TfrmMRforn;

implementation

uses uGeral, uPrincipal, uDados, urelani;

{$R *.DFM}

procedure TfrmMRforn.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
procedure TfrmMRforn.FormShow(Sender: TObject);
begin
...
procedure TfrmMRforn.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRforn.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRforn.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRforn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
