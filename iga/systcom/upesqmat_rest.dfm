object frmPesqMat_Rest: TfrmPesqMat_Rest
  Left = 201
  Top = 208
  Width = 938
  Height = 709
  BorderIcons = []
  Caption = 'Pesquisa Tratamento'
  Color = clBtnFace
  ...
  object pnldir: TPanel
    ...
    object dbgMat_Restaurar: TDBGrid
      Left = 8
      Top = 479
      Width = 697
      Height = 105
      ...
      TitleFont.Style = []
      OnKeyDown = dbgMat_RestaurarKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'DESCRICAO'
