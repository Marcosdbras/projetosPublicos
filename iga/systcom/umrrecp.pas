...
var
  frmMRrecp: TfrmMRrecp;

implementation

uses uGeral, uDados, upesqrecbtop, urelrecp, upesqtra;

{$R *.DFM}

procedure TfrmMRrecp.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelrecp := tfrmrelrecp.Create(self);
     frmrelrecp.relatorio.Preview;
     frmrelrecp.Free;
     frmpesqrecbtop.spdfiltrar.Click;
   end;
//endi
...
procedure TfrmMRrecp.FormShow(Sender: TObject);
begin
...
procedure TfrmMRrecp.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRrecp.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRrecp.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRrecp.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfrmMRrecp.ImprRelRecDia;
var
       ...
       begin
         ...
         while not cds_vencto.Eof do
            begin
              ...
              case frmpesqrecbtop.cbxclassificar.ItemIndex of
                  0:begin
