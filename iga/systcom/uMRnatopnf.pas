...
var
  frmMRnatopnf: TfrmMRnatopnf;

implementation

uses uGeral, uPrincipal, uDados, urelnatopnf ;

{$R *.DFM}

procedure TfrmMRnatopnf.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmrelnatopnf := tfrmrelnatopnf.Create(self);
     frmrelnatopnf.relatorio.Preview;
     frmrelnatopnf.Free;
   end;
//endi
...
procedure TfrmMRnatopnf.FormShow(Sender: TObject);
begin
...
procedure TfrmMRnatopnf.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMRnatopnf.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMRnatopnf.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMRnatopnf.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure tfrmMRnatopnf.Impetq;
var I , J : longint;
