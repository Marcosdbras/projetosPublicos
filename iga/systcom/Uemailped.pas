...
uses
  ...
  IdMessageClient, IdSMTP, StdCtrls, SqlExpr, Db, IdCustomTransparentProxy,
  IdExplicitTLSClientServerBase, IdSMTPBase;

type
  Tfrmemailped = class(TForm)
    btnenviar: TButton;
    btncancelar: TButton;
...
var
  frmemailped: Tfrmemailped;

implementation
  uses ugeral, upesqvd, udados, uImpNF;
{$R *.dfm}

procedure Tfrmemailped.btncancelarClick(Sender: TObject);
begin
close;
end;

procedure Tfrmemailped.FormShow(Sender: TObject);
var
...
procedure Tfrmemailped.btnenviarClick(Sender: TObject);
begin
    {
     ...
     msg.Recipients.add;
     msg.Recipients.Items[0].Address := ediemail.Text;
     msg.Recipients.Items[0].Name := edinome.text;
...
procedure tfrmemailped.revisamsg;
var
...
procedure Tfrmemailped.btnsalvarClick(Sender: TObject);
begin
...
procedure Tfrmemailped.FormClose(Sender: TObject;
