...
var
  frmMReprod: TfrmMReprod;

implementation

uses uGeral, uPrincipal, uDados, ureleprod,ureleprods ;

{$R *.DFM}

procedure TfrmMReprod.sPdGravarClick(Sender: TObject);
  var
    vardir:String;
begin
...
if rgbtiporel.ItemIndex = 0 then
   begin
     frmreleprod := tfrmreleprod.Create(self);
     frmreleprod.relatorio.Preview;
     frmreleprod.Free;
   end;
//endi
...
if rgbtiporel.ItemIndex = 1 then
   begin
   frmreleprods := tfrmreleprods.create(self);
     frmreleprods.relatorio.preview;
     frmreleprods.free;
   end;
//endi
...
procedure TfrmMReprod.FormShow(Sender: TObject);
begin
...
procedure TfrmMReprod.rgbtiporelClick(Sender: TObject);
begin
spdgravar.Enabled := true;

end;

procedure TfrmMReprod.spdSairClick(Sender: TObject);
begin
close;
end;

procedure TfrmMReprod.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMReprod.FormClose(Sender: TObject; var Action: TCloseAction);
begin
