object frmPesqtipopgtovp: TfrmPesqtipopgtovp
  Left = -4
  Top = -4
  Width = 1032
  Height = 746
  BorderIcons = []
  Caption = 'Pesquisa de Tipo Pagamento ( Vendas )'
  Color = clBtnFace
  ...
  object pnldir: TPanel
    ...
    object dbgtipopgtov: TDBGrid
      Left = 1
      Top = 98
      Width = 821
      Height = 530
      Align = alClient
      DataSource = frmDados.dts_Tipo_Pgto
      ...
      TitleFont.Style = []
      OnEnter = dbgtipopgtovEnter
      OnExit = dbgtipopgtovExit
      OnKeyPress = dbgtipopgtovKeyPress
      Columns = <
        item
          Expanded = False
          FieldName = 'DESCRICAO'
