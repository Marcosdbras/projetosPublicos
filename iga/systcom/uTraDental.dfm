object frmtradental: Tfrmtradental
  Left = -2
  Top = 74
  Width = 1032
  Height = 684
  Caption = 'Tratamento Dent'#225'rio'
  Color = clBtnFace
  ...
  object pnlsuperior: TPanel
    ...
    Align = alTop
    TabOrder = 1
    object spdnovotratamento: TSpeedButton
      Left = 265
      Top = 5
      Width = 128
      Height = 49
      ...
      Layout = blGlyphTop
      NumGlyphs = 2
      OnClick = spdnovotratamentoClick
    end
    ...
    object spdlocalizar: TSpeedButton
      Left = 7
      Top = 5
      Width = 128
      Height = 49
  ...
  object pnldental: TPanel
    ...
    object dbgmat_rest: TDBCtrlGrid
      ...
      ShowFocus = False
      OnDblClick = dbgmat_restDblClick
