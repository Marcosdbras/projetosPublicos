...
var
  frmtrageral: Tfrmtrageral;

implementation

uses uGeral, uPrincipal, uDados, urelcfunsp;

{$R *.DFM}

procedure Tfrmtrageral.FormShow(Sender: TObject);
var
   vardir: String;
begin
...
procedure Tfrmtrageral.ediOSExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure Tfrmtrageral.ediosefExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure Tfrmtrageral.ediparcExit(Sender: TObject);
var
   valor : integer;
begin
...
procedure Tfrmtrageral.edimaxparcExit(Sender: TObject);
var
   valor : integer;
begin
end;

procedure Tfrmtrageral.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  frmtrageral:=nil;
  form_ativo := '';
...
procedure Tfrmtrageral.mmoobsKeyPress(Sender: TObject; var Key: Char);
begin
   if (key = #13) then SelectNext(ActiveControl,True,True);
end;

procedure Tfrmtrageral.dbgcfunKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tfrmtrageral.dbgcfunEnter(Sender: TObject);
begin
tabela := 'Comissao';
end;

procedure Tfrmtrageral.spdconfirmaClick(Sender: TObject);
begin
close;
end;

procedure Tfrmtrageral.spdcancelaClick(Sender: TObject);
begin
close;
end;

procedure Tfrmtrageral.spdfiltrarClick(Sender: TObject);
var
...
procedure Tfrmtrageral.spdlimparClick(Sender: TObject);
begin
...
procedure Tfrmtrageral.edidescChange(Sender: TObject);
begin
if (edidesc.Text <> '') and (sclassificar <> 'Dte') and (sclassificar <> 'Dtv') and (sclassificar <> 'Dtl') then
   frmdados.cds_Comissao.Locate(frmtrageral.sClassificar,edidesc.text,[loPartialKey,loCaseInsensitive]);
//endi
end;

procedure Tfrmtrageral.cbxclassificarKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure Tfrmtrageral.cbxclassificarKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key := 0;
end;

procedure Tfrmtrageral.edidescKeyPress(Sender: TObject; var Key: Char);
begin
edicodigoi.Text := '';
edicodigof.Text := '';
if key = #13 then
...
procedure Tfrmtrageral.edicodigoiKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure Tfrmtrageral.edicodigofKeyPress(Sender: TObject; var Key: Char);
begin
edidesc.Text := '';
if key = #13 then
   begin
...
procedure Tfrmtrageral.dbgcfunExit(Sender: TObject);
begin
  if frmdados.Cds_Comissao.State in [dsinsert, dsedit] then
     frmdados.Cds_Comissao.Post;
  //endi
...
procedure Tfrmtrageral.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = 27 then
   close;
...
procedure Tfrmtrageral.cbxclassificar2KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
key := 0;
...
procedure Tfrmtrageral.cbxclassificar2KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
     begin
...
procedure Tfrmtrageral.cbxclassificarClick(Sender: TObject);
begin
spdfiltrar.Click;
habdedidesc;
end;

procedure tfrmtrageral.habdedidesc;
begin
...
procedure Tfrmtrageral.spdprinterClick(Sender: TObject);
begin
...
procedure Tfrmtrageral.cbxnomeforClick(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure Tfrmtrageral.cbxnomeforEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure Tfrmtrageral.cbxnomeclaClick(Sender: TObject);
begin
tabela := 'temp';
end;

procedure Tfrmtrageral.cbxnomeclaEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure Tfrmtrageral.cbxnomeforKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmtrageral.cbxnomesitpagarClick(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure Tfrmtrageral.cbxnomesitpagarEnter(Sender: TObject);
begin
tabela := 'Temp';
end;

procedure Tfrmtrageral.cbxnomesitpagarKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key = vk_delete then
   frmdados.Cds_temp.edit;
...
procedure Tfrmtrageral.dbgcfunKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmtrageral.cbxnomefunDropDown(Sender: TObject);
begin
//showmessage('');
//tabela := 'Funcionarios';
...
procedure Tfrmtrageral.spdrelatorios176Click(Sender: TObject);
begin
