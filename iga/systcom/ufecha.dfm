  ...
  object pnlcentral: TPanel
    ...
    object pnlparcelamento: TPanel
      ...
      object Label30: TLabel
        ...
        Height = 15
        AutoSize = False
        Caption = 'F2-Ativa imp. / F3-Cliente '
        Color = clMoneyGreen
      ...
      object spdincluirparc: TSpeedButton
        Left = 268
        Top = 130
        Width = 33
        Height = 30
      ...
      object spdsalvarparc: TSpeedButton
        Left = 348
        Top = 130
        Width = 33
        Height = 30
      ...
      object spdaddparc: TSpeedButton
        Left = 398
        Top = 34
        Width = 23
        Height = 21
      ...
      object cbxtipo1: TDBLookupComboBox
        Left = 2
        Top = 34
        Width = 101
        Height = 21
      ...
      object dbgparcelamento: TDBGrid
        Left = 1
        Top = 56
        Width = 420
        Height = 73
        ...
        Font.Name = 'MS Sans Serif'
        Font.Style = []
        Options = [dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgCancelOnExit]
        ParentFont = False
        TabOrder = 7
