...
procedure TFrmRelHistInf.QuickRep1AfterPreview(Sender: TObject);
begin
   codAluno := FrmDados.CDS_CadAluno.FieldByNAme('CODIGO').AsString;
end;

procedure TFrmRelHistInf.GroupHeaderBand1BeforePrint(
...
begin
  ...
  begin
    ...
    DBX_Historico.SQL.Add('SELECT * FROM HISTORICO WHERE CODALU = ' + CODALUNO + ' and codcurso = 1 order by ANO');
...
procedure TFrmRelHistInf.QRSubDetail2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  i : integer;
  sAno,
...
begin
  ...
  begin
    ...
    begin
      ...
      DBX_Historico.Active := False;
      DBX_Historico.SQL.Clear;
      DBX_Historico.SQL.Add('SELECT * FROM HISTORICO WHERE CODALU = ' + CODALUNO + ' and SERIE = ' + quotedstr(sANO) + ' and codcurso = 1');
      DBX_Historico.Active := True;
      CDS_Historico.Active := True;
