...
type
  TFrmRelPgmtosAss5a8 = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRBand3: TQRBand;
    QRLabel1: TQRLabel;
...
var
  FrmRelPgmtosAss5a8: TFrmRelPgmtosAss5a8;
...
procedure TFrmRelPgmtosAss5a8.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  sSerie : String;
begin
...
procedure TFrmRelPgmtosAss5a8.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  with FrmDados do
  begin
...
procedure TFrmRelPgmtosAss5a8.QuickRep1AfterPreview(Sender: TObject);
begin
  with FrmDados do
  begin
