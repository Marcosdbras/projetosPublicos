...
var
  FrmRelGradCurEI: TFrmRelGradCurEI;
...
procedure TFrmRelGradCurEI.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  cont : integer;
  sSerie : String;
...
procedure TFrmRelGradCurEI.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  iAno1 := 0;
  iAno2 := 0;
...
procedure TFrmRelGradCurEI.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFrmRelGradCurEI.QuickRep1AfterPrint(Sender: TObject);
begin
  with FrmDados do
  begin
    CDS_GradCur.Active := False;
...
procedure TFrmRelGradCurEI.QuickRep1AfterPreview(Sender: TObject);
begin
  with FrmDados do
  begin
    CDS_GradCur.Active := False;
