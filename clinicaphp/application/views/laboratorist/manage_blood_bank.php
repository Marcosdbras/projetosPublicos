		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_blood_bank');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('blood_bank_list');?>
                    	</a></li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('laboratorist/manage_blood_bank/edit/do_update/'.$row['blood_group_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_blood_bank');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
