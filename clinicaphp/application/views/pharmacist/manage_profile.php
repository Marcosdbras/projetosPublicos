			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <form method="post" action="<?php echo base_url();?>index.php?pharmacist/manage_profile/update_profile_info/" class="form-horizontal validatable">
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <form method="post" action="<?php echo base_url();?>index.php?pharmacist/manage_profile/change_password/" class="form-horizontal validatable">
                                <div class="control-group">
