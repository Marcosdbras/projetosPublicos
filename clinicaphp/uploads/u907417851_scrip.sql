...
--
-- Host: localhost
-- Generation Time: Aug 05, 2014 at 03:35 AM
...
(1, '', 'roblagua@gmail.com', 'BetoLagua', '', '');
...
(1, 'José', 'jose@gmail.com', 'BetoLagua', 'Rua General Goes Monteiro 8 B 601', '3184845678', 1, 'José');
...
(1, 'Roberto ', 'roblagua@gmail.com', 'BetoLagua', 'Afonso Alves Branco 33', '3132255635', 'male', '11/03/1982', 32, 'A+', 1407223666);
...
(1, 1407223949, 1, 1, 'Roberto Paciente com problemas cardiológicos', 'remédio para coração', '', '');
...
(1, 'birth', 'Nascimento bebê', 1407223989, 0, 0),
(2, 'death', 'Morte Paciente', 1407224024, 0, 0),
(3, 'operation', 'Operação', 1407224061, 0, 0);
