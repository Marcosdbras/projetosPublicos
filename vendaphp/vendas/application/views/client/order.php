	...
	<div class="box-content padded">
		<div class="tab-content">
                    ...
                    <div class="box">
                        <div class="box-content">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                                ...
                                <tbody>
                                    <?php $count = 1;foreach($order as $row): if($row['client'] == $this->session->userdata('client_id')):?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <?php if($row['status'] !== 'approved'): if($row['status'] !== 'cancelled'):?>
                                            <a data-toggle="modal" href="#modal-form" onclick="modal('edit_order',<?php echo $row['order_id'];?>)"	class="btn btn-gray btn-small">
                                                    <i class="icon-wrench"></i> <?php echo get_phrase('edit');?>
                                            </a>
                                            <?php endif; ?>
                                            <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?client/order/delete/<?php echo $row['order_id'];?>')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('client/order/create' , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    <form method="post" action="<?php echo base_url();?>index.php?client/order/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
							...
							<div class="control-group">
								...
								<div class="controls">
                                	<?php echo get_phrase('you');?>
									<input type="hidden" name="client" value="<?php echo $this->session->userdata('client_id');?>"/>
							...
							<div class="control-group">
								<label class="control-label"><?php echo get_phrase('product category');?></label>
								<div class="controls">
