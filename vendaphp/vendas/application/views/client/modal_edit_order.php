<div class="tab-pane box active" id="edit" style="padding: 5px">
				...
				<?php foreach($edit_data as $row):?>
                	<?php echo form_open('client/order/do_update/'.$row['order_id'] , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
							...
							<div class="control-group">
								...
								<div class="controls">
									<span class="btn btn-small btn-<?php if ($row['status'] == 'pending'){echo 'blue';} elseif ($row['status'] == 'cancelled'){echo 'red';} elseif ($row['status'] == 'approved'){echo 'green';}?>"><?php echo $row['status'];?>
								</div>
							</div>
