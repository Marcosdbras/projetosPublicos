<div class="tab-pane box active" id="edit" style="padding: 5px">
				...
				<?php foreach($edit_data as $row):?>
                	<?php echo form_open('client/message/do_update/'.$row['message_id'] , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="hidden" class="" name="receiver" value="1"/>
									<input type="text" disabled="disabled" class="" name="receiver" value="<?php echo get_phrase('admin');?>"/>
								</div>
							</div>
