...
<div id="modal-form" class="modal hide fade">
    ...
    <div class="modal-body" id="modal-body">Buscar dados..</div>
    <div class="modal-footer">
        <button class="btn btn-gray" onclick="custom_print('frame1')">Imprimir</button>
...
<div id="modal-delete" class="modal hide fade" style="height:140px;">
    ...
    <div class="modal-delete-body" id="modal-body-delete">Excluir dados ?</div>
    <div class="modal-footer">
    	<a href="" id="delete_link" class="btn btn-red" >Confirma</a>
