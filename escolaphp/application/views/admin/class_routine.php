                            ...
                            <div class="accordion-group">
                                <div class="accordion-heading">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse<?php echo $row['class_id'];?>">
                                        <i class="icon-rss icon-1x"></i> Classe <?php echo $row['name'];?>
                                    </a>
                                </div>
                                                    ...
                                                    <td>
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu">
																<li><a data-toggle="modal" href="#modal-form" onclick="modal('edit_class_routine',<?php echo $row2['class_routine_id'];?>)"><i class="icon-cog"></i> editar</a></li>
																<li><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/class_routine/delete/<?php echo $row2['class_routine_id'];?>')">
                                                                		<i class="icon-trash"></i> deletar</a></li>
															</ul>
														</div>
														<?php endforeach;?>
