				...
				<center>
                        ...
                        ?>
                            <option value="<?php echo $row['class_id'];?>"
                            	<?php if($class_id == $row['class_id'])echo 'selected';?>>
                                	Classe <?php echo $row['name'];?></option>
                        <?php
                        endforeach;
                        ?>
                    </select>
					...
					<?php if($class_id	==	''):?>
                        <div id="ask_class" class="  alert alert-info  " style="width:300px;">
                            <i class="icon-info-sign"></i><span class="  alert alert-info span16 ">Por favor, selecione uma classe para gerenciar estudante</span>.</div>
                        <script>
                    ...
                    <div class="action-nav-normal">
                        <div class=" action-nav-button" style="width:300px;">
                          <a href="#" title="Users">
                            ...
                            <span>Total <?php echo count($students);?> estudantes</span>
                          </a>
                        </div>
                    </div>
                </center>
...
<div class="span5" style="float:none !important;">
    <div class="box">
		<div class="box-header">
			<span class="title"> <i class="icon-info-sign"></i><span class="  alert alert-info span16 ">Por favor, selecione uma classe para gerenciar estudante</span>.</span>		</div>
