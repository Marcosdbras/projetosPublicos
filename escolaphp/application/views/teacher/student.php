				...
				<center>
					...
					<?php if($class_id	==	''):?>
                        <div id="ask_class" class="  alert alert-info  " style="width:300px;">
                            <i class="icon-info-sign"></i> Por favor, selecione uma classe para gerenciar estudante.
...
<div class="span5" style="float:none !important;">
    <div class="box">
		<div class="box-header">
			<span class="title"> <i class="icon-info-sign"></i> Por favor, selecione uma classe para gerenciar estudante.</span>		</div>
