		...
		<div class="tab-content">
                          ...
                          <div id="collapse<?php echo $row0['exam_id'];?>" class="accordion-body collapse" style="height: 0px;">
                            ...
                            <center>
                              <table class="table table-striped " >
                                ...
                                <hr />
                                Total de notas: <?php	echo $total_marks;?>
                                <hr />
                                PM(Pontua&ccedil;&atilde;o M&eacute;dia) : <?php echo round($total_grade_point/$total_subjects , 2);?>
                              </center>
                            </div>
                          </div>
                        </div>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
					...
					<?php if($class_id	==	''):?>
                    	<div class="row-fluid">
                            <div class="  alert alert-info span16 ">Por favor, selecione uma classe para gerenciar estudante.                            </div>
                        </div>
                    <?php endif;?>
                </center>
                <?php if($class_id	!=	''):?>
